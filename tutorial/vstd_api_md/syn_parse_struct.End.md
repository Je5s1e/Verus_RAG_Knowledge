...
# Struct <span class="struct">End</span> Copy item path

<span class="sub-heading"><a href="../../src/syn/lookahead.rs.html#312" class="src">Source</a>
</span>
...
This type is only useful as an argument to one of the following
functions:

- [`ParseStream::peek`](struct.ParseBuffer.html#method.peek "method syn::parse::ParseBuffer::peek")
- [`ParseStream::peek2`](struct.ParseBuffer.html#method.peek2 "method syn::parse::ParseBuffer::peek2")
- [`ParseStream::peek3`](struct.ParseBuffer.html#method.peek3 "method syn::parse::ParseBuffer::peek3")
- [`Lookahead1::peek`](struct.Lookahead1.html#method.peek "method syn::parse::Lookahead1::peek")
...
Suppose we are parsing attributes containing core::fmt inspired
...
`input.peek(Token![,]) && input.peek2(End)` to recognize the case of a
trailing comma without consuming the comma from the parse stream,
because if it isn’t a trailing comma, that same comma needs to be parsed
as part of `args`.
...
Implementing this parsing logic without `peek2(End)` is more clumsy
because we’d need a parse stream actually advanced past the comma before
being able to find out whether there is anything after it. It would look
something like:
...
<div id="impl-Clone-for-End" class="section impl">

<a href="../../src/syn/lookahead.rs.html#316-320"
class="src rightside">Source</a><a href="#impl-Clone-for-End" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/clone/trait.Clone.html"
class="trait" title="trait core::clone::Clone">Clone</a> for <a href="struct.End.html" class="struct"
title="struct syn::parse::End">End</a>
...
<a href="../../src/syn/lookahead.rs.html#317-319"
...
<div id="impl-Copy-for-End" class="section impl">

<a href="../../src/syn/lookahead.rs.html#314"
class="src rightside">Source</a><a href="#impl-Copy-for-End" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Copy.html"
class="trait" title="trait core::marker::Copy">Copy</a> for <a href="struct.End.html" class="struct"
title="struct syn::parse::End">End</a>
...
<a href="../../src/syn/lookahead.rs.html#322-324"
class="src rightside">Source</a><a href="#impl-Peek-for-End" class="anchor">§</a>

### impl <a href="trait.Peek.html" class="trait"
title="trait syn::parse::Peek">Peek</a> for <a href="struct.End.html" class="struct"
title="struct syn::parse::End">End</a>
...
<div id="impl-Freeze-for-End" class="section impl">

<a href="#impl-Freeze-for-End" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.End.html" class="struct"
title="struct syn::parse::End">End</a>

</div>

<div id="impl-RefUnwindSafe-for-End" class="section impl">

<a href="#impl-RefUnwindSafe-for-End" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.End.html" class="struct"
title="struct syn::parse::End">End</a>

</div>

<div id="impl-Send-for-End" class="section impl">

<a href="#impl-Send-for-End" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.End.html" class="struct"
title="struct syn::parse::End">End</a>

</div>

<div id="impl-Sync-for-End" class="section impl">

<a href="#impl-Sync-for-End" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.End.html" class="struct"
title="struct syn::parse::End">End</a>

</div>

<div id="impl-Unpin-for-End" class="section impl">

<a href="#impl-Unpin-for-End" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.End.html" class="struct"
title="struct syn::parse::End">End</a>

</div>

<div id="impl-UnwindSafe-for-End" class="section impl">

<a href="#impl-UnwindSafe-for-End" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.End.html" class="struct"
title="struct syn::parse::End">End</a>
...
### impl\<T\> <a href="../token/trait.Token.html" class="trait"
...
<div id="method.peek" class="section method trait-impl">

<a href="../../src/syn/token.rs.html#192-194"
class="src rightside">Source</a><a href="#method.peek" class="anchor">§</a>

#### fn <a href="../token/trait.Token.html#tymethod.peek" class="fn">peek</a>(cursor: <a href="../buffer/struct.Cursor.html" class="struct"
title="struct syn::buffer::Cursor">Cursor</a>\<'\_\>) -\> <a href="https://doc.rust-lang.org/1.92.0/std/primitive.bool.html"
class="primitive">bool</a>

</div>

<div id="method.display" class="section method trait-impl">

<a href="../../src/syn/token.rs.html#196-198"
class="src rightside">Source</a><a href="#method.display" class="anchor">§</a>

#### fn <a href="../token/trait.Token.html#tymethod.display"
class="fn">display</a>() -\> &'static <a href="https://doc.rust-lang.org/1.92.0/std/primitive.str.html"
