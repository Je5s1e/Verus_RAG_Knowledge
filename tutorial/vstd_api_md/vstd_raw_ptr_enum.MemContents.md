...
# Enum <span class="enum">MemContents</span> Copy item path

<span class="sub-heading"><a href="../../src/vstd/raw_ptr.rs.html#125-130" class="src">Source</a>
</span>
...
<div id="variant.Uninit" class="section variant">

<a href="#variant.Uninit" class="anchor">§</a>
...
<div id="variant.Init" class="section variant">

<a href="#variant.Init" class="anchor">§</a>
...
<div id="impl-Freeze-for-MemContents%3CT%3E" class="section impl">

<a href="#impl-Freeze-for-MemContents%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="enum.MemContents.html" class="enum"
title="enum vstd::raw_ptr::MemContents">MemContents</a>\<T\>
...
<div id="impl-RefUnwindSafe-for-MemContents%3CT%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-MemContents%3CT%3E"
class="anchor">§</a>

### impl\<T\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="enum.MemContents.html" class="enum"
title="enum vstd::raw_ptr::MemContents">MemContents</a>\<T\>
...
<div id="impl-Send-for-MemContents%3CT%3E" class="section impl">

<a href="#impl-Send-for-MemContents%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="enum.MemContents.html" class="enum"
title="enum vstd::raw_ptr::MemContents">MemContents</a>\<T\>
...
<div id="impl-Sync-for-MemContents%3CT%3E" class="section impl">

<a href="#impl-Sync-for-MemContents%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="enum.MemContents.html" class="enum"
title="enum vstd::raw_ptr::MemContents">MemContents</a>\<T\>
...
<div id="impl-Unpin-for-MemContents%3CT%3E" class="section impl">

<a href="#impl-Unpin-for-MemContents%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="enum.MemContents.html" class="enum"
title="enum vstd::raw_ptr::MemContents">MemContents</a>\<T\>
...
<div id="impl-UnwindSafe-for-MemContents%3CT%3E" class="section impl">

<a href="#impl-UnwindSafe-for-MemContents%3CT%3E" class="anchor">§</a>

### impl\<T\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="enum.MemContents.html" class="enum"
title="enum vstd::raw_ptr::MemContents">MemContents</a>\<T\>
