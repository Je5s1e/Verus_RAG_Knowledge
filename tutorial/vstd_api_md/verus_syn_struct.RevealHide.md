...
# Struct <span class="struct">RevealHide</span> Copy item path

<span class="sub-heading"><a href="../src/verus_syn/verus.rs.html#342-352" class="src">Source</a>
</span>
...
pub struct RevealHide {
    ...
    pub reveal_token: Option<Reveal>,
    pub reveal_with_fuel_token: Option<RevealWithFuel>,
    pub hide_token: Option<Hide>,
    pub paren_token: Paren,
    pub path: Box<ExprPath>,
    pub fuel: Option<(Comma, Box<Expr>)>,
}
```
...
title="struct verus_syn::Attribute"><code>Attribute</code></a>`>`</span><span id="structfield.reveal_token"
class="structfield section-header"><a href="#structfield.reveal_token" class="anchor field">§</a>`reveal_token: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<`<a href="token/struct.Reveal.html" class="struct"
title="struct verus_syn::token::Reveal"><code>Reveal</code></a>`>`</span><span id="structfield.reveal_with_fuel_token"
class="structfield section-header"><a href="#structfield.reveal_with_fuel_token" class="anchor field">§</a>`reveal_with_fuel_token: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<`<a href="token/struct.RevealWithFuel.html" class="struct"
title="struct verus_syn::token::RevealWithFuel"><code>RevealWithFuel</code></a>`>`</span><span id="structfield.hide_token"
class="structfield section-header"><a href="#structfield.hide_token" class="anchor field">§</a>`hide_token: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<`<a href="token/struct.Hide.html" class="struct"
title="struct verus_syn::token::Hide"><code>Hide</code></a>`>`</span><span id="structfield.paren_token"
...
title="struct verus_syn::token::Paren"><code>Paren</code></a></span><span id="structfield.path"
class="structfield section-header"><a href="#structfield.path" class="anchor field">§</a>`path: `<a href="https://doc.rust-lang.org/1.92.0/alloc/boxed/struct.Box.html"
class="struct" title="struct alloc::boxed::Box"><code>Box</code></a>`<`<a href="struct.ExprPath.html" class="struct"
title="struct verus_syn::ExprPath"><code>ExprPath</code></a>`>`</span><span id="structfield.fuel"
class="structfield section-header"><a href="#structfield.fuel" class="anchor field">§</a>`fuel: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<(`<a href="token/struct.Comma.html" class="struct"
title="struct verus_syn::token::Comma"><code>Comma</code></a>`, `<a href="https://doc.rust-lang.org/1.92.0/alloc/boxed/struct.Box.html"
...
<div id="impl-Clone-for-RevealHide" class="section impl">

<a href="../src/verus_syn/gen/clone.rs.html#2419-2431"
class="src rightside">Source</a><a href="#impl-Clone-for-RevealHide" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/clone/trait.Clone.html"
class="trait" title="trait core::clone::Clone">Clone</a> for <a href="struct.RevealHide.html" class="struct"
...
<a href="../src/verus_syn/gen/clone.rs.html#2420-2430"
...
<div id="impl-Debug-for-RevealHide" class="section impl">

<a href="../src/verus_syn/gen/debug.rs.html#3406-3418"
class="src rightside">Source</a><a href="#impl-Debug-for-RevealHide" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/fmt/trait.Debug.html"
class="trait" title="trait core::fmt::Debug">Debug</a> for <a href="struct.RevealHide.html" class="struct"
title="struct verus_syn::RevealHide">RevealHide</a>
...
<a href="../src/verus_syn/gen/debug.rs.html#3407-3417"
...
<div id="impl-Hash-for-RevealHide" class="section impl">

<a href="../src/verus_syn/gen/hash.rs.html#3035-3047"
class="src rightside">Source</a><a href="#impl-Hash-for-RevealHide" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/hash/trait.Hash.html"
class="trait" title="trait core::hash::Hash">Hash</a> for <a href="struct.RevealHide.html" class="struct"
title="struct verus_syn::RevealHide">RevealHide</a>
...
<a href="../src/verus_syn/gen/hash.rs.html#3036-3046"
...
<a href="../src/verus_syn/verus.rs.html#1314-1355"
...
<div id="impl-PartialEq-for-RevealHide" class="section impl">

<a href="../src/verus_syn/gen/eq.rs.html#2386-2393"
class="src rightside">Source</a><a href="#impl-PartialEq-for-RevealHide" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.PartialEq.html"
class="trait" title="trait core::cmp::PartialEq">PartialEq</a> for <a href="struct.RevealHide.html" class="struct"
title="struct verus_syn::RevealHide">RevealHide</a>
...
<a href="../src/verus_syn/gen/eq.rs.html#2387-2392"
...
<div id="impl-ToTokens-for-RevealHide" class="section impl">

<a href="../src/verus_syn/verus.rs.html#1911-1928"
class="src rightside">Source</a><a href="#impl-ToTokens-for-RevealHide" class="anchor">§</a>

### impl <a href="../quote/to_tokens/trait.ToTokens.html" class="trait"
title="trait quote::to_tokens::ToTokens">ToTokens</a> for <a href="struct.RevealHide.html" class="struct"
title="struct verus_syn::RevealHide">RevealHide</a>
...
<a href="../src/verus_syn/verus.rs.html#1912-1927"
...
<div id="impl-Eq-for-RevealHide" class="section impl">

<a href="../src/verus_syn/gen/eq.rs.html#2384"
class="src rightside">Source</a><a href="#impl-Eq-for-RevealHide" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.Eq.html"
class="trait" title="trait core::cmp::Eq">Eq</a> for <a href="struct.RevealHide.html" class="struct"
title="struct verus_syn::RevealHide">RevealHide</a>
...
<div id="impl-Freeze-for-RevealHide" class="section impl">

<a href="#impl-Freeze-for-RevealHide" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.RevealHide.html" class="struct"
title="struct verus_syn::RevealHide">RevealHide</a>

</div>

<div id="impl-RefUnwindSafe-for-RevealHide" class="section impl">

<a href="#impl-RefUnwindSafe-for-RevealHide" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.RevealHide.html" class="struct"
title="struct verus_syn::RevealHide">RevealHide</a>

</div>

<div id="impl-Send-for-RevealHide" class="section impl">

<a href="#impl-Send-for-RevealHide" class="anchor">§</a>

### impl \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.RevealHide.html" class="struct"
title="struct verus_syn::RevealHide">RevealHide</a>

</div>

<div id="impl-Sync-for-RevealHide" class="section impl">

<a href="#impl-Sync-for-RevealHide" class="anchor">§</a>

### impl \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.RevealHide.html" class="struct"
title="struct verus_syn::RevealHide">RevealHide</a>

</div>

<div id="impl-Unpin-for-RevealHide" class="section impl">

<a href="#impl-Unpin-for-RevealHide" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.RevealHide.html" class="struct"
title="struct verus_syn::RevealHide">RevealHide</a>

</div>

<div id="impl-UnwindSafe-for-RevealHide" class="section impl">

<a href="#impl-UnwindSafe-for-RevealHide" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.RevealHide.html" class="struct"
title="struct verus_syn::RevealHide">RevealHide</a>
