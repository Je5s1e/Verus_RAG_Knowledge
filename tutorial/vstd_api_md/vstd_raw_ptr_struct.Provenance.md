...
# Struct <span class="struct">Provenance</span> Copy item path

<span class="sub-heading"><a href="../../src/vstd/raw_ptr.rs.html#63" class="src">Source</a>
</span>
...
A full model of provenance is given by formalisms such as “Stacked
Borrows” or “Tree Borrows.”

None of these models are finalized, nor has Rust committed to them.
Rust’s recent [RFC on
provenance](https://rust-lang.github.io/rfcs/3559-rust-has-provenance.html)
simply details that there *is* some concept of provenance.

Our model here, likewise, simply declares `Provenance` as an abstract
type.

MiniRust currently declares a pointer has an `Option<Provenance>`; the
model here gives provenance a special “null” value instead of using an
option.
...
<div id="impl-Freeze-for-Provenance" class="section impl">

<a href="#impl-Freeze-for-Provenance" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.Provenance.html" class="struct"
title="struct vstd::raw_ptr::Provenance">Provenance</a>

</div>

<div id="impl-RefUnwindSafe-for-Provenance" class="section impl">

<a href="#impl-RefUnwindSafe-for-Provenance" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.Provenance.html" class="struct"
title="struct vstd::raw_ptr::Provenance">Provenance</a>

</div>

<div id="impl-Send-for-Provenance" class="section impl">

<a href="#impl-Send-for-Provenance" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.Provenance.html" class="struct"
title="struct vstd::raw_ptr::Provenance">Provenance</a>

</div>

<div id="impl-Sync-for-Provenance" class="section impl">

<a href="#impl-Sync-for-Provenance" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.Provenance.html" class="struct"
title="struct vstd::raw_ptr::Provenance">Provenance</a>

</div>

<div id="impl-Unpin-for-Provenance" class="section impl">

<a href="#impl-Unpin-for-Provenance" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.Provenance.html" class="struct"
title="struct vstd::raw_ptr::Provenance">Provenance</a>

</div>

<div id="impl-UnwindSafe-for-Provenance" class="section impl">

<a href="#impl-UnwindSafe-for-Provenance" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.Provenance.html" class="struct"
title="struct vstd::raw_ptr::Provenance">Provenance</a>
