...
# Struct <span class="struct">RawIter</span> Copy item path

<span class="sub-heading"><a href="../../src/hashbrown/raw/mod.rs.html#2005-2008"
...
For maximum flexibility this iterator is not bound by a lifetime, but
you must observe several rules when using it:

- You must not free the hash table while iterating (including via
  growing/shrinking).
- It is fine to erase a bucket that has been yielded by the iterator.
- Erasing a bucket that has not yet been yielded by the iterator may
  still result in the iterator yielding that bucket (unless
  `reflect_remove` is called).
...
<div id="impl-RawIter%3CT%3E" class="section impl">

<a href="../../src/hashbrown/raw/mod.rs.html#2010-2134"
class="src rightside">Source</a><a href="#impl-RawIter%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="struct.RawIter.html" class="struct"
title="struct hashbrown::raw::RawIter">RawIter</a>\<T\>

</div>

<div class="impl-items">

<div id="method.reflect_remove" class="section method">

<a href="../../src/hashbrown/raw/mod.rs.html#2019-2021"
class="src rightside">Source</a>

#### pub fn <a href="#method.reflect_remove" class="fn">reflect_remove</a>(&mut self, b: &<a href="struct.Bucket.html" class="struct"
...
Refresh the iterator so that it reflects a removal from the given
bucket.

For the iterator to remain valid, this method must be called once for
each removed bucket before `next` is called again.

This method should be called *before* the removal is made. It is not
necessary to call this method if you are removing an item that this
iterator yielded in the past.

</div>

<div id="method.reflect_insert" class="section method">

<a href="../../src/hashbrown/raw/mod.rs.html#2033-2035"
class="src rightside">Source</a>

#### pub fn <a href="#method.reflect_insert" class="fn">reflect_insert</a>(&mut self, b: &<a href="struct.Bucket.html" class="struct"
title="struct hashbrown::raw::Bucket">Bucket</a>\<T\>)
...
Refresh the iterator so that it reflects an insertion into the given
bucket.

For the iterator to remain valid, this method must be called once for
each insert before `next` is called again.

This method does not guarantee that an insertion of a bucket with a
greater index than the last one yielded will be reflected in the
iterator.
...
<div id="impl-Clone-for-RawIter%3CT%3E" class="section impl">

<a href="../../src/hashbrown/raw/mod.rs.html#2136-2144"
class="src rightside">Source</a><a href="#impl-Clone-for-RawIter%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/clone/trait.Clone.html"
class="trait" title="trait core::clone::Clone">Clone</a> for <a href="struct.RawIter.html" class="struct"
title="struct hashbrown::raw::RawIter">RawIter</a>\<T\>
...
<a href="../../src/hashbrown/raw/mod.rs.html#2138-2143"
...
<div id="impl-ExactSizeIterator-for-RawIter%3CT%3E"
class="section impl">

<a href="../../src/hashbrown/raw/mod.rs.html#2175"
class="src rightside">Source</a><a href="#impl-ExactSizeIterator-for-RawIter%3CT%3E"
class="anchor">§</a>

### impl\<T\> <a
href="https://doc.rust-lang.org/1.92.0/core/iter/traits/exact_size/trait.ExactSizeIterator.html"
class="trait"
title="trait core::iter::traits::exact_size::ExactSizeIterator">ExactSizeIterator</a> for <a href="struct.RawIter.html" class="struct"
title="struct hashbrown::raw::RawIter">RawIter</a>\<T\>
...
<span class="rightside"><span class="since"
title="Stable since Rust version 1.0.0">1.0.0</span> · <a
href="https://doc.rust-lang.org/1.92.0/src/core/iter/traits/exact_size.rs.html#116"
class="src">Source</a></span><a href="#method.len" class="anchor">§</a>
...
<div id="impl-Iterator-for-RawIter%3CT%3E" class="section impl">

<a href="../../src/hashbrown/raw/mod.rs.html#2146-2173"
class="src rightside">Source</a><a href="#impl-Iterator-for-RawIter%3CT%3E" class="anchor">§</a>

### impl\<T\> <a
href="https://doc.rust-lang.org/1.92.0/core/iter/traits/iterator/trait.Iterator.html"
class="trait"
title="trait core::iter::traits::iterator::Iterator">Iterator</a> for <a href="struct.RawIter.html" class="struct"
title="struct hashbrown::raw::RawIter">RawIter</a>\<T\>
...
<a href="../../src/hashbrown/raw/mod.rs.html#2147"
...
class="associatedtype">Item</a> = <a href="struct.Bucket.html" class="struct"
title="struct hashbrown::raw::Bucket">Bucket</a>\<T\>
...
<a href="../../src/hashbrown/raw/mod.rs.html#2150-2167"
...
<a href="../../src/hashbrown/raw/mod.rs.html#2170-2172"
...
<div id="impl-FusedIterator-for-RawIter%3CT%3E" class="section impl">

<a href="../../src/hashbrown/raw/mod.rs.html#2176"
class="src rightside">Source</a><a href="#impl-FusedIterator-for-RawIter%3CT%3E" class="anchor">§</a>

### impl\<T\> <a
href="https://doc.rust-lang.org/1.92.0/core/iter/traits/marker/trait.FusedIterator.html"
class="trait"
title="trait core::iter::traits::marker::FusedIterator">FusedIterator</a> for <a href="struct.RawIter.html" class="struct"
title="struct hashbrown::raw::RawIter">RawIter</a>\<T\>
...
<div id="impl-Freeze-for-RawIter%3CT%3E" class="section impl">

<a href="#impl-Freeze-for-RawIter%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.RawIter.html" class="struct"
title="struct hashbrown::raw::RawIter">RawIter</a>\<T\>

</div>

<div id="impl-RefUnwindSafe-for-RawIter%3CT%3E" class="section impl">

<a href="#impl-RefUnwindSafe-for-RawIter%3CT%3E" class="anchor">§</a>

### impl\<T\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.RawIter.html" class="struct"
title="struct hashbrown::raw::RawIter">RawIter</a>\<T\>
...
<div id="impl-Send-for-RawIter%3CT%3E" class="section impl">

<a href="#impl-Send-for-RawIter%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.RawIter.html" class="struct"
title="struct hashbrown::raw::RawIter">RawIter</a>\<T\>

</div>

<div id="impl-Sync-for-RawIter%3CT%3E" class="section impl">

<a href="#impl-Sync-for-RawIter%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.RawIter.html" class="struct"
title="struct hashbrown::raw::RawIter">RawIter</a>\<T\>

</div>

<div id="impl-Unpin-for-RawIter%3CT%3E" class="section impl">

<a href="#impl-Unpin-for-RawIter%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.RawIter.html" class="struct"
title="struct hashbrown::raw::RawIter">RawIter</a>\<T\>

</div>

<div id="impl-UnwindSafe-for-RawIter%3CT%3E" class="section impl">

<a href="#impl-UnwindSafe-for-RawIter%3CT%3E" class="anchor">§</a>

### impl\<T\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.RawIter.html" class="struct"
title="struct hashbrown::raw::RawIter">RawIter</a>\<T\>
