...
[vstd](../../index.html)::[tokens](../index.html)::[set](index.html)

</div>

# Struct <span class="struct">GhostSingleton</span> Copy item path

<span class="sub-heading"><a href="../../../src/vstd/tokens/set.rs.html#117-119"
...
The existence of a
[`GhostSingleton`](struct.GhostSingleton.html "struct vstd::tokens::set::GhostSingleton")
implies that:

- The value will remain in the set;
- All other
  [`GhostSubset`](struct.GhostSubset.html "struct vstd::tokens::set::GhostSubset")/[`GhostSingleton`](struct.GhostSingleton.html "struct vstd::tokens::set::GhostSingleton")
...
<div id="impl-Freeze-for-GhostSingleton%3CT%3E" class="section impl">

<a href="#impl-Freeze-for-GhostSingleton%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.GhostSingleton.html" class="struct"
title="struct vstd::tokens::set::GhostSingleton">GhostSingleton</a>\<T\>

</div>

<div id="impl-RefUnwindSafe-for-GhostSingleton%3CT%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-GhostSingleton%3CT%3E"
class="anchor">§</a>

### impl\<T\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.GhostSingleton.html" class="struct"
title="struct vstd::tokens::set::GhostSingleton">GhostSingleton</a>\<T\>
...
<div id="impl-Send-for-GhostSingleton%3CT%3E" class="section impl">

<a href="#impl-Send-for-GhostSingleton%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.GhostSingleton.html" class="struct"
title="struct vstd::tokens::set::GhostSingleton">GhostSingleton</a>\<T\>
...
<div id="impl-Sync-for-GhostSingleton%3CT%3E" class="section impl">

<a href="#impl-Sync-for-GhostSingleton%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.GhostSingleton.html" class="struct"
title="struct vstd::tokens::set::GhostSingleton">GhostSingleton</a>\<T\>
...
<div id="impl-Unpin-for-GhostSingleton%3CT%3E" class="section impl">

<a href="#impl-Unpin-for-GhostSingleton%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.GhostSingleton.html" class="struct"
title="struct vstd::tokens::set::GhostSingleton">GhostSingleton</a>\<T\>
...
<div id="impl-UnwindSafe-for-GhostSingleton%3CT%3E"
class="section impl">

<a href="#impl-UnwindSafe-for-GhostSingleton%3CT%3E"
class="anchor">§</a>

### impl\<T\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.GhostSingleton.html" class="struct"
title="struct vstd::tokens::set::GhostSingleton">GhostSingleton</a>\<T\>
