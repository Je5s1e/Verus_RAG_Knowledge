...
# Struct <span class="struct">PointsToData</span> Copy item path

<span class="sub-heading"><a href="../../src/vstd/raw_ptr.rs.html#144-147" class="src">Source</a>
</span>
...
If `opt_value` is `Init(T)`, this signifies that `ptr` points to
initialized memory, and the value of `opt_value` is consistent with the
bytes `ptr` points to, We also have all the ghost state associated with
type `T`.

If `opt_value` is `Uninit`, then we have no knowledge about what’s in
memory, and we assume `ptr` points to uninitialized memory. (To be
pedantic, the bytes might be initialized in Rust’s abstract machine, but
we don’t know, so we have to pretend they’re uninitialized.)

</div>

## Fields<a href="#fields" class="anchor">§</a>

<span id="structfield.ptr"
class="structfield section-header"><a href="#structfield.ptr" class="anchor field">§</a>`ptr: `<a href="https://doc.rust-lang.org/1.92.0/std/primitive.pointer.html"
class="primitive"><code>*mut T</code></a></span><span id="structfield.opt_value"
class="structfield section-header"><a href="#structfield.opt_value" class="anchor field">§</a>`opt_value: `<a href="enum.MemContents.html" class="enum"
title="enum vstd::raw_ptr::MemContents"><code>MemContents</code></a>`<T>`</span>

## Auto Trait Implementations<a href="#synthetic-implementations" class="anchor">§</a>

<div id="synthetic-implementations-list">

<div id="impl-Freeze-for-PointsToData%3CT%3E" class="section impl">

<a href="#impl-Freeze-for-PointsToData%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.PointsToData.html" class="struct"
...
<div id="impl-RefUnwindSafe-for-PointsToData%3CT%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-PointsToData%3CT%3E"
class="anchor">§</a>

### impl\<T\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.PointsToData.html" class="struct"
title="struct vstd::raw_ptr::PointsToData">PointsToData</a>\<T\>
...
<div id="impl-Send-for-PointsToData%3CT%3E" class="section impl">

<a href="#impl-Send-for-PointsToData%3CT%3E" class="anchor">§</a>

### impl\<T\> \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.PointsToData.html" class="struct"
title="struct vstd::raw_ptr::PointsToData">PointsToData</a>\<T\>

</div>

<div id="impl-Sync-for-PointsToData%3CT%3E" class="section impl">

<a href="#impl-Sync-for-PointsToData%3CT%3E" class="anchor">§</a>

### impl\<T\> \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.PointsToData.html" class="struct"
title="struct vstd::raw_ptr::PointsToData">PointsToData</a>\<T\>

</div>

<div id="impl-Unpin-for-PointsToData%3CT%3E" class="section impl">

<a href="#impl-Unpin-for-PointsToData%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.PointsToData.html" class="struct"
title="struct vstd::raw_ptr::PointsToData">PointsToData</a>\<T\>
...
<div id="impl-UnwindSafe-for-PointsToData%3CT%3E" class="section impl">

<a href="#impl-UnwindSafe-for-PointsToData%3CT%3E" class="anchor">§</a>

### impl\<T\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.PointsToData.html" class="struct"
title="struct vstd::raw_ptr::PointsToData">PointsToData</a>\<T\>
