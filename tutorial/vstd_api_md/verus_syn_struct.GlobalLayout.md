...
# Struct <span class="struct">GlobalLayout</span> Copy item path

<span class="sub-heading"><a href="../src/verus_syn/verus.rs.html#541-549" class="src">Source</a>
</span>
...
pub struct GlobalLayout {
    ...
    pub type_: Type,
    pub is_token: Is,
    pub size: (Ident, EqEq, ExprLit),
    pub align: Option<(Comma, Ident, EqEq, ExprLit)>,
}
```

## Fields<a href="#fields" class="anchor">§</a>

<span id="structfield.layout_token"
class="structfield section-header"><a href="#structfield.layout_token" class="anchor field">§</a>`layout_token: `<a href="token/struct.Layout.html" class="struct"
title="struct verus_syn::token::Layout"><code>Layout</code></a></span><span id="structfield.type_"
class="structfield section-header"><a href="#structfield.type_" class="anchor field">§</a>`type_: `<a href="enum.Type.html" class="enum"
title="enum verus_syn::Type"><code>Type</code></a></span><span id="structfield.is_token"
class="structfield section-header"><a href="#structfield.is_token" class="anchor field">§</a>`is_token: `<a href="token/struct.Is.html" class="struct"
title="struct verus_syn::token::Is"><code>Is</code></a></span><span id="structfield.size"
class="structfield section-header"><a href="#structfield.size" class="anchor field">§</a>`size: (`<a href="struct.Ident.html" class="struct"
title="struct verus_syn::Ident"><code>Ident</code></a>`, `<a href="token/struct.EqEq.html" class="struct"
title="struct verus_syn::token::EqEq"><code>EqEq</code></a>`, `<a href="struct.ExprLit.html" class="struct"
title="struct verus_syn::ExprLit"><code>ExprLit</code></a>`)`</span><span id="structfield.align"
class="structfield section-header"><a href="#structfield.align" class="anchor field">§</a>`align: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<(`<a href="token/struct.Comma.html" class="struct"
title="struct verus_syn::token::Comma"><code>Comma</code></a>`, `<a href="struct.Ident.html" class="struct"
title="struct verus_syn::Ident"><code>Ident</code></a>`, `<a href="token/struct.EqEq.html" class="struct"
title="struct verus_syn::token::EqEq"><code>EqEq</code></a>`, `<a href="struct.ExprLit.html" class="struct"
title="struct verus_syn::ExprLit"><code>ExprLit</code></a>`)>`</span>

## Trait Implementations<a href="#trait-implementations" class="anchor">§</a>

<div id="trait-implementations-list">

<div id="impl-Clone-for-GlobalLayout" class="section impl">

<a href="../src/verus_syn/gen/clone.rs.html#1326-1336"
class="src rightside">Source</a><a href="#impl-Clone-for-GlobalLayout" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/clone/trait.Clone.html"
class="trait" title="trait core::clone::Clone">Clone</a> for <a href="struct.GlobalLayout.html" class="struct"
...
<a href="../src/verus_syn/gen/clone.rs.html#1327-1335"
...
<div id="impl-Debug-for-GlobalLayout" class="section impl">

<a href="../src/verus_syn/gen/debug.rs.html#1966-1976"
class="src rightside">Source</a><a href="#impl-Debug-for-GlobalLayout" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/fmt/trait.Debug.html"
class="trait" title="trait core::fmt::Debug">Debug</a> for <a href="struct.GlobalLayout.html" class="struct"
title="struct verus_syn::GlobalLayout">GlobalLayout</a>
...
<a href="../src/verus_syn/gen/debug.rs.html#1967-1975"
...
<div id="impl-From%3CGlobalLayout%3E-for-GlobalInner"
class="section impl">

<a href="../src/verus_syn/verus.rs.html#551-556"
class="src rightside">Source</a><a href="#impl-From%3CGlobalLayout%3E-for-GlobalInner"
class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/convert/trait.From.html"
class="trait" title="trait core::convert::From">From</a>\<<a href="struct.GlobalLayout.html" class="struct"
title="struct verus_syn::GlobalLayout">GlobalLayout</a>\> for <a href="enum.GlobalInner.html" class="enum"
...
class="fn">from</a>(e: <a href="struct.GlobalLayout.html" class="struct"
title="struct verus_syn::GlobalLayout">GlobalLayout</a>) -\> <a href="enum.GlobalInner.html" class="enum"
title="enum verus_syn::GlobalInner">GlobalInner</a>
...
<div id="impl-Hash-for-GlobalLayout" class="section impl">

<a href="../src/verus_syn/gen/hash.rs.html#1727-1736"
class="src rightside">Source</a><a href="#impl-Hash-for-GlobalLayout" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/hash/trait.Hash.html"
class="trait" title="trait core::hash::Hash">Hash</a> for <a href="struct.GlobalLayout.html" class="struct"
title="struct verus_syn::GlobalLayout">GlobalLayout</a>
...
<a href="../src/verus_syn/gen/hash.rs.html#1728-1735"
...
<a href="../src/verus_syn/verus.rs.html#1519-1549"
...
<div id="impl-PartialEq-for-GlobalLayout" class="section impl">

<a href="../src/verus_syn/gen/eq.rs.html#1331-1335"
class="src rightside">Source</a><a href="#impl-PartialEq-for-GlobalLayout" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.PartialEq.html"
class="trait" title="trait core::cmp::PartialEq">PartialEq</a> for <a href="struct.GlobalLayout.html" class="struct"
title="struct verus_syn::GlobalLayout">GlobalLayout</a>
...
<a href="../src/verus_syn/gen/eq.rs.html#1332-1334"
...
<div id="impl-ToTokens-for-GlobalLayout" class="section impl">

<a href="../src/verus_syn/verus.rs.html#2107-2121"
class="src rightside">Source</a><a href="#impl-ToTokens-for-GlobalLayout" class="anchor">§</a>

### impl <a href="../quote/to_tokens/trait.ToTokens.html" class="trait"
title="trait quote::to_tokens::ToTokens">ToTokens</a> for <a href="struct.GlobalLayout.html" class="struct"
title="struct verus_syn::GlobalLayout">GlobalLayout</a>
...
<a href="../src/verus_syn/verus.rs.html#2108-2120"
...
<div id="impl-Eq-for-GlobalLayout" class="section impl">

<a href="../src/verus_syn/gen/eq.rs.html#1329"
class="src rightside">Source</a><a href="#impl-Eq-for-GlobalLayout" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.Eq.html"
class="trait" title="trait core::cmp::Eq">Eq</a> for <a href="struct.GlobalLayout.html" class="struct"
title="struct verus_syn::GlobalLayout">GlobalLayout</a>
...
<div id="impl-Freeze-for-GlobalLayout" class="section impl">

<a href="#impl-Freeze-for-GlobalLayout" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.GlobalLayout.html" class="struct"
title="struct verus_syn::GlobalLayout">GlobalLayout</a>

</div>

<div id="impl-RefUnwindSafe-for-GlobalLayout" class="section impl">

<a href="#impl-RefUnwindSafe-for-GlobalLayout" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.GlobalLayout.html" class="struct"
title="struct verus_syn::GlobalLayout">GlobalLayout</a>

</div>

<div id="impl-Send-for-GlobalLayout" class="section impl">

<a href="#impl-Send-for-GlobalLayout" class="anchor">§</a>

### impl \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.GlobalLayout.html" class="struct"
title="struct verus_syn::GlobalLayout">GlobalLayout</a>

</div>

<div id="impl-Sync-for-GlobalLayout" class="section impl">

<a href="#impl-Sync-for-GlobalLayout" class="anchor">§</a>

### impl \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.GlobalLayout.html" class="struct"
title="struct verus_syn::GlobalLayout">GlobalLayout</a>

</div>

<div id="impl-Unpin-for-GlobalLayout" class="section impl">

<a href="#impl-Unpin-for-GlobalLayout" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.GlobalLayout.html" class="struct"
title="struct verus_syn::GlobalLayout">GlobalLayout</a>

</div>

<div id="impl-UnwindSafe-for-GlobalLayout" class="section impl">

<a href="#impl-UnwindSafe-for-GlobalLayout" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.GlobalLayout.html" class="struct"
title="struct verus_syn::GlobalLayout">GlobalLayout</a>
