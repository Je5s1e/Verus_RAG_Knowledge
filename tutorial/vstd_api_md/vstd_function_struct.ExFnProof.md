...
[vstd](../index.html)::[function](index.html)

</div>

# Struct <span class="struct">ExFnProof</span> Copy item path

<span class="sub-heading"><a href="../../src/vstd/function.rs.html#12-14" class="src">Source</a>
</span>

</div>

``` rust
pub struct ExFnProof<'a, Options, ArgModes, OutMode, Args, Output>(/* private fields */);
```
...
<div id="impl-Freeze-for-ExFnProof%3C'a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="section impl">

<a
href="#impl-Freeze-for-ExFnProof%3C&#39;a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="anchor">§</a>

### impl\<'a, Options, ArgModes, OutMode, Args, Output\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.ExFnProof.html" class="struct"
title="struct vstd::function::ExFnProof">ExFnProof</a>\<'a, Options, ArgModes, OutMode, Args, Output\>

</div>

<div id="impl-RefUnwindSafe-for-ExFnProof%3C'a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="section impl">

<a
href="#impl-RefUnwindSafe-for-ExFnProof%3C&#39;a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="anchor">§</a>
...
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.ExFnProof.html" class="struct"
title="struct vstd::function::ExFnProof">ExFnProof</a>\<'a, Options, ArgModes, OutMode, Args, Output\>
...
<div id="impl-Send-for-ExFnProof%3C'a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="section impl">

<a
href="#impl-Send-for-ExFnProof%3C&#39;a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="anchor">§</a>

### impl\<'a, Options, ArgModes, OutMode, Args, Output\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.ExFnProof.html" class="struct"
title="struct vstd::function::ExFnProof">ExFnProof</a>\<'a, Options, ArgModes, OutMode, Args, Output\>
...
<div id="impl-Sync-for-ExFnProof%3C'a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="section impl">

<a
href="#impl-Sync-for-ExFnProof%3C&#39;a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="anchor">§</a>

### impl\<'a, Options, ArgModes, OutMode, Args, Output\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.ExFnProof.html" class="struct"
title="struct vstd::function::ExFnProof">ExFnProof</a>\<'a, Options, ArgModes, OutMode, Args, Output\>
...
<div id="impl-Unpin-for-ExFnProof%3C'a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="section impl">

<a
href="#impl-Unpin-for-ExFnProof%3C&#39;a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="anchor">§</a>

### impl\<'a, Options, ArgModes, OutMode, Args, Output\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.ExFnProof.html" class="struct"
title="struct vstd::function::ExFnProof">ExFnProof</a>\<'a, Options, ArgModes, OutMode, Args, Output\>
...
<div id="impl-UnwindSafe-for-ExFnProof%3C'a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="section impl">

<a
href="#impl-UnwindSafe-for-ExFnProof%3C&#39;a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="anchor">§</a>

### impl\<'a, Options, ArgModes, OutMode, Args, Output\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.ExFnProof.html" class="struct"
title="struct vstd::function::ExFnProof">ExFnProof</a>\<'a, Options, ArgModes, OutMode, Args, Output\>
