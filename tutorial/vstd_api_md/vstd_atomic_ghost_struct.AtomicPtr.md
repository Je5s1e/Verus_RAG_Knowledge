...
# Struct <span class="struct">AtomicPtr</span> Copy item path

<span class="sub-heading"><a href="../../src/vstd/atomic_ghost.rs.html#212" class="src">Source</a>
</span>

</div>

``` rust
pub struct AtomicPtr<T, K, G, Pred> { /* private fields */ }
```
...
Sequentially-consistent atomic memory location storing a `*mut T` and
associated ghost state.
...
<div id="impl-AtomicPtr%3CT,+K,+G,+Pred%3E" class="section impl">

<a href="../../src/vstd/atomic_ghost.rs.html#212"
class="src rightside">Source</a><a href="#impl-AtomicPtr%3CT,+K,+G,+Pred%3E" class="anchor">§</a>

### impl\<T, K, G, Pred\> <a href="struct.AtomicPtr.html" class="struct"
title="struct vstd::atomic_ghost::AtomicPtr">AtomicPtr</a>\<T, K, G, Pred\>

<div class="where">

where Pred: <a href="trait.AtomicInvariantPredicate.html" class="trait"
...
#### pub const fn <a href="#method.new" class="fn">new</a>( verus_tmp_k: <a href="../prelude/struct.Ghost.html" class="struct"
title="struct vstd::prelude::Ghost">Ghost</a>\<K\>, u: <a href="https://doc.rust-lang.org/1.92.0/std/primitive.pointer.html"
class="primitive">*mut T</a>, verus_tmp_g: <a href="../prelude/struct.Tracked.html" class="struct"
title="struct vstd::prelude::Tracked">Tracked</a>\<G\>, ) -\> Self
...
#### pub fn <a href="#method.load" class="fn">load</a>(&self) -\> <a href="https://doc.rust-lang.org/1.92.0/std/primitive.pointer.html"
...
#### pub fn <a href="#method.into_inner" class="fn">into_inner</a>(self) -\> (<a href="https://doc.rust-lang.org/1.92.0/std/primitive.pointer.html"
class="primitive">*mut T</a>, <a href="../prelude/struct.Tracked.html" class="struct"
title="struct vstd::prelude::Tracked">Tracked</a>\<G\>)
...
<div id="impl-Freeze-for-AtomicPtr%3CT,+K,+G,+Pred%3E"
class="section impl">

<a href="#impl-Freeze-for-AtomicPtr%3CT,+K,+G,+Pred%3E"
class="anchor">§</a>

### impl\<T, K, G, Pred\> \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.AtomicPtr.html" class="struct"
title="struct vstd::atomic_ghost::AtomicPtr">AtomicPtr</a>\<T, K, G, Pred\>

</div>

<div id="impl-RefUnwindSafe-for-AtomicPtr%3CT,+K,+G,+Pred%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-AtomicPtr%3CT,+K,+G,+Pred%3E"
class="anchor">§</a>

### impl\<T, K, G, Pred\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.AtomicPtr.html" class="struct"
title="struct vstd::atomic_ghost::AtomicPtr">AtomicPtr</a>\<T, K, G, Pred\>
...
<div id="impl-Send-for-AtomicPtr%3CT,+K,+G,+Pred%3E"
class="section impl">

<a href="#impl-Send-for-AtomicPtr%3CT,+K,+G,+Pred%3E"
class="anchor">§</a>

### impl\<T, K, G, Pred\> \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.AtomicPtr.html" class="struct"
title="struct vstd::atomic_ghost::AtomicPtr">AtomicPtr</a>\<T, K, G, Pred\>

</div>

<div id="impl-Sync-for-AtomicPtr%3CT,+K,+G,+Pred%3E"
class="section impl">

<a href="#impl-Sync-for-AtomicPtr%3CT,+K,+G,+Pred%3E"
class="anchor">§</a>

### impl\<T, K, G, Pred\> \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.AtomicPtr.html" class="struct"
title="struct vstd::atomic_ghost::AtomicPtr">AtomicPtr</a>\<T, K, G, Pred\>

</div>

<div id="impl-Unpin-for-AtomicPtr%3CT,+K,+G,+Pred%3E"
class="section impl">

<a href="#impl-Unpin-for-AtomicPtr%3CT,+K,+G,+Pred%3E"
class="anchor">§</a>

### impl\<T, K, G, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.AtomicPtr.html" class="struct"
title="struct vstd::atomic_ghost::AtomicPtr">AtomicPtr</a>\<T, K, G, Pred\>
...
<div id="impl-UnwindSafe-for-AtomicPtr%3CT,+K,+G,+Pred%3E"
class="section impl">

<a href="#impl-UnwindSafe-for-AtomicPtr%3CT,+K,+G,+Pred%3E"
class="anchor">§</a>

### impl\<T, K, G, Pred\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.AtomicPtr.html" class="struct"
title="struct vstd::atomic_ghost::AtomicPtr">AtomicPtr</a>\<T, K, G, Pred\>
...
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a>, G: <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
