...
# Struct <span class="struct">AtomicInvariant</span> Copy item path

<span class="sub-heading"><a href="../../src/vstd/invariant.rs.html#122-125"
...
An `AtomicInvariant` implements
[`Sync`](https://doc.rust-lang.org/std/sync/) and may be shared between
threads. However, this means that an `AtomicInvariant` can be only
opened for the duration of a single *sequentially consistent atomic*
operation. Such operations are provided by our
[`PAtomic`](../atomic/index.html "mod vstd::atomic") library. For an
invariant object without this atomicity restriction, see
...
- A *predicate* specified via the `InvariantPredicate` type bound, that
  determines what values `V` may be saved inside the invariant.
- A *constant* `K`, specified at construction type. The predicate
  function takes this constant as a parameter, so the constant allows
  users to dynamically configure the predicate function in a way that
  can’t be done at the type level.
- A *namespace*. This is a bit of a technicality, and you can often just
  declare it as an arbitrary integer with no issues. See the
  [`open_local_invariant!`](../macro.open_local_invariant.html "macro vstd::open_local_invariant")
  documentation for more details.

The constant and namespace are specified at construction time
(\[`AtomicInvariant::new`\]). These values are fixed for the lifetime of
the `AtomicInvariant` object. To open the invariant and access the
stored object `V`, use the macro
[`open_atomic_invariant!`](../macro.open_atomic_invariant.html "macro vstd::open_atomic_invariant").

The `AtomicInvariant` API is an instance of the [“invariant” method in
Verus’s general philosophy on interior
mutability](https://verus-lang.github.io/verus/guide/interior_mutability.html).

**Note:** Rather than using `AtomicInvariant` directly, we generally
recommend using the [`atomic_ghost`
...
<div id="impl-Freeze-for-AtomicInvariant%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-Freeze-for-AtomicInvariant%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.AtomicInvariant.html" class="struct"
title="struct vstd::invariant::AtomicInvariant">AtomicInvariant</a>\<K, V, Pred\>

</div>

<div id="impl-RefUnwindSafe-for-AtomicInvariant%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-AtomicInvariant%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.AtomicInvariant.html" class="struct"
title="struct vstd::invariant::AtomicInvariant">AtomicInvariant</a>\<K, V, Pred\>
...
<div id="impl-Send-for-AtomicInvariant%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-Send-for-AtomicInvariant%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.AtomicInvariant.html" class="struct"
title="struct vstd::invariant::AtomicInvariant">AtomicInvariant</a>\<K, V, Pred\>
...
<div id="impl-Sync-for-AtomicInvariant%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-Sync-for-AtomicInvariant%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.AtomicInvariant.html" class="struct"
title="struct vstd::invariant::AtomicInvariant">AtomicInvariant</a>\<K, V, Pred\>
...
<div id="impl-Unpin-for-AtomicInvariant%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-Unpin-for-AtomicInvariant%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.AtomicInvariant.html" class="struct"
title="struct vstd::invariant::AtomicInvariant">AtomicInvariant</a>\<K, V, Pred\>
...
<div id="impl-UnwindSafe-for-AtomicInvariant%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-UnwindSafe-for-AtomicInvariant%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.AtomicInvariant.html" class="struct"
title="struct vstd::invariant::AtomicInvariant">AtomicInvariant</a>\<K, V, Pred\>
