...
# Struct <span class="struct">ItemImpl</span> Copy item path

<span class="sub-heading"><a href="../src/verus_syn/item.rs.html#190-207" class="src">Source</a>
</span>
...
title="struct verus_syn::Attribute"><code>Attribute</code></a>`>`</span><span id="structfield.defaultness"
...
title="struct verus_syn::token::Default"><code>Default</code></a>`>`</span><span id="structfield.unsafety"
...
title="struct verus_syn::token::Unsafe"><code>Unsafe</code></a>`>`</span><span id="structfield.impl_token"
class="structfield section-header"><a href="#structfield.impl_token" class="anchor field">§</a>`impl_token: `<a href="token/struct.Impl.html" class="struct"
title="struct verus_syn::token::Impl"><code>Impl</code></a></span><span id="structfield.generics"
...
title="struct verus_syn::Generics"><code>Generics</code></a></span><span id="structfield.trait_"
class="structfield section-header"><a href="#structfield.trait_" class="anchor field">§</a>`trait_: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<(`<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<`<a href="token/struct.Not.html" class="struct"
title="struct verus_syn::token::Not"><code>Not</code></a>`>, `<a href="struct.Path.html" class="struct"
title="struct verus_syn::Path"><code>Path</code></a>`, `<a href="token/struct.For.html" class="struct"
title="struct verus_syn::token::For"><code>For</code></a>`)>`</span>
...
<span id="structfield.self_ty"
class="structfield section-header"><a href="#structfield.self_ty" class="anchor field">§</a>`self_ty: `<a href="https://doc.rust-lang.org/1.92.0/alloc/boxed/struct.Box.html"
class="struct" title="struct alloc::boxed::Box"><code>Box</code></a>`<`<a href="enum.Type.html" class="enum"
title="enum verus_syn::Type"><code>Type</code></a>`>`</span>
...
<span id="structfield.brace_token"
...
class="struct" title="struct alloc::vec::Vec"><code>Vec</code></a>`<`<a href="enum.ImplItem.html" class="enum"
title="enum verus_syn::ImplItem"><code>ImplItem</code></a>`>`</span>

## Trait Implementations<a href="#trait-implementations" class="anchor">§</a>

<div id="trait-implementations-list">

<div id="impl-Clone-for-ItemImpl" class="section impl">

<a href="../src/verus_syn/gen/clone.rs.html#1645-1659"
class="src rightside">Source</a><a href="#impl-Clone-for-ItemImpl" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/clone/trait.Clone.html"
class="trait" title="trait core::clone::Clone">Clone</a> for <a href="struct.ItemImpl.html" class="struct"
...
<a href="../src/verus_syn/gen/clone.rs.html#1646-1658"
...
<div id="impl-Debug-for-ItemImpl" class="section impl">

<a href="../src/verus_syn/gen/debug.rs.html#2383-2387"
class="src rightside">Source</a><a href="#impl-Debug-for-ItemImpl" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/fmt/trait.Debug.html"
class="trait" title="trait core::fmt::Debug">Debug</a> for <a href="struct.ItemImpl.html" class="struct"
title="struct verus_syn::ItemImpl">ItemImpl</a>
...
<a href="../src/verus_syn/gen/debug.rs.html#2384-2386"
...
<div id="impl-Hash-for-ItemImpl" class="section impl">

<a href="../src/verus_syn/gen/hash.rs.html#2122-2135"
class="src rightside">Source</a><a href="#impl-Hash-for-ItemImpl" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/hash/trait.Hash.html"
class="trait" title="trait core::hash::Hash">Hash</a> for <a href="struct.ItemImpl.html" class="struct"
title="struct verus_syn::ItemImpl">ItemImpl</a>
...
<a href="../src/verus_syn/gen/hash.rs.html#2123-2134"
...
<a href="../src/verus_syn/item.rs.html#2758-2761"
...
<div id="impl-PartialEq-for-ItemImpl" class="section impl">

<a href="../src/verus_syn/gen/eq.rs.html#1637-1644"
class="src rightside">Source</a><a href="#impl-PartialEq-for-ItemImpl" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.PartialEq.html"
class="trait" title="trait core::cmp::PartialEq">PartialEq</a> for <a href="struct.ItemImpl.html" class="struct"
title="struct verus_syn::ItemImpl">ItemImpl</a>
...
<a href="../src/verus_syn/gen/eq.rs.html#1638-1643"
...
<div id="impl-ToTokens-for-ItemImpl" class="section impl">

<a href="../src/verus_syn/item.rs.html#3415-3434"
class="src rightside">Source</a><a href="#impl-ToTokens-for-ItemImpl" class="anchor">§</a>

### impl <a href="../quote/to_tokens/trait.ToTokens.html" class="trait"
title="trait quote::to_tokens::ToTokens">ToTokens</a> for <a href="struct.ItemImpl.html" class="struct"
title="struct verus_syn::ItemImpl">ItemImpl</a>
...
<a href="../src/verus_syn/item.rs.html#3416-3433"
...
<div id="impl-Eq-for-ItemImpl" class="section impl">

<a href="../src/verus_syn/gen/eq.rs.html#1634"
class="src rightside">Source</a><a href="#impl-Eq-for-ItemImpl" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.Eq.html"
class="trait" title="trait core::cmp::Eq">Eq</a> for <a href="struct.ItemImpl.html" class="struct"
title="struct verus_syn::ItemImpl">ItemImpl</a>
...
<div id="impl-Freeze-for-ItemImpl" class="section impl">

<a href="#impl-Freeze-for-ItemImpl" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.ItemImpl.html" class="struct"
title="struct verus_syn::ItemImpl">ItemImpl</a>

</div>

<div id="impl-RefUnwindSafe-for-ItemImpl" class="section impl">

<a href="#impl-RefUnwindSafe-for-ItemImpl" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.ItemImpl.html" class="struct"
title="struct verus_syn::ItemImpl">ItemImpl</a>

</div>

<div id="impl-Send-for-ItemImpl" class="section impl">

<a href="#impl-Send-for-ItemImpl" class="anchor">§</a>

### impl \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.ItemImpl.html" class="struct"
title="struct verus_syn::ItemImpl">ItemImpl</a>

</div>

<div id="impl-Sync-for-ItemImpl" class="section impl">

<a href="#impl-Sync-for-ItemImpl" class="anchor">§</a>

### impl \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.ItemImpl.html" class="struct"
title="struct verus_syn::ItemImpl">ItemImpl</a>

</div>

<div id="impl-Unpin-for-ItemImpl" class="section impl">

<a href="#impl-Unpin-for-ItemImpl" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.ItemImpl.html" class="struct"
title="struct verus_syn::ItemImpl">ItemImpl</a>

</div>

<div id="impl-UnwindSafe-for-ItemImpl" class="section impl">

<a href="#impl-UnwindSafe-for-ItemImpl" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.ItemImpl.html" class="struct"
title="struct verus_syn::ItemImpl">ItemImpl</a>
