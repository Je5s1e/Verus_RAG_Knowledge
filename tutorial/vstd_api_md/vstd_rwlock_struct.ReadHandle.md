...
# Struct <span class="struct">ReadHandle</span> Copy item path

<span class="sub-heading"><a href="../../src/vstd/rwlock.rs.html#384-387" class="src">Source</a>
</span>

</div>

``` rust
pub struct ReadHandle<'a, V, Pred: RwLockPredicate<V>> { /* private fields */ }
```
...
[`release_read`](struct.ReadHandle.html#method.release_read "method vstd::rwlock::ReadHandle::release_read").
...
<div id="impl-ReadHandle%3C'a,+V,+Pred%3E" class="section impl">

<a href="../../src/vstd/rwlock.rs.html#421-487"
class="src rightside">Source</a><a href="#impl-ReadHandle%3C&#39;a,+V,+Pred%3E" class="anchor">§</a>

### impl\<'a, V, Pred: <a href="trait.RwLockPredicate.html" class="trait"
title="trait vstd::rwlock::RwLockPredicate">RwLockPredicate</a>\<V\>\> <a href="struct.ReadHandle.html" class="struct"
title="struct vstd::rwlock::ReadHandle">ReadHandle</a>\<'a, V, Pred\>
...
<a href="../../src/vstd/rwlock.rs.html#440-452"
class="src rightside">Source</a>

#### pub fn <a href="#method.borrow" class="fn">borrow</a>\<'b\>(&'b self) -\> <a href="https://doc.rust-lang.org/1.92.0/std/primitive.reference.html"
class="primitive">&amp;'b V</a>
...
<div id="method.release_read" class="section method">

<a href="../../src/vstd/rwlock.rs.html#473-486"
class="src rightside">Source</a>

#### pub fn <a href="#method.release_read" class="fn">release_read</a>(self)
...
<div id="impl-Freeze-for-ReadHandle%3C'a,+V,+Pred%3E"
class="section impl">

<a href="#impl-Freeze-for-ReadHandle%3C&#39;a,+V,+Pred%3E"
class="anchor">§</a>

### impl\<'a, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.ReadHandle.html" class="struct"
title="struct vstd::rwlock::ReadHandle">ReadHandle</a>\<'a, V, Pred\>

</div>

<div id="impl-RefUnwindSafe-for-ReadHandle%3C'a,+V,+Pred%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-ReadHandle%3C&#39;a,+V,+Pred%3E"
class="anchor">§</a>

### impl\<'a, V, Pred\> \!<a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.ReadHandle.html" class="struct"
title="struct vstd::rwlock::ReadHandle">ReadHandle</a>\<'a, V, Pred\>

</div>

<div id="impl-Send-for-ReadHandle%3C'a,+V,+Pred%3E"
class="section impl">

<a href="#impl-Send-for-ReadHandle%3C&#39;a,+V,+Pred%3E"
class="anchor">§</a>

### impl\<'a, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.ReadHandle.html" class="struct"
title="struct vstd::rwlock::ReadHandle">ReadHandle</a>\<'a, V, Pred\>
...
<div id="impl-Sync-for-ReadHandle%3C'a,+V,+Pred%3E"
class="section impl">

<a href="#impl-Sync-for-ReadHandle%3C&#39;a,+V,+Pred%3E"
class="anchor">§</a>

### impl\<'a, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.ReadHandle.html" class="struct"
title="struct vstd::rwlock::ReadHandle">ReadHandle</a>\<'a, V, Pred\>
...
<div id="impl-Unpin-for-ReadHandle%3C'a,+V,+Pred%3E"
class="section impl">

<a href="#impl-Unpin-for-ReadHandle%3C&#39;a,+V,+Pred%3E"
class="anchor">§</a>

### impl\<'a, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.ReadHandle.html" class="struct"
title="struct vstd::rwlock::ReadHandle">ReadHandle</a>\<'a, V, Pred\>
...
<div id="impl-UnwindSafe-for-ReadHandle%3C'a,+V,+Pred%3E"
class="section impl">

<a href="#impl-UnwindSafe-for-ReadHandle%3C&#39;a,+V,+Pred%3E"
class="anchor">§</a>

### impl\<'a, V, Pred\> \!<a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.ReadHandle.html" class="struct"
title="struct vstd::rwlock::ReadHandle">ReadHandle</a>\<'a, V, Pred\>
