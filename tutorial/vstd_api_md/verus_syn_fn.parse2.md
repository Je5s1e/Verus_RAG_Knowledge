...
<span class="sub-heading"><a href="../src/verus_syn/lib.rs.html#936-938" class="src">Source</a>
</span>
...
[`Macro`](struct.Macro.html "struct verus_syn::Macro") node. When in a
procedural macro parsing the `proc_macro::TokenStream` provided by the
compiler, use [`syn::parse`](fn.parse.html "fn verus_syn::parse")
instead.
