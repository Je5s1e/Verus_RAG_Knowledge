...
# Struct <span class="struct">Bucket</span> Copy item path

<span class="sub-heading"><a href="../../src/hashbrown/raw/mod.rs.html#273-279"
...
This is usually just a pointer to the element itself. However if the
element is a ZST, then we instead track the index of the element in the
table so that `erase` works properly.
...
<div id="impl-Bucket%3CT%3E" class="section impl">

<a href="../../src/hashbrown/raw/mod.rs.html#292-358"
class="src rightside">Source</a><a href="#impl-Bucket%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="struct.Bucket.html" class="struct"
...
<div id="method.as_ptr" class="section method">

<a href="../../src/hashbrown/raw/mod.rs.html#314-321"
class="src rightside">Source</a>

#### pub fn <a href="#method.as_ptr" class="fn">as_ptr</a>(&self) -\> <a href="https://doc.rust-lang.org/1.92.0/core/primitive.pointer.html"
class="primitive">*mut T</a>

</div>

<div id="method.drop" class="section method">

<a href="../../src/hashbrown/raw/mod.rs.html#334-336"
class="src rightside">Source</a>

#### pub unsafe fn <a href="#method.drop" class="fn">drop</a>(&self)

</div>

<div id="method.read" class="section method">

<a href="../../src/hashbrown/raw/mod.rs.html#338-340"
class="src rightside">Source</a>

#### pub unsafe fn <a href="#method.read" class="fn">read</a>(&self) -\> T

</div>

<div id="method.write" class="section method">

<a href="../../src/hashbrown/raw/mod.rs.html#342-344"
class="src rightside">Source</a>

#### pub unsafe fn <a href="#method.write" class="fn">write</a>(&self, val: T)

</div>

<div id="method.as_ref" class="section method">

<a href="../../src/hashbrown/raw/mod.rs.html#346-348"
class="src rightside">Source</a>

#### pub unsafe fn <a href="#method.as_ref" class="fn">as_ref</a>\<'a\>(&self) -\> <a href="https://doc.rust-lang.org/1.92.0/core/primitive.reference.html"
class="primitive">&amp;'a T</a>

</div>

<div id="method.as_mut" class="section method">

<a href="../../src/hashbrown/raw/mod.rs.html#350-352"
class="src rightside">Source</a>

#### pub unsafe fn <a href="#method.as_mut" class="fn">as_mut</a>\<'a\>(&self) -\> <a href="https://doc.rust-lang.org/1.92.0/core/primitive.reference.html"
class="primitive">&amp;'a mut T</a>

</div>

<div id="method.copy_from_nonoverlapping" class="section method">

<a href="../../src/hashbrown/raw/mod.rs.html#355-357"
class="src rightside">Source</a>

#### pub unsafe fn <a href="#method.copy_from_nonoverlapping"
class="fn">copy_from_nonoverlapping</a>(&self, other: &Self)
...
<div id="impl-Clone-for-Bucket%3CT%3E" class="section impl">

<a href="../../src/hashbrown/raw/mod.rs.html#285-290"
class="src rightside">Source</a><a href="#impl-Clone-for-Bucket%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/clone/trait.Clone.html"
class="trait" title="trait core::clone::Clone">Clone</a> for <a href="struct.Bucket.html" class="struct"
title="struct hashbrown::raw::Bucket">Bucket</a>\<T\>
...
<a href="../../src/hashbrown/raw/mod.rs.html#287-289"
...
<div id="impl-Send-for-Bucket%3CT%3E" class="section impl">

<a href="../../src/hashbrown/raw/mod.rs.html#283"
class="src rightside">Source</a><a href="#impl-Send-for-Bucket%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.Bucket.html" class="struct"
title="struct hashbrown::raw::Bucket">Bucket</a>\<T\>
...
<div id="impl-Freeze-for-Bucket%3CT%3E" class="section impl">

<a href="#impl-Freeze-for-Bucket%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.Bucket.html" class="struct"
title="struct hashbrown::raw::Bucket">Bucket</a>\<T\>

</div>

<div id="impl-RefUnwindSafe-for-Bucket%3CT%3E" class="section impl">

<a href="#impl-RefUnwindSafe-for-Bucket%3CT%3E" class="anchor">§</a>

### impl\<T\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.Bucket.html" class="struct"
title="struct hashbrown::raw::Bucket">Bucket</a>\<T\>
...
<div id="impl-Sync-for-Bucket%3CT%3E" class="section impl">

<a href="#impl-Sync-for-Bucket%3CT%3E" class="anchor">§</a>

### impl\<T\> \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.Bucket.html" class="struct"
title="struct hashbrown::raw::Bucket">Bucket</a>\<T\>

</div>

<div id="impl-Unpin-for-Bucket%3CT%3E" class="section impl">

<a href="#impl-Unpin-for-Bucket%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.Bucket.html" class="struct"
title="struct hashbrown::raw::Bucket">Bucket</a>\<T\>

</div>

<div id="impl-UnwindSafe-for-Bucket%3CT%3E" class="section impl">

<a href="#impl-UnwindSafe-for-Bucket%3CT%3E" class="anchor">§</a>

### impl\<T\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.Bucket.html" class="struct"
title="struct hashbrown::raw::Bucket">Bucket</a>\<T\>
