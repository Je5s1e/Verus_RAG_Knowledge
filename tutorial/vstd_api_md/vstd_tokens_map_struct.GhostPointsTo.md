...
[vstd](../../index.html)::[tokens](../index.html)::[map](index.html)

</div>

# Struct <span class="struct">GhostPointsTo</span> Copy item path

<span class="sub-heading"><a href="../../../src/vstd/tokens/map.rs.html#331-333"
...
The existence of a
[`GhostPointsTo`](struct.GhostPointsTo.html "struct vstd::tokens::map::GhostPointsTo")
implies that:

- Those key will remain in the map (unless the onwer of the
  [`GhostPointsTo`](struct.GhostPointsTo.html "struct vstd::tokens::map::GhostPointsTo")
  deletes it using \[`GhostMapAuth::delete_points_to`\]);
- Those key will remain pointing to the same value (unless the onwer of
  the
  [`GhostPointsTo`](struct.GhostPointsTo.html "struct vstd::tokens::map::GhostPointsTo")
  updates them using \[`GhostPointsTo::update`\])
- All other
  [`GhostSubmap`](struct.GhostSubmap.html "struct vstd::tokens::map::GhostSubmap")/[`GhostPointsTo`](struct.GhostPointsTo.html "struct vstd::tokens::map::GhostPointsTo")/[`GhostPersistentSubmap`](struct.GhostPersistentSubmap.html "struct vstd::tokens::map::GhostPersistentSubmap")/[`GhostPersistentPointsTo`](struct.GhostPersistentPointsTo.html "struct vstd::tokens::map::GhostPersistentPointsTo")
  are disjoint subsets of the domain
...
<div id="impl-Freeze-for-GhostPointsTo%3CK,+V%3E" class="section impl">

<a href="#impl-Freeze-for-GhostPointsTo%3CK,+V%3E" class="anchor">§</a>

### impl\<K, V\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.GhostPointsTo.html" class="struct"
title="struct vstd::tokens::map::GhostPointsTo">GhostPointsTo</a>\<K, V\>

</div>

<div id="impl-RefUnwindSafe-for-GhostPointsTo%3CK,+V%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-GhostPointsTo%3CK,+V%3E"
class="anchor">§</a>

### impl\<K, V\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.GhostPointsTo.html" class="struct"
title="struct vstd::tokens::map::GhostPointsTo">GhostPointsTo</a>\<K, V\>
...
<div id="impl-Send-for-GhostPointsTo%3CK,+V%3E" class="section impl">

<a href="#impl-Send-for-GhostPointsTo%3CK,+V%3E" class="anchor">§</a>

### impl\<K, V\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.GhostPointsTo.html" class="struct"
title="struct vstd::tokens::map::GhostPointsTo">GhostPointsTo</a>\<K, V\>
...
<div id="impl-Sync-for-GhostPointsTo%3CK,+V%3E" class="section impl">

<a href="#impl-Sync-for-GhostPointsTo%3CK,+V%3E" class="anchor">§</a>

### impl\<K, V\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.GhostPointsTo.html" class="struct"
title="struct vstd::tokens::map::GhostPointsTo">GhostPointsTo</a>\<K, V\>
...
<div id="impl-Unpin-for-GhostPointsTo%3CK,+V%3E" class="section impl">

<a href="#impl-Unpin-for-GhostPointsTo%3CK,+V%3E" class="anchor">§</a>

### impl\<K, V\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.GhostPointsTo.html" class="struct"
title="struct vstd::tokens::map::GhostPointsTo">GhostPointsTo</a>\<K, V\>
...
<div id="impl-UnwindSafe-for-GhostPointsTo%3CK,+V%3E"
class="section impl">

<a href="#impl-UnwindSafe-for-GhostPointsTo%3CK,+V%3E"
class="anchor">§</a>

### impl\<K, V\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.GhostPointsTo.html" class="struct"
title="struct vstd::tokens::map::GhostPointsTo">GhostPointsTo</a>\<K, V\>
