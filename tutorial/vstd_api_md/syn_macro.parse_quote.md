...
<span class="sub-heading"><a href="../src/syn/parse_quote.rs.html#80-84" class="src">Source</a>
</span>
...
[`Parse`](parse/trait.Parse.html "trait syn::parse::Parse") trait.
...
- [`Attribute`](struct.Attribute.html "struct syn::Attribute") — parses
  one attribute, allowing either outer like `#[...]` or inner like
  `#![...]`
- [`Vec<Attribute>`](struct.Attribute.html "struct syn::Attribute") —
  parses multiple attributes, including mixed kinds in any order
- [`Punctuated<T, P>`](punctuated/struct.Punctuated.html "struct syn::punctuated::Punctuated")
  — parses zero or more `T` separated by punctuation `P` with optional
  trailing punctuation
- [`Vec<Arm>`](struct.Arm.html "struct syn::Arm") — parses arms
  separated by optional commas according to the same grammar as the
  inside of a `match` expression
- [`Vec<Stmt>`](struct.Block.html#method.parse_within "associated function syn::Block::parse_within")
  — parses the same as `Block::parse_within`
- [`Pat`](enum.Pat.html#method.parse_multi_with_leading_vert "associated function syn::Pat::parse_multi_with_leading_vert"),
  [`Box<Pat>`](enum.Pat.html#method.parse_multi_with_leading_vert "associated function syn::Pat::parse_multi_with_leading_vert")
  — parses the same as `Pat::parse_multi_with_leading_vert`
- [`Field`](struct.Field.html "struct syn::Field") — parses a named or
