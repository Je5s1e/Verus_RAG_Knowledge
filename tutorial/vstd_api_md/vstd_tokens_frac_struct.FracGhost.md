...
[vstd](../../index.html)::[tokens](../index.html)::[frac](index.html)

</div>

# Struct <span class="struct">FracGhost</span> Copy item path

<span class="sub-heading"><a href="../../../src/vstd/tokens/frac.rs.html#123-125"
...
While most presentations of fractional permissions use the fractional
total of 1, with fractions being arbitrary rational numbers, this
library represents fractional permissions as integers, totalling to some
compile-time constant `TOTAL`. Thus, you can have any fractions from 1
up to `TOTAL`, and if you have `TOTAL`, you can update the ghost
variable.
...
<div id="impl-Freeze-for-FracGhost%3CT,+TOTAL%3E" class="section impl">

<a href="#impl-Freeze-for-FracGhost%3CT,+TOTAL%3E" class="anchor">§</a>

### impl\<T, const TOTAL: <a href="https://doc.rust-lang.org/1.92.0/std/primitive.u64.html"
class="primitive">u64</a>\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.FracGhost.html" class="struct"
title="struct vstd::tokens::frac::FracGhost">FracGhost</a>\<T, TOTAL\>

</div>

<div id="impl-RefUnwindSafe-for-FracGhost%3CT,+TOTAL%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-FracGhost%3CT,+TOTAL%3E"
class="anchor">§</a>

### impl\<T, const TOTAL: <a href="https://doc.rust-lang.org/1.92.0/std/primitive.u64.html"
class="primitive">u64</a>\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.FracGhost.html" class="struct"
title="struct vstd::tokens::frac::FracGhost">FracGhost</a>\<T, TOTAL\>
...
<div id="impl-Send-for-FracGhost%3CT,+TOTAL%3E" class="section impl">

<a href="#impl-Send-for-FracGhost%3CT,+TOTAL%3E" class="anchor">§</a>

### impl\<T, const TOTAL: <a href="https://doc.rust-lang.org/1.92.0/std/primitive.u64.html"
class="primitive">u64</a>\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.FracGhost.html" class="struct"
title="struct vstd::tokens::frac::FracGhost">FracGhost</a>\<T, TOTAL\>
...
<div id="impl-Sync-for-FracGhost%3CT,+TOTAL%3E" class="section impl">

<a href="#impl-Sync-for-FracGhost%3CT,+TOTAL%3E" class="anchor">§</a>

### impl\<T, const TOTAL: <a href="https://doc.rust-lang.org/1.92.0/std/primitive.u64.html"
class="primitive">u64</a>\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.FracGhost.html" class="struct"
title="struct vstd::tokens::frac::FracGhost">FracGhost</a>\<T, TOTAL\>
...
<div id="impl-Unpin-for-FracGhost%3CT,+TOTAL%3E" class="section impl">

<a href="#impl-Unpin-for-FracGhost%3CT,+TOTAL%3E" class="anchor">§</a>

### impl\<T, const TOTAL: <a href="https://doc.rust-lang.org/1.92.0/std/primitive.u64.html"
class="primitive">u64</a>\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.FracGhost.html" class="struct"
title="struct vstd::tokens::frac::FracGhost">FracGhost</a>\<T, TOTAL\>
...
<div id="impl-UnwindSafe-for-FracGhost%3CT,+TOTAL%3E"
class="section impl">

<a href="#impl-UnwindSafe-for-FracGhost%3CT,+TOTAL%3E"
class="anchor">§</a>
...
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.FracGhost.html" class="struct"
title="struct vstd::tokens::frac::FracGhost">FracGhost</a>\<T, TOTAL\>
