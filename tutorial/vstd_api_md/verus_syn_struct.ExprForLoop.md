...
# Struct <span class="struct">ExprForLoop</span> Copy item path

<span class="sub-heading"><a href="../src/verus_syn/expr.rs.html#442-457" class="src">Source</a>
</span>
...
pub struct ExprForLoop {
    ...
    pub pat: Box<Pat>,
    pub in_token: In,
    pub expr_name: Option<Box<(Ident, Colon)>>,
    pub expr: Box<Expr>,
...
title="struct verus_syn::Attribute"><code>Attribute</code></a>`>`</span><span id="structfield.label"
class="structfield section-header"><a href="#structfield.label" class="anchor field">§</a>`label: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<`<a href="struct.Label.html" class="struct"
title="struct verus_syn::Label"><code>Label</code></a>`>`</span><span id="structfield.for_token"
class="structfield section-header"><a href="#structfield.for_token" class="anchor field">§</a>`for_token: `<a href="token/struct.For.html" class="struct"
title="struct verus_syn::token::For"><code>For</code></a></span><span id="structfield.pat"
class="structfield section-header"><a href="#structfield.pat" class="anchor field">§</a>`pat: `<a href="https://doc.rust-lang.org/1.92.0/alloc/boxed/struct.Box.html"
class="struct" title="struct alloc::boxed::Box"><code>Box</code></a>`<`<a href="enum.Pat.html" class="enum"
title="enum verus_syn::Pat"><code>Pat</code></a>`>`</span><span id="structfield.in_token"
class="structfield section-header"><a href="#structfield.in_token" class="anchor field">§</a>`in_token: `<a href="token/struct.In.html" class="struct"
title="struct verus_syn::token::In"><code>In</code></a></span><span id="structfield.expr_name"
class="structfield section-header"><a href="#structfield.expr_name" class="anchor field">§</a>`expr_name: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
...
class="struct" title="struct alloc::boxed::Box"><code>Box</code></a>`<(`<a href="struct.Ident.html" class="struct"
title="struct verus_syn::Ident"><code>Ident</code></a>`, `<a href="token/struct.Colon.html" class="struct"
title="struct verus_syn::token::Colon"><code>Colon</code></a>`)>>`</span><span id="structfield.expr"
...
title="enum verus_syn::Expr"><code>Expr</code></a>`>`</span><span id="structfield.invariant"
class="structfield section-header"><a href="#structfield.invariant" class="anchor field">§</a>`invariant: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<`<a href="struct.Invariant.html" class="struct"
title="struct verus_syn::Invariant"><code>Invariant</code></a>`>`</span><span id="structfield.decreases"
...
class="enum" title="enum core::option::Option"><code>Option</code></a>`<`<a href="struct.Decreases.html" class="struct"
title="struct verus_syn::Decreases"><code>Decreases</code></a>`>`</span><span id="structfield.body"
class="structfield section-header"><a href="#structfield.body" class="anchor field">§</a>`body: `<a href="struct.Block.html" class="struct"
...
<div id="impl-Clone-for-ExprForLoop" class="section impl">

<a href="../src/verus_syn/gen/clone.rs.html#660-675"
class="src rightside">Source</a><a href="#impl-Clone-for-ExprForLoop" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/clone/trait.Clone.html"
class="trait" title="trait core::clone::Clone">Clone</a> for <a href="struct.ExprForLoop.html" class="struct"
...
<a href="../src/verus_syn/gen/clone.rs.html#661-674"
...
<div id="impl-Debug-for-ExprForLoop" class="section impl">

<a href="../src/verus_syn/gen/debug.rs.html#1006-1010"
class="src rightside">Source</a><a href="#impl-Debug-for-ExprForLoop" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/fmt/trait.Debug.html"
class="trait" title="trait core::fmt::Debug">Debug</a> for <a href="struct.ExprForLoop.html" class="struct"
title="struct verus_syn::ExprForLoop">ExprForLoop</a>
...
<a href="../src/verus_syn/gen/debug.rs.html#1007-1009"
...
<div id="impl-Hash-for-ExprForLoop" class="section impl">

<a href="../src/verus_syn/gen/hash.rs.html#965-979"
class="src rightside">Source</a><a href="#impl-Hash-for-ExprForLoop" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/hash/trait.Hash.html"
class="trait" title="trait core::hash::Hash">Hash</a> for <a href="struct.ExprForLoop.html" class="struct"
title="struct verus_syn::ExprForLoop">ExprForLoop</a>
...
<a href="../src/verus_syn/gen/hash.rs.html#966-978"
...
<a href="../src/verus_syn/expr.rs.html#2522-2557"
...
<div id="impl-PartialEq-for-ExprForLoop" class="section impl">

<a href="../src/verus_syn/gen/eq.rs.html#672-679"
class="src rightside">Source</a><a href="#impl-PartialEq-for-ExprForLoop" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.PartialEq.html"
class="trait" title="trait core::cmp::PartialEq">PartialEq</a> for <a href="struct.ExprForLoop.html" class="struct"
title="struct verus_syn::ExprForLoop">ExprForLoop</a>
...
<a href="../src/verus_syn/gen/eq.rs.html#673-678"
...
<div id="impl-ToTokens-for-ExprForLoop" class="section impl">

<a href="../src/verus_syn/expr.rs.html#3926-3946"
class="src rightside">Source</a><a href="#impl-ToTokens-for-ExprForLoop" class="anchor">§</a>

### impl <a href="../quote/to_tokens/trait.ToTokens.html" class="trait"
title="trait quote::to_tokens::ToTokens">ToTokens</a> for <a href="struct.ExprForLoop.html" class="struct"
title="struct verus_syn::ExprForLoop">ExprForLoop</a>
...
<a href="../src/verus_syn/expr.rs.html#3927-3945"
...
<div id="impl-Eq-for-ExprForLoop" class="section impl">

<a href="../src/verus_syn/gen/eq.rs.html#669"
class="src rightside">Source</a><a href="#impl-Eq-for-ExprForLoop" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.Eq.html"
class="trait" title="trait core::cmp::Eq">Eq</a> for <a href="struct.ExprForLoop.html" class="struct"
title="struct verus_syn::ExprForLoop">ExprForLoop</a>
...
<div id="impl-Freeze-for-ExprForLoop" class="section impl">

<a href="#impl-Freeze-for-ExprForLoop" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.ExprForLoop.html" class="struct"
title="struct verus_syn::ExprForLoop">ExprForLoop</a>

</div>

<div id="impl-RefUnwindSafe-for-ExprForLoop" class="section impl">

<a href="#impl-RefUnwindSafe-for-ExprForLoop" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.ExprForLoop.html" class="struct"
title="struct verus_syn::ExprForLoop">ExprForLoop</a>

</div>

<div id="impl-Send-for-ExprForLoop" class="section impl">

<a href="#impl-Send-for-ExprForLoop" class="anchor">§</a>

### impl \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.ExprForLoop.html" class="struct"
title="struct verus_syn::ExprForLoop">ExprForLoop</a>

</div>

<div id="impl-Sync-for-ExprForLoop" class="section impl">

<a href="#impl-Sync-for-ExprForLoop" class="anchor">§</a>

### impl \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.ExprForLoop.html" class="struct"
title="struct verus_syn::ExprForLoop">ExprForLoop</a>

</div>

<div id="impl-Unpin-for-ExprForLoop" class="section impl">

<a href="#impl-Unpin-for-ExprForLoop" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.ExprForLoop.html" class="struct"
title="struct verus_syn::ExprForLoop">ExprForLoop</a>

</div>

<div id="impl-UnwindSafe-for-ExprForLoop" class="section impl">

<a href="#impl-UnwindSafe-for-ExprForLoop" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.ExprForLoop.html" class="struct"
title="struct verus_syn::ExprForLoop">ExprForLoop</a>
