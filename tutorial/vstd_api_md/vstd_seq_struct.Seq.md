...
[vstd](../index.html)::[seq](index.html)

</div>

# Struct <span class="struct">Seq</span> Copy item path

<span class="sub-heading"><a href="../../src/vstd/seq.rs.html#31-33" class="src">Source</a>
</span>
...
`Seq<A>` is a sequence type for specifications. To use a “sequence” in
compiled code, use an `exec` type like `vec::Vec` that has `Seq<A>` as
its specification type.

An object `seq: Seq<A>` has a length, given by [`seq.len()`](Seq::len),
and a value at each `i` for `0 <= i < seq.len()`, given by
[`seq[i]`](Seq::index).

Sequences can be constructed in a few different ways:

- \[`Seq::empty`\] construct an empty sequence (`len() == 0`)
- \[`Seq::new`\] construct a sequence of a given length, initialized
  according to a given function mapping indices `i` to values `A`.
- The [`seq!`](../macro.seq.html "macro vstd::seq") macro, to construct
  small sequences of a fixed size (analagous to the
  [`std::vec!`](https://doc.rust-lang.org/1.92.0/alloc/macro.vec.html "macro alloc::vec")
  macro).
- By manipulating an existing sequence with \[`Seq::push`\],
  \[`Seq::update`\], or \[`Seq::add`\].
...
<div id="impl-Seq%3CA%3E" class="section impl">

<a href="../../src/vstd/seq_lib.rs.html#20-2278"
class="src rightside">Source</a><a href="#impl-Seq%3CA%3E" class="anchor">§</a>

### impl\<A\> <a href="struct.Seq.html" class="struct"
title="struct vstd::seq::Seq">Seq</a>\<A\>

</div>

<div class="impl-items">

<div id="method.group_seq_extra" class="section method">

<a href="../../src/vstd/seq_lib.rs.html#2257"
class="src rightside">Source</a>

#### pub fn <a href="#method.group_seq_extra" class="fn">group_seq_extra</a>()

</div>

</div>

<div id="impl-Seq%3CSeq%3CA%3E%3E" class="section impl">

<a href="../../src/vstd/seq_lib.rs.html#2381-2533"
class="src rightside">Source</a><a href="#impl-Seq%3CSeq%3CA%3E%3E" class="anchor">§</a>

### impl\<A\> <a href="struct.Seq.html" class="struct"
title="struct vstd::seq::Seq">Seq</a>\<<a href="struct.Seq.html" class="struct"
title="struct vstd::seq::Seq">Seq</a>\<A\>\>
...
<div id="method.group_seq_flatten" class="section method">

<a href="../../src/vstd/seq_lib.rs.html#2529"
class="src rightside">Source</a>

#### pub fn <a href="#method.group_seq_flatten" class="fn">group_seq_flatten</a>()
...
<div id="impl-Freeze-for-Seq%3CA%3E" class="section impl">

<a href="#impl-Freeze-for-Seq%3CA%3E" class="anchor">§</a>

### impl\<A\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.Seq.html" class="struct"
title="struct vstd::seq::Seq">Seq</a>\<A\>

</div>

<div id="impl-RefUnwindSafe-for-Seq%3CA%3E" class="section impl">

<a href="#impl-RefUnwindSafe-for-Seq%3CA%3E" class="anchor">§</a>

### impl\<A\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.Seq.html" class="struct"
title="struct vstd::seq::Seq">Seq</a>\<A\>
...
<div id="impl-Send-for-Seq%3CA%3E" class="section impl">

<a href="#impl-Send-for-Seq%3CA%3E" class="anchor">§</a>

### impl\<A\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.Seq.html" class="struct"
title="struct vstd::seq::Seq">Seq</a>\<A\>
...
<div id="impl-Sync-for-Seq%3CA%3E" class="section impl">

<a href="#impl-Sync-for-Seq%3CA%3E" class="anchor">§</a>

### impl\<A\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.Seq.html" class="struct"
title="struct vstd::seq::Seq">Seq</a>\<A\>
...
<div id="impl-Unpin-for-Seq%3CA%3E" class="section impl">

<a href="#impl-Unpin-for-Seq%3CA%3E" class="anchor">§</a>

### impl\<A\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.Seq.html" class="struct"
title="struct vstd::seq::Seq">Seq</a>\<A\>
...
<div id="impl-UnwindSafe-for-Seq%3CA%3E" class="section impl">

<a href="#impl-UnwindSafe-for-Seq%3CA%3E" class="anchor">§</a>

### impl\<A\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.Seq.html" class="struct"
title="struct vstd::seq::Seq">Seq</a>\<A\>
