...
<span class="sub-heading"><a href="../../src/syn/parse.rs.html#1-1420" class="src">Source</a>
</span>
...
and produce a [`Result<T>`](../type.Result.html "type syn::Result")
where `T` is some syntax tree node. Underlying these parser functions is
a lower level mechanism built around the
[`Cursor`](../buffer/struct.Cursor.html "struct syn::buffer::Cursor")
...
[`Parse`](trait.Parse.html "trait syn::parse::Parse") trait to parse
these syntax tree data structures from a token stream.
...
The [`syn::parse`](../fn.parse.html "fn syn::parse"),
[`syn::parse2`](../fn.parse2.html "fn syn::parse2"), and
[`syn::parse_str`](../fn.parse_str.html "fn syn::parse_str") functions
serve as an entry point for parsing syntax tree nodes that can be parsed
in an obvious default way. These functions can return any syntax tree
node that implements the
[`Parse`](trait.Parse.html "trait syn::parse::Parse") trait, which
...
The [`parse_quote!`](../macro.parse_quote.html "macro syn::parse_quote")
...
example an
[`Attribute`](../struct.Attribute.html "struct syn::Attribute") can be
either “outer” like `#[...]` or “inner” like `#![...]` and parsing the
wrong one would be a bug. Similarly
[`Punctuated`](../punctuated/index.html "mod syn::punctuated") may or
may not allow trailing punctuation, and parsing it the wrong way would
either reject valid input or accept invalid input.
...
title="mod syn::parse::discouraged">discouraged</a>  
...
title="struct syn::parse::Error">Error</a>  
Error returned when a Syn parser cannot parse the input tokens.

<a href="struct.Lookahead1.html" class="struct"
title="struct syn::parse::Lookahead1">Lookahead1</a>  
...
title="struct syn::parse::ParseBuffer">ParseBuffer</a>  
Cursor position within a buffered token stream.

<a href="struct.StepCursor.html" class="struct"
title="struct syn::parse::StepCursor">StepCursor</a>  
...
title="trait syn::parse::Parser">Parser</a>  
...
title="type syn::parse::ParseStream">ParseStream</a>  
Input to a Syn parser function.

<a href="type.Result.html" class="type"
title="type syn::parse::Result">Result</a>  
