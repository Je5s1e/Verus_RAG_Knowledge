...
# Struct <span class="struct">DrainFilter</span> Copy item path

<span class="sub-heading"><a href="../../src/hashbrown/map.rs.html#2632-2638"
class="src">Source</a> </span>

</div>

``` rust
pub struct DrainFilter<'a, K, V, F, A: Allocator + Clone = Global>where
    F: FnMut(&K, &mut V) -> bool,{ /* private fields */ }
```
...
[`drain_filter`](struct.HashMap.html#method.drain_filter) method on
...
<div id="impl-Drop-for-DrainFilter%3C'a,+K,+V,+F,+A%3E"
class="section impl">

<a href="../../src/hashbrown/map.rs.html#2640-2653"
class="src rightside">Source</a><a href="#impl-Drop-for-DrainFilter%3C&#39;a,+K,+V,+F,+A%3E"
class="anchor">§</a>

### impl\<'a, K, V, F, A\> <a href="https://doc.rust-lang.org/1.92.0/core/ops/drop/trait.Drop.html"
class="trait" title="trait core::ops::drop::Drop">Drop</a> for <a href="struct.DrainFilter.html" class="struct"
title="struct hashbrown::hash_map::DrainFilter">DrainFilter</a>\<'a, K, V, F, A\>
...
class="primitive">bool</a>, A: Allocator +
...
<a href="../../src/hashbrown/map.rs.html#2646-2652"
...
<div id="impl-Iterator-for-DrainFilter%3C'_,+K,+V,+F,+A%3E"
class="section impl">

<a href="../../src/hashbrown/map.rs.html#2664-2680"
class="src rightside">Source</a><a href="#impl-Iterator-for-DrainFilter%3C&#39;_,+K,+V,+F,+A%3E"
class="anchor">§</a>

### impl\<K, V, F, A\> <a
href="https://doc.rust-lang.org/1.92.0/core/iter/traits/iterator/trait.Iterator.html"
class="trait"
title="trait core::iter::traits::iterator::Iterator">Iterator</a> for <a href="struct.DrainFilter.html" class="struct"
title="struct hashbrown::hash_map::DrainFilter">DrainFilter</a>\<'\_, K, V, F, A\>
...
<a href="../../src/hashbrown/map.rs.html#2669"
...
<a href="../../src/hashbrown/map.rs.html#2672-2674"
...
<a href="../../src/hashbrown/map.rs.html#2677-2679"
...
<div id="impl-FusedIterator-for-DrainFilter%3C'_,+K,+V,+F%3E"
class="section impl">

<a href="../../src/hashbrown/map.rs.html#2682"
class="src rightside">Source</a><a href="#impl-FusedIterator-for-DrainFilter%3C&#39;_,+K,+V,+F%3E"
class="anchor">§</a>

### impl\<K, V, F\> <a
href="https://doc.rust-lang.org/1.92.0/core/iter/traits/marker/trait.FusedIterator.html"
class="trait"
title="trait core::iter::traits::marker::FusedIterator">FusedIterator</a> for <a href="struct.DrainFilter.html" class="struct"
title="struct hashbrown::hash_map::DrainFilter">DrainFilter</a>\<'\_, K, V, F\>
...
<div id="impl-Freeze-for-DrainFilter%3C'a,+K,+V,+F,+A%3E"
class="section impl">

<a href="#impl-Freeze-for-DrainFilter%3C&#39;a,+K,+V,+F,+A%3E"
class="anchor">§</a>

### impl\<'a, K, V, F, A\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.DrainFilter.html" class="struct"
title="struct hashbrown::hash_map::DrainFilter">DrainFilter</a>\<'a, K, V, F, A\>
...
<div id="impl-RefUnwindSafe-for-DrainFilter%3C'a,+K,+V,+F,+A%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-DrainFilter%3C&#39;a,+K,+V,+F,+A%3E"
class="anchor">§</a>

### impl\<'a, K, V, F, A\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.DrainFilter.html" class="struct"
title="struct hashbrown::hash_map::DrainFilter">DrainFilter</a>\<'a, K, V, F, A\>
...
<div id="impl-Send-for-DrainFilter%3C'a,+K,+V,+F,+A%3E"
class="section impl">

<a href="#impl-Send-for-DrainFilter%3C&#39;a,+K,+V,+F,+A%3E"
class="anchor">§</a>

### impl\<'a, K, V, F, A\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.DrainFilter.html" class="struct"
title="struct hashbrown::hash_map::DrainFilter">DrainFilter</a>\<'a, K, V, F, A\>
...
<div id="impl-Sync-for-DrainFilter%3C'a,+K,+V,+F,+A%3E"
class="section impl">

<a href="#impl-Sync-for-DrainFilter%3C&#39;a,+K,+V,+F,+A%3E"
class="anchor">§</a>

### impl\<'a, K, V, F, A\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.DrainFilter.html" class="struct"
title="struct hashbrown::hash_map::DrainFilter">DrainFilter</a>\<'a, K, V, F, A\>
...
<div id="impl-Unpin-for-DrainFilter%3C'a,+K,+V,+F,+A%3E"
class="section impl">

<a href="#impl-Unpin-for-DrainFilter%3C&#39;a,+K,+V,+F,+A%3E"
class="anchor">§</a>

### impl\<'a, K, V, F, A\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.DrainFilter.html" class="struct"
title="struct hashbrown::hash_map::DrainFilter">DrainFilter</a>\<'a, K, V, F, A\>
...
<div id="impl-UnwindSafe-for-DrainFilter%3C'a,+K,+V,+F,+A%3E"
class="section impl">

<a href="#impl-UnwindSafe-for-DrainFilter%3C&#39;a,+K,+V,+F,+A%3E"
class="anchor">§</a>

### impl\<'a, K, V, F, A = Global\> \!<a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.DrainFilter.html" class="struct"
title="struct hashbrown::hash_map::DrainFilter">DrainFilter</a>\<'a, K, V, F, A\>
