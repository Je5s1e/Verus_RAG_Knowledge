...
[vstd](../index.html)::[set](index.html)

</div>

# Struct <span class="struct">Set</span> Copy item path

<span class="sub-heading"><a href="../../src/vstd/set.rs.html#31-33" class="src">Source</a>
</span>
...
In general, a set might be infinite. To work specifically with finite
sets, see the [`self.finite()`](Set::finite) predicate.
...
- The [`set!`](../macro.set.html "macro vstd::set") macro, to construct
  small sets of a fixed size
- By manipulating an existing sequence with \[`Set::union`\],
  \[`Set::intersect`\], \[`Set::difference`\], \[`Set::complement`\],
  \[`Set::filter`\], \[`Set::insert`\], or \[`Set::remove`\].
...
<div id="impl-Freeze-for-Set%3CA%3E" class="section impl">

<a href="#impl-Freeze-for-Set%3CA%3E" class="anchor">§</a>

### impl\<A\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.Set.html" class="struct"
title="struct vstd::set::Set">Set</a>\<A\>

</div>

<div id="impl-RefUnwindSafe-for-Set%3CA%3E" class="section impl">

<a href="#impl-RefUnwindSafe-for-Set%3CA%3E" class="anchor">§</a>

### impl\<A\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.Set.html" class="struct"
title="struct vstd::set::Set">Set</a>\<A\>
...
<div id="impl-Send-for-Set%3CA%3E" class="section impl">

<a href="#impl-Send-for-Set%3CA%3E" class="anchor">§</a>

### impl\<A\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.Set.html" class="struct"
title="struct vstd::set::Set">Set</a>\<A\>
...
<div id="impl-Sync-for-Set%3CA%3E" class="section impl">

<a href="#impl-Sync-for-Set%3CA%3E" class="anchor">§</a>

### impl\<A\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.Set.html" class="struct"
title="struct vstd::set::Set">Set</a>\<A\>
...
<div id="impl-Unpin-for-Set%3CA%3E" class="section impl">

<a href="#impl-Unpin-for-Set%3CA%3E" class="anchor">§</a>

### impl\<A\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.Set.html" class="struct"
title="struct vstd::set::Set">Set</a>\<A\>
...
<div id="impl-UnwindSafe-for-Set%3CA%3E" class="section impl">

<a href="#impl-UnwindSafe-for-Set%3CA%3E" class="anchor">§</a>

### impl\<A\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.Set.html" class="struct"
title="struct vstd::set::Set">Set</a>\<A\>
