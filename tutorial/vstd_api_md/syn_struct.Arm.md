...
# Struct <span class="struct">Arm</span> Copy item path

<span class="sub-heading"><a href="../src/syn/expr.rs.html#1121-1148" class="src">Source</a>
</span>
...
title="struct syn::Attribute"><code>Attribute</code></a>`>`</span><span id="structfield.pat"
class="structfield section-header"><a href="#structfield.pat" class="anchor field">§</a>`pat: `<a href="enum.Pat.html" class="enum"
title="enum syn::Pat"><code>Pat</code></a></span><span id="structfield.guard"
class="structfield section-header"><a href="#structfield.guard" class="anchor field">§</a>`guard: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<(`<a href="token/struct.If.html" class="struct"
title="struct syn::token::If"><code>If</code></a>`, `<a href="https://doc.rust-lang.org/1.92.0/alloc/boxed/struct.Box.html"
class="struct" title="struct alloc::boxed::Box"><code>Box</code></a>`<`<a href="enum.Expr.html" class="enum"
title="enum syn::Expr"><code>Expr</code></a>`>)>`</span><span id="structfield.fat_arrow_token"
class="structfield section-header"><a href="#structfield.fat_arrow_token" class="anchor field">§</a>`fat_arrow_token: `<a href="token/struct.FatArrow.html" class="struct"
title="struct syn::token::FatArrow"><code>FatArrow</code></a></span><span id="structfield.body"
...
class="struct" title="struct alloc::boxed::Box"><code>Box</code></a>`<`<a href="enum.Expr.html" class="enum"
title="enum syn::Expr"><code>Expr</code></a>`>`</span><span id="structfield.comma"
class="structfield section-header"><a href="#structfield.comma" class="anchor field">§</a>`comma: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
...
<div id="impl-Clone-for-Arm" class="section impl">

<a href="../src/syn/gen/clone.rs.html#29-40"
class="src rightside">Source</a><a href="#impl-Clone-for-Arm" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/clone/trait.Clone.html"
class="trait" title="trait core::clone::Clone">Clone</a> for <a href="struct.Arm.html" class="struct" title="struct syn::Arm">Arm</a>
...
<a href="../src/syn/gen/clone.rs.html#30-39"
...
<div id="impl-Debug-for-Arm" class="section impl">

<a href="../src/syn/gen/debug.rs.html#36-47"
class="src rightside">Source</a><a href="#impl-Debug-for-Arm" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/fmt/trait.Debug.html"
class="trait" title="trait core::fmt::Debug">Debug</a> for <a href="struct.Arm.html" class="struct" title="struct syn::Arm">Arm</a>
...
<a href="../src/syn/gen/debug.rs.html#37-46"
...
<div id="impl-Hash-for-Arm" class="section impl">

<a href="../src/syn/gen/hash.rs.html#32-43"
class="src rightside">Source</a><a href="#impl-Hash-for-Arm" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/hash/trait.Hash.html"
class="trait" title="trait core::hash::Hash">Hash</a> for <a href="struct.Arm.html" class="struct" title="struct syn::Arm">Arm</a>
...
<a href="../src/syn/gen/hash.rs.html#33-42"
...
title="trait syn::parse::Parse">Parse</a> for <a href="struct.Arm.html" class="struct" title="struct syn::Arm">Arm</a>
...
<a href="../src/syn/expr.rs.html#3005-3033"
...
title="type syn::Result">Result</a>\<<a href="struct.Arm.html" class="struct" title="struct syn::Arm">Arm</a>\>

</div>

</div>

<div id="impl-PartialEq-for-Arm" class="section impl">

<a href="../src/syn/gen/eq.rs.html#33-38"
class="src rightside">Source</a><a href="#impl-PartialEq-for-Arm" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.PartialEq.html"
class="trait" title="trait core::cmp::PartialEq">PartialEq</a> for <a href="struct.Arm.html" class="struct" title="struct syn::Arm">Arm</a>
...
<a href="../src/syn/gen/eq.rs.html#34-37"
...
<div id="impl-ToTokens-for-Arm" class="section impl">

<a href="../src/syn/expr.rs.html#4104-4116"
class="src rightside">Source</a><a href="#impl-ToTokens-for-Arm" class="anchor">§</a>

### impl <a href="../quote/to_tokens/trait.ToTokens.html" class="trait"
title="trait quote::to_tokens::ToTokens">ToTokens</a> for <a href="struct.Arm.html" class="struct" title="struct syn::Arm">Arm</a>
...
<a href="../src/syn/expr.rs.html#4105-4115"
...
<div id="impl-Eq-for-Arm" class="section impl">

<a href="../src/syn/gen/eq.rs.html#30" class="src rightside">Source</a><a href="#impl-Eq-for-Arm" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.Eq.html"
class="trait" title="trait core::cmp::Eq">Eq</a> for <a href="struct.Arm.html" class="struct" title="struct syn::Arm">Arm</a>
...
<div id="impl-Freeze-for-Arm" class="section impl">

<a href="#impl-Freeze-for-Arm" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.Arm.html" class="struct" title="struct syn::Arm">Arm</a>

</div>

<div id="impl-RefUnwindSafe-for-Arm" class="section impl">

<a href="#impl-RefUnwindSafe-for-Arm" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.Arm.html" class="struct" title="struct syn::Arm">Arm</a>

</div>

<div id="impl-Send-for-Arm" class="section impl">

<a href="#impl-Send-for-Arm" class="anchor">§</a>

### impl \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.Arm.html" class="struct" title="struct syn::Arm">Arm</a>

</div>

<div id="impl-Sync-for-Arm" class="section impl">

<a href="#impl-Sync-for-Arm" class="anchor">§</a>

### impl \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.Arm.html" class="struct" title="struct syn::Arm">Arm</a>

</div>

<div id="impl-Unpin-for-Arm" class="section impl">

<a href="#impl-Unpin-for-Arm" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.Arm.html" class="struct" title="struct syn::Arm">Arm</a>

</div>

<div id="impl-UnwindSafe-for-Arm" class="section impl">

<a href="#impl-UnwindSafe-for-Arm" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.Arm.html" class="struct" title="struct syn::Arm">Arm</a>
