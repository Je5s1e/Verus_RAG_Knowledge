...
# Struct <span class="struct">Path</span> Copy item path

<span class="sub-heading"><a href="../src/verus_syn/path.rs.html#11-18" class="src">Source</a>
</span>
...
<span id="structfield.leading_colon"
class="structfield section-header"><a href="#structfield.leading_colon" class="anchor field">§</a>`leading_colon: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<`<a href="token/struct.PathSep.html" class="struct"
title="struct verus_syn::token::PathSep"><code>PathSep</code></a>`>`</span><span id="structfield.segments"
class="structfield section-header"><a href="#structfield.segments" class="anchor field">§</a>`segments: `<a href="punctuated/struct.Punctuated.html" class="struct"
title="struct verus_syn::punctuated::Punctuated"><code>Punctuated</code></a>`<`<a href="struct.PathSegment.html" class="struct"
title="struct verus_syn::PathSegment"><code>PathSegment</code></a>`, `<a href="token/struct.PathSep.html" class="struct"
title="struct verus_syn::token::PathSep"><code>PathSep</code></a>`>`</span>

## Implementations<a href="#implementations" class="anchor">§</a>

<div id="implementations-list">

<div id="impl-Path" class="section impl">

<a href="../src/verus_syn/path.rs.html#547-644"
class="src rightside">Source</a><a href="#impl-Path" class="anchor">§</a>

### impl <a href="struct.Path.html" class="struct"
...
<div id="method.parse_mod_style" class="section method">

<a href="../src/verus_syn/path.rs.html#579-609"
class="src rightside">Source</a>

#### pub fn <a href="#method.parse_mod_style" class="fn">parse_mod_style</a>(input: <a href="parse/type.ParseStream.html" class="type"
...
<div id="impl-Path-1" class="section impl">

<a href="../src/verus_syn/path.rs.html#34-105"
class="src rightside">Source</a><a href="#impl-Path-1" class="anchor">§</a>
...
<div id="method.is_ident" class="section method">

<a href="../src/verus_syn/path.rs.html#63-72"
class="src rightside">Source</a>

#### pub fn <a href="#method.is_ident" class="fn">is_ident</a>\<I\>(&self, ident: <a href="https://doc.rust-lang.org/1.92.0/std/primitive.reference.html"
class="primitive">&amp;I</a>) -\> <a href="https://doc.rust-lang.org/1.92.0/std/primitive.bool.html"
...
class="trait" title="trait core::cmp::PartialEq">PartialEq</a>\<I\>,
...
<div id="method.get_ident" class="section method">

<a href="../src/verus_syn/path.rs.html#82-91"
class="src rightside">Source</a>

#### pub fn <a href="#method.get_ident" class="fn">get_ident</a>(&self) -\> <a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
...
<div id="method.require_ident" class="section method">

<a href="../src/verus_syn/path.rs.html#96-104"
class="src rightside">Source</a>

#### pub fn <a href="#method.require_ident" class="fn">require_ident</a>(&self) -\> <a href="type.Result.html" class="type"
title="type verus_syn::Result">Result</a>\<&<a href="struct.Ident.html" class="struct"
title="struct verus_syn::Ident">Ident</a>\>
...
<div id="impl-Clone-for-Path" class="section impl">

<a href="../src/verus_syn/gen/clone.rs.html#2235-2242"
class="src rightside">Source</a><a href="#impl-Clone-for-Path" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/clone/trait.Clone.html"
class="trait" title="trait core::clone::Clone">Clone</a> for <a href="struct.Path.html" class="struct"
title="struct verus_syn::Path">Path</a>
...
<a href="../src/verus_syn/gen/clone.rs.html#2236-2241"
...
<div id="impl-Debug-for-Path" class="section impl">

<a href="../src/verus_syn/gen/debug.rs.html#3180-3184"
class="src rightside">Source</a><a href="#impl-Debug-for-Path" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/fmt/trait.Debug.html"
class="trait" title="trait core::fmt::Debug">Debug</a> for <a href="struct.Path.html" class="struct"
title="struct verus_syn::Path">Path</a>
...
<a href="../src/verus_syn/gen/debug.rs.html#3181-3183"
...
<div id="impl-From%3CT%3E-for-Path" class="section impl">

<a href="../src/verus_syn/path.rs.html#20-32"
class="src rightside">Source</a><a href="#impl-From%3CT%3E-for-Path" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/convert/trait.From.html"
class="trait" title="trait core::convert::From">From</a>\<T\> for <a href="struct.Path.html" class="struct"
title="struct verus_syn::Path">Path</a>
...
class="trait" title="trait core::convert::Into">Into</a>\<<a href="struct.PathSegment.html" class="struct"
...
<a href="../src/verus_syn/path.rs.html#24-31"
class="src rightside">Source</a><a href="#method.from-1" class="anchor">§</a>

#### fn <a
href="https://doc.rust-lang.org/1.92.0/core/convert/trait.From.html#tymethod.from"
class="fn">from</a>(segment: T) -\> Self
...
<div id="impl-Hash-for-Path" class="section impl">

<a href="../src/verus_syn/gen/hash.rs.html#2813-2821"
class="src rightside">Source</a><a href="#impl-Hash-for-Path" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/hash/trait.Hash.html"
class="trait" title="trait core::hash::Hash">Hash</a> for <a href="struct.Path.html" class="struct"
title="struct verus_syn::Path">Path</a>
...
<a href="../src/verus_syn/gen/hash.rs.html#2814-2820"
...
<a href="../src/verus_syn/path.rs.html#310-312"
...
<div id="impl-PartialEq-for-Path" class="section impl">

<a href="../src/verus_syn/gen/eq.rs.html#2190-2194"
class="src rightside">Source</a><a href="#impl-PartialEq-for-Path" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.PartialEq.html"
class="trait" title="trait core::cmp::PartialEq">PartialEq</a> for <a href="struct.Path.html" class="struct"
title="struct verus_syn::Path">Path</a>
...
<a href="../src/verus_syn/gen/eq.rs.html#2191-2193"
...
<div id="impl-ToTokens-for-Path" class="section impl">

<a href="../src/verus_syn/path.rs.html#730-734"
class="src rightside">Source</a><a href="#impl-ToTokens-for-Path" class="anchor">§</a>

### impl <a href="../quote/to_tokens/trait.ToTokens.html" class="trait"
title="trait quote::to_tokens::ToTokens">ToTokens</a> for <a href="struct.Path.html" class="struct"
title="struct verus_syn::Path">Path</a>
...
<a href="../src/verus_syn/path.rs.html#731-733"
...
<div id="impl-Eq-for-Path" class="section impl">

<a href="../src/verus_syn/gen/eq.rs.html#2187"
class="src rightside">Source</a><a href="#impl-Eq-for-Path" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.Eq.html"
class="trait" title="trait core::cmp::Eq">Eq</a> for <a href="struct.Path.html" class="struct"
title="struct verus_syn::Path">Path</a>
...
<div id="impl-Freeze-for-Path" class="section impl">

<a href="#impl-Freeze-for-Path" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.Path.html" class="struct"
title="struct verus_syn::Path">Path</a>

</div>

<div id="impl-RefUnwindSafe-for-Path" class="section impl">

<a href="#impl-RefUnwindSafe-for-Path" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.Path.html" class="struct"
title="struct verus_syn::Path">Path</a>

</div>

<div id="impl-Send-for-Path" class="section impl">

<a href="#impl-Send-for-Path" class="anchor">§</a>

### impl \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.Path.html" class="struct"
title="struct verus_syn::Path">Path</a>

</div>

<div id="impl-Sync-for-Path" class="section impl">

<a href="#impl-Sync-for-Path" class="anchor">§</a>

### impl \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.Path.html" class="struct"
title="struct verus_syn::Path">Path</a>

</div>

<div id="impl-Unpin-for-Path" class="section impl">

<a href="#impl-Unpin-for-Path" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.Path.html" class="struct"
title="struct verus_syn::Path">Path</a>

</div>

<div id="impl-UnwindSafe-for-Path" class="section impl">

<a href="#impl-UnwindSafe-for-Path" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.Path.html" class="struct"
title="struct verus_syn::Path">Path</a>
