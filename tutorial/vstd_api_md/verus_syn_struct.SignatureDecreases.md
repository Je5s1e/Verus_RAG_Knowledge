...
# Struct <span class="struct">SignatureDecreases</span> Copy item path

<span class="sub-heading"><a href="../src/verus_syn/verus.rs.html#194-200" class="src">Source</a>
</span>
...
pub struct SignatureDecreases {
    ...
    pub when: Option<(When, Expr)>,
    pub via: Option<(Via, Expr)>,
}
```

## Fields<a href="#fields" class="anchor">§</a>

<span id="structfield.decreases"
class="structfield section-header"><a href="#structfield.decreases" class="anchor field">§</a>`decreases: `<a href="struct.Decreases.html" class="struct"
title="struct verus_syn::Decreases"><code>Decreases</code></a></span><span id="structfield.when"
class="structfield section-header"><a href="#structfield.when" class="anchor field">§</a>`when: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<(`<a href="token/struct.When.html" class="struct"
title="struct verus_syn::token::When"><code>When</code></a>`, `<a href="enum.Expr.html" class="enum"
title="enum verus_syn::Expr"><code>Expr</code></a>`)>`</span><span id="structfield.via"
class="structfield section-header"><a href="#structfield.via" class="anchor field">§</a>`via: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<(`<a href="token/struct.Via.html" class="struct"
title="struct verus_syn::token::Via"><code>Via</code></a>`, `<a href="enum.Expr.html" class="enum"
...
<div id="impl-Clone-for-SignatureDecreases" class="section impl">

<a href="../src/verus_syn/gen/clone.rs.html#2456-2464"
class="src rightside">Source</a><a href="#impl-Clone-for-SignatureDecreases" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/clone/trait.Clone.html"
class="trait" title="trait core::clone::Clone">Clone</a> for <a href="struct.SignatureDecreases.html" class="struct"
...
<a href="../src/verus_syn/gen/clone.rs.html#2457-2463"
...
<div id="impl-Debug-for-SignatureDecreases" class="section impl">

<a href="../src/verus_syn/gen/debug.rs.html#3443-3451"
class="src rightside">Source</a><a href="#impl-Debug-for-SignatureDecreases" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/fmt/trait.Debug.html"
class="trait" title="trait core::fmt::Debug">Debug</a> for <a href="struct.SignatureDecreases.html" class="struct"
title="struct verus_syn::SignatureDecreases">SignatureDecreases</a>
...
<a href="../src/verus_syn/gen/debug.rs.html#3444-3450"
...
<div id="impl-Hash-for-SignatureDecreases" class="section impl">

<a href="../src/verus_syn/gen/hash.rs.html#3071-3080"
class="src rightside">Source</a><a href="#impl-Hash-for-SignatureDecreases" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/hash/trait.Hash.html"
class="trait" title="trait core::hash::Hash">Hash</a> for <a href="struct.SignatureDecreases.html" class="struct"
title="struct verus_syn::SignatureDecreases">SignatureDecreases</a>
...
<a href="../src/verus_syn/gen/hash.rs.html#3072-3079"
...
<a href="../src/verus_syn/verus.rs.html#866-887"
...
<div id="impl-PartialEq-for-SignatureDecreases" class="section impl">

<a href="../src/verus_syn/gen/eq.rs.html#2413-2418"
class="src rightside">Source</a><a href="#impl-PartialEq-for-SignatureDecreases" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.PartialEq.html"
class="trait" title="trait core::cmp::PartialEq">PartialEq</a> for <a href="struct.SignatureDecreases.html" class="struct"
title="struct verus_syn::SignatureDecreases">SignatureDecreases</a>
...
<a href="../src/verus_syn/gen/eq.rs.html#2414-2417"
...
<div id="impl-ToTokens-for-SignatureDecreases" class="section impl">

<a href="../src/verus_syn/verus.rs.html#1768-1780"
class="src rightside">Source</a><a href="#impl-ToTokens-for-SignatureDecreases" class="anchor">§</a>

### impl <a href="../quote/to_tokens/trait.ToTokens.html" class="trait"
title="trait quote::to_tokens::ToTokens">ToTokens</a> for <a href="struct.SignatureDecreases.html" class="struct"
title="struct verus_syn::SignatureDecreases">SignatureDecreases</a>
...
<a href="../src/verus_syn/verus.rs.html#1769-1779"
...
<div id="impl-Eq-for-SignatureDecreases" class="section impl">

<a href="../src/verus_syn/gen/eq.rs.html#2411"
class="src rightside">Source</a><a href="#impl-Eq-for-SignatureDecreases" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.Eq.html"
class="trait" title="trait core::cmp::Eq">Eq</a> for <a href="struct.SignatureDecreases.html" class="struct"
title="struct verus_syn::SignatureDecreases">SignatureDecreases</a>
...
<div id="impl-Freeze-for-SignatureDecreases" class="section impl">

<a href="#impl-Freeze-for-SignatureDecreases" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.SignatureDecreases.html" class="struct"
title="struct verus_syn::SignatureDecreases">SignatureDecreases</a>

</div>

<div id="impl-RefUnwindSafe-for-SignatureDecreases"
class="section impl">

<a href="#impl-RefUnwindSafe-for-SignatureDecreases"
class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.SignatureDecreases.html" class="struct"
title="struct verus_syn::SignatureDecreases">SignatureDecreases</a>

</div>

<div id="impl-Send-for-SignatureDecreases" class="section impl">

<a href="#impl-Send-for-SignatureDecreases" class="anchor">§</a>

### impl \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.SignatureDecreases.html" class="struct"
title="struct verus_syn::SignatureDecreases">SignatureDecreases</a>

</div>

<div id="impl-Sync-for-SignatureDecreases" class="section impl">

<a href="#impl-Sync-for-SignatureDecreases" class="anchor">§</a>

### impl \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.SignatureDecreases.html" class="struct"
title="struct verus_syn::SignatureDecreases">SignatureDecreases</a>

</div>

<div id="impl-Unpin-for-SignatureDecreases" class="section impl">

<a href="#impl-Unpin-for-SignatureDecreases" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.SignatureDecreases.html" class="struct"
title="struct verus_syn::SignatureDecreases">SignatureDecreases</a>

</div>

<div id="impl-UnwindSafe-for-SignatureDecreases" class="section impl">

<a href="#impl-UnwindSafe-for-SignatureDecreases" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.SignatureDecreases.html" class="struct"
title="struct verus_syn::SignatureDecreases">SignatureDecreases</a>
