...
# Struct <span class="struct">PermissionDataPtr</span> Copy item path
...
``` rust
pub struct PermissionDataPtr<T> {
    pub patomic: int,
    pub value: *mut T,
}
```
...
<span id="structfield.patomic"
class="structfield section-header"><a href="#structfield.patomic" class="anchor field">§</a>`patomic: `<a href="../prelude/struct.int.html" class="struct"
title="struct vstd::prelude::int"><code>int</code></a></span><span id="structfield.value"
class="structfield section-header"><a href="#structfield.value" class="anchor field">§</a>`value: `<a href="https://doc.rust-lang.org/1.92.0/std/primitive.pointer.html"
class="primitive"><code>*mut T</code></a></span>

## Auto Trait Implementations<a href="#synthetic-implementations" class="anchor">§</a>

<div id="synthetic-implementations-list">

<div id="impl-Freeze-for-PermissionDataPtr%3CT%3E" class="section impl">

<a href="#impl-Freeze-for-PermissionDataPtr%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.PermissionDataPtr.html" class="struct"
title="struct vstd::atomic::PermissionDataPtr">PermissionDataPtr</a>\<T\>

</div>

<div id="impl-RefUnwindSafe-for-PermissionDataPtr%3CT%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-PermissionDataPtr%3CT%3E"
class="anchor">§</a>

### impl\<T\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.PermissionDataPtr.html" class="struct"
title="struct vstd::atomic::PermissionDataPtr">PermissionDataPtr</a>\<T\>
...
<div id="impl-Send-for-PermissionDataPtr%3CT%3E" class="section impl">

<a href="#impl-Send-for-PermissionDataPtr%3CT%3E" class="anchor">§</a>

### impl\<T\> \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.PermissionDataPtr.html" class="struct"
title="struct vstd::atomic::PermissionDataPtr">PermissionDataPtr</a>\<T\>

</div>

<div id="impl-Sync-for-PermissionDataPtr%3CT%3E" class="section impl">

<a href="#impl-Sync-for-PermissionDataPtr%3CT%3E" class="anchor">§</a>

### impl\<T\> \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.PermissionDataPtr.html" class="struct"
title="struct vstd::atomic::PermissionDataPtr">PermissionDataPtr</a>\<T\>

</div>

<div id="impl-Unpin-for-PermissionDataPtr%3CT%3E" class="section impl">

<a href="#impl-Unpin-for-PermissionDataPtr%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.PermissionDataPtr.html" class="struct"
title="struct vstd::atomic::PermissionDataPtr">PermissionDataPtr</a>\<T\>

</div>

<div id="impl-UnwindSafe-for-PermissionDataPtr%3CT%3E"
class="section impl">

<a href="#impl-UnwindSafe-for-PermissionDataPtr%3CT%3E"
class="anchor">§</a>

### impl\<T\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.PermissionDataPtr.html" class="struct"
title="struct vstd::atomic::PermissionDataPtr">PermissionDataPtr</a>\<T\>
