...
# Struct <span class="struct">JoinHandle</span> Copy item path

<span class="sub-heading"><a href="../../src/vstd/thread.rs.html#16-18" class="src">Source</a>
</span>

</div>

``` rust
pub struct JoinHandle<Ret> { /* private fields */ }
```
...
[`spawn()`](fn.spawn.html "fn vstd::thread::spawn") for more details.
...
<div id="impl-JoinHandle%3CRet%3E" class="section impl">

<a href="../../src/vstd/thread.rs.html#20-53"
class="src rightside">Source</a><a href="#impl-JoinHandle%3CRet%3E" class="anchor">§</a>

### impl\<Ret\> <a href="struct.JoinHandle.html" class="struct"
title="struct vstd::thread::JoinHandle">JoinHandle</a>\<Ret\>
...
<a href="../../src/vstd/thread.rs.html#27-52"
class="src rightside">Source</a>

#### pub fn <a href="#method.join" class="fn">join</a>(self) -\> <a href="https://doc.rust-lang.org/1.92.0/core/result/enum.Result.html"
class="enum" title="enum core::result::Result">Result</a>\<Ret, <a href="https://doc.rust-lang.org/1.92.0/std/primitive.unit.html"
class="primitive">()</a>\>
...
<div id="impl-Freeze-for-JoinHandle%3CRet%3E" class="section impl">

<a href="#impl-Freeze-for-JoinHandle%3CRet%3E" class="anchor">§</a>

### impl\<Ret\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.JoinHandle.html" class="struct"
title="struct vstd::thread::JoinHandle">JoinHandle</a>\<Ret\>

</div>

<div id="impl-RefUnwindSafe-for-JoinHandle%3CRet%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-JoinHandle%3CRet%3E"
class="anchor">§</a>

### impl\<Ret\> \!<a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.JoinHandle.html" class="struct"
title="struct vstd::thread::JoinHandle">JoinHandle</a>\<Ret\>

</div>

<div id="impl-Send-for-JoinHandle%3CRet%3E" class="section impl">

<a href="#impl-Send-for-JoinHandle%3CRet%3E" class="anchor">§</a>

### impl\<Ret\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.JoinHandle.html" class="struct"
title="struct vstd::thread::JoinHandle">JoinHandle</a>\<Ret\>

</div>

<div id="impl-Sync-for-JoinHandle%3CRet%3E" class="section impl">

<a href="#impl-Sync-for-JoinHandle%3CRet%3E" class="anchor">§</a>

### impl\<Ret\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.JoinHandle.html" class="struct"
title="struct vstd::thread::JoinHandle">JoinHandle</a>\<Ret\>

</div>

<div id="impl-Unpin-for-JoinHandle%3CRet%3E" class="section impl">

<a href="#impl-Unpin-for-JoinHandle%3CRet%3E" class="anchor">§</a>

### impl\<Ret\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.JoinHandle.html" class="struct"
title="struct vstd::thread::JoinHandle">JoinHandle</a>\<Ret\>

</div>

<div id="impl-UnwindSafe-for-JoinHandle%3CRet%3E" class="section impl">

<a href="#impl-UnwindSafe-for-JoinHandle%3CRet%3E" class="anchor">§</a>

### impl\<Ret\> \!<a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.JoinHandle.html" class="struct"
title="struct vstd::thread::JoinHandle">JoinHandle</a>\<Ret\>
