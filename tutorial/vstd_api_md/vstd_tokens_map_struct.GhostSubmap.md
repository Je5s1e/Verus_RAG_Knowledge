...
# Struct <span class="struct">GhostSubmap</span> Copy item path

<span class="sub-heading"><a href="../../../src/vstd/tokens/map.rs.html#310-312"
...
The existence of a
[`GhostSubmap`](struct.GhostSubmap.html "struct vstd::tokens::map::GhostSubmap")
implies that:

- Those keys will remain in the map (unless the onwer of the
  [`GhostSubmap`](struct.GhostSubmap.html "struct vstd::tokens::map::GhostSubmap")
  deletes it using \[`GhostMapAuth::delete`\]);
- Those keys will remain pointing to the same values (unless the onwer
  of the
  [`GhostSubmap`](struct.GhostSubmap.html "struct vstd::tokens::map::GhostSubmap")
  updates them using \[`GhostSubmap::update`\])
- All other
...
<div id="impl-Freeze-for-GhostSubmap%3CK,+V%3E" class="section impl">

<a href="#impl-Freeze-for-GhostSubmap%3CK,+V%3E" class="anchor">§</a>

### impl\<K, V\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.GhostSubmap.html" class="struct"
title="struct vstd::tokens::map::GhostSubmap">GhostSubmap</a>\<K, V\>

</div>

<div id="impl-RefUnwindSafe-for-GhostSubmap%3CK,+V%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-GhostSubmap%3CK,+V%3E"
class="anchor">§</a>

### impl\<K, V\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.GhostSubmap.html" class="struct"
title="struct vstd::tokens::map::GhostSubmap">GhostSubmap</a>\<K, V\>
...
<div id="impl-Send-for-GhostSubmap%3CK,+V%3E" class="section impl">

<a href="#impl-Send-for-GhostSubmap%3CK,+V%3E" class="anchor">§</a>

### impl\<K, V\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.GhostSubmap.html" class="struct"
title="struct vstd::tokens::map::GhostSubmap">GhostSubmap</a>\<K, V\>
...
<div id="impl-Sync-for-GhostSubmap%3CK,+V%3E" class="section impl">

<a href="#impl-Sync-for-GhostSubmap%3CK,+V%3E" class="anchor">§</a>

### impl\<K, V\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.GhostSubmap.html" class="struct"
title="struct vstd::tokens::map::GhostSubmap">GhostSubmap</a>\<K, V\>
...
<div id="impl-Unpin-for-GhostSubmap%3CK,+V%3E" class="section impl">

<a href="#impl-Unpin-for-GhostSubmap%3CK,+V%3E" class="anchor">§</a>

### impl\<K, V\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.GhostSubmap.html" class="struct"
title="struct vstd::tokens::map::GhostSubmap">GhostSubmap</a>\<K, V\>
...
<div id="impl-UnwindSafe-for-GhostSubmap%3CK,+V%3E"
class="section impl">

<a href="#impl-UnwindSafe-for-GhostSubmap%3CK,+V%3E"
class="anchor">§</a>

### impl\<K, V\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.GhostSubmap.html" class="struct"
title="struct vstd::tokens::map::GhostSubmap">GhostSubmap</a>\<K, V\>
