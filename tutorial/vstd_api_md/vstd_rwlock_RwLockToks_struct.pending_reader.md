...
# Struct <span class="struct">pending_reader</span> Copy item path
...
``` rust
pub struct pending_reader<K, V, Pred: InvariantPredicate<K, V>> { /* private fields */ }
```
...
class="primitive">()</a>\> for <a href="struct.pending_reader.html" class="struct"
...
<div id="impl-Freeze-for-pending_reader%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-Freeze-for-pending_reader%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.pending_reader.html" class="struct"
title="struct vstd::rwlock::RwLockToks::pending_reader">pending_reader</a>\<K, V, Pred\>

</div>

<div id="impl-RefUnwindSafe-for-pending_reader%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-pending_reader%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.pending_reader.html" class="struct"
title="struct vstd::rwlock::RwLockToks::pending_reader">pending_reader</a>\<K, V, Pred\>
...
<div id="impl-Send-for-pending_reader%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-Send-for-pending_reader%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.pending_reader.html" class="struct"
title="struct vstd::rwlock::RwLockToks::pending_reader">pending_reader</a>\<K, V, Pred\>
...
<div id="impl-Sync-for-pending_reader%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-Sync-for-pending_reader%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.pending_reader.html" class="struct"
title="struct vstd::rwlock::RwLockToks::pending_reader">pending_reader</a>\<K, V, Pred\>
...
<div id="impl-Unpin-for-pending_reader%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-Unpin-for-pending_reader%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.pending_reader.html" class="struct"
title="struct vstd::rwlock::RwLockToks::pending_reader">pending_reader</a>\<K, V, Pred\>
...
<div id="impl-UnwindSafe-for-pending_reader%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-UnwindSafe-for-pending_reader%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.pending_reader.html" class="struct"
title="struct vstd::rwlock::RwLockToks::pending_reader">pending_reader</a>\<K, V, Pred\>
