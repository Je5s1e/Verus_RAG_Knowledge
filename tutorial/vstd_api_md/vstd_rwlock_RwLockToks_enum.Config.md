...
# Enum <span class="enum">Config</span> Copy item path
...
<div id="variant.initialize_full" class="section variant">

<a href="#variant.initialize_full" class="anchor">§</a>
...
<div id="impl-Freeze-for-Config%3CK,+V,+Pred%3E" class="section impl">

<a href="#impl-Freeze-for-Config%3CK,+V,+Pred%3E" class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="enum.Config.html" class="enum"
title="enum vstd::rwlock::RwLockToks::Config">Config</a>\<K, V, Pred\>
...
<div id="impl-RefUnwindSafe-for-Config%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-Config%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="enum.Config.html" class="enum"
title="enum vstd::rwlock::RwLockToks::Config">Config</a>\<K, V, Pred\>
...
<div id="impl-Send-for-Config%3CK,+V,+Pred%3E" class="section impl">

<a href="#impl-Send-for-Config%3CK,+V,+Pred%3E" class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="enum.Config.html" class="enum"
title="enum vstd::rwlock::RwLockToks::Config">Config</a>\<K, V, Pred\>
...
<div id="impl-Sync-for-Config%3CK,+V,+Pred%3E" class="section impl">

<a href="#impl-Sync-for-Config%3CK,+V,+Pred%3E" class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="enum.Config.html" class="enum"
title="enum vstd::rwlock::RwLockToks::Config">Config</a>\<K, V, Pred\>
...
<div id="impl-Unpin-for-Config%3CK,+V,+Pred%3E" class="section impl">

<a href="#impl-Unpin-for-Config%3CK,+V,+Pred%3E" class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="enum.Config.html" class="enum"
title="enum vstd::rwlock::RwLockToks::Config">Config</a>\<K, V, Pred\>
...
<div id="impl-UnwindSafe-for-Config%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-UnwindSafe-for-Config%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="enum.Config.html" class="enum"
title="enum vstd::rwlock::RwLockToks::Config">Config</a>\<K, V, Pred\>
