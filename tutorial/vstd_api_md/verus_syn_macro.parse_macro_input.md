...
<span class="sub-heading"><a href="../src/verus_syn/parse_macro_input.rs.html#108-128"
...
Refer to the [`parse` module](parse/index.html "mod verus_syn::parse")
...
trait](parse/trait.Parser.html "trait verus_syn::parse::Parser") for
types that have multiple ways that they can be parsed.
