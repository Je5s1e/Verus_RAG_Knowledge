...
# Struct <span class="struct">GhostPersistentSubmap</span> Copy item path

<span class="sub-heading"><a href="../../../src/vstd/tokens/map.rs.html#320-322"
class="src">Source</a> </span>

</div>

``` rust
pub struct GhostPersistentSubmap<K, V> { /* private fields */ }
```
...
The existence of a
[`GhostPersistentSubmap`](struct.GhostPersistentSubmap.html "struct vstd::tokens::map::GhostPersistentSubmap")
implies that:

- Those keys will remain in the map, pointing to the same values,
  forever;
- All other
  [`GhostSubmap`](struct.GhostSubmap.html "struct vstd::tokens::map::GhostSubmap")/[`GhostPointsTo`](struct.GhostPointsTo.html "struct vstd::tokens::map::GhostPointsTo")
...
<div id="impl-Freeze-for-GhostPersistentSubmap%3CK,+V%3E"
class="section impl">

<a href="#impl-Freeze-for-GhostPersistentSubmap%3CK,+V%3E"
class="anchor">§</a>

### impl\<K, V\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.GhostPersistentSubmap.html" class="struct"
title="struct vstd::tokens::map::GhostPersistentSubmap">GhostPersistentSubmap</a>\<K, V\>

</div>

<div id="impl-RefUnwindSafe-for-GhostPersistentSubmap%3CK,+V%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-GhostPersistentSubmap%3CK,+V%3E"
class="anchor">§</a>

### impl\<K, V\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.GhostPersistentSubmap.html" class="struct"
title="struct vstd::tokens::map::GhostPersistentSubmap">GhostPersistentSubmap</a>\<K, V\>
...
<div id="impl-Send-for-GhostPersistentSubmap%3CK,+V%3E"
class="section impl">

<a href="#impl-Send-for-GhostPersistentSubmap%3CK,+V%3E"
class="anchor">§</a>

### impl\<K, V\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.GhostPersistentSubmap.html" class="struct"
title="struct vstd::tokens::map::GhostPersistentSubmap">GhostPersistentSubmap</a>\<K, V\>
...
<div id="impl-Sync-for-GhostPersistentSubmap%3CK,+V%3E"
class="section impl">

<a href="#impl-Sync-for-GhostPersistentSubmap%3CK,+V%3E"
class="anchor">§</a>

### impl\<K, V\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.GhostPersistentSubmap.html" class="struct"
title="struct vstd::tokens::map::GhostPersistentSubmap">GhostPersistentSubmap</a>\<K, V\>
...
<div id="impl-Unpin-for-GhostPersistentSubmap%3CK,+V%3E"
class="section impl">

<a href="#impl-Unpin-for-GhostPersistentSubmap%3CK,+V%3E"
class="anchor">§</a>

### impl\<K, V\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.GhostPersistentSubmap.html" class="struct"
title="struct vstd::tokens::map::GhostPersistentSubmap">GhostPersistentSubmap</a>\<K, V\>
...
<div id="impl-UnwindSafe-for-GhostPersistentSubmap%3CK,+V%3E"
class="section impl">

<a href="#impl-UnwindSafe-for-GhostPersistentSubmap%3CK,+V%3E"
class="anchor">§</a>

### impl\<K, V\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.GhostPersistentSubmap.html" class="struct"
title="struct vstd::tokens::map::GhostPersistentSubmap">GhostPersistentSubmap</a>\<K, V\>
