...
# Struct <span class="struct">GhostVarAuth</span> Copy item path

<span class="sub-heading"><a href="../../../src/vstd/tokens/frac.rs.html#349-351"
...
One possible application is to have a library which keeps
`GhostVarAuth<T>` and maintains an invariant relating the
implementation’s abstract state to the value of `GhostVarAuth<T>`. Both
`GhostVarAuth<T>` and
[`GhostVar<T>`](struct.GhostVar.html "struct vstd::tokens::frac::GhostVar")
are needed together to update the value, but either one alone allows
reasoning about the current state.

These tokens can be implemented using fractional permissions, e.g.,
[`FracGhost`](struct.FracGhost.html "struct vstd::tokens::frac::FracGhost").
...
<div id="impl-Freeze-for-GhostVarAuth%3CT%3E" class="section impl">

<a href="#impl-Freeze-for-GhostVarAuth%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.GhostVarAuth.html" class="struct"
title="struct vstd::tokens::frac::GhostVarAuth">GhostVarAuth</a>\<T\>

</div>

<div id="impl-RefUnwindSafe-for-GhostVarAuth%3CT%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-GhostVarAuth%3CT%3E"
class="anchor">§</a>

### impl\<T\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.GhostVarAuth.html" class="struct"
title="struct vstd::tokens::frac::GhostVarAuth">GhostVarAuth</a>\<T\>
...
<div id="impl-Send-for-GhostVarAuth%3CT%3E" class="section impl">

<a href="#impl-Send-for-GhostVarAuth%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.GhostVarAuth.html" class="struct"
title="struct vstd::tokens::frac::GhostVarAuth">GhostVarAuth</a>\<T\>
...
<div id="impl-Sync-for-GhostVarAuth%3CT%3E" class="section impl">

<a href="#impl-Sync-for-GhostVarAuth%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.GhostVarAuth.html" class="struct"
title="struct vstd::tokens::frac::GhostVarAuth">GhostVarAuth</a>\<T\>
...
<div id="impl-Unpin-for-GhostVarAuth%3CT%3E" class="section impl">

<a href="#impl-Unpin-for-GhostVarAuth%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.GhostVarAuth.html" class="struct"
title="struct vstd::tokens::frac::GhostVarAuth">GhostVarAuth</a>\<T\>
...
<div id="impl-UnwindSafe-for-GhostVarAuth%3CT%3E" class="section impl">

<a href="#impl-UnwindSafe-for-GhostVarAuth%3CT%3E" class="anchor">§</a>

### impl\<T\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.GhostVarAuth.html" class="struct"
title="struct vstd::tokens::frac::GhostVarAuth">GhostVarAuth</a>\<T\>
