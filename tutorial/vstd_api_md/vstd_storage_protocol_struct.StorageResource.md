...
[vstd](../index.html)::[storage_protocol](index.html)

</div>

# Struct <span class="struct">StorageResource</span> Copy item path

<span class="sub-heading"><a href="../../src/vstd/storage_protocol.rs.html#33-36"
...
Storage protocols are based on [*Leaf: Modularity for Temporary Sharing
in Separation Logic*](https://dl.acm.org/doi/10.1145/3622798).

The reference for the laws and operations we’re embedding here can be
found at:
...
The reference version requires two monoids, the “protocol monoid” and
the “base monoid”. In this interface, we fix the base monoid to be of
the form [`Map<K, V>`](../map/struct.Map.html "struct vstd::map::Map").
(with composition of overlapping maps being undefined), which has all
the necessary properties. Note that there’s no `create_unit` (it’s not
sound to do this for an arbitrary location unless you already know a
protocol was initialized at that location).

For applications, I generally advise using the
[`tokenized_state_machine!`
system](https://verus-lang.github.io/verus/state_machines/), rather than
...
<div id="impl-Freeze-for-StorageResource%3CK,+V,+P%3E"
class="section impl">

<a href="#impl-Freeze-for-StorageResource%3CK,+V,+P%3E"
class="anchor">§</a>

### impl\<K, V, P\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.StorageResource.html" class="struct"
title="struct vstd::storage_protocol::StorageResource">StorageResource</a>\<K, V, P\>

</div>

<div id="impl-RefUnwindSafe-for-StorageResource%3CK,+V,+P%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-StorageResource%3CK,+V,+P%3E"
class="anchor">§</a>

### impl\<K, V, P\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.StorageResource.html" class="struct"
title="struct vstd::storage_protocol::StorageResource">StorageResource</a>\<K, V, P\>
...
<div id="impl-Send-for-StorageResource%3CK,+V,+P%3E"
class="section impl">

<a href="#impl-Send-for-StorageResource%3CK,+V,+P%3E"
class="anchor">§</a>

### impl\<K, V, P\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.StorageResource.html" class="struct"
title="struct vstd::storage_protocol::StorageResource">StorageResource</a>\<K, V, P\>
...
<div id="impl-Sync-for-StorageResource%3CK,+V,+P%3E"
class="section impl">

<a href="#impl-Sync-for-StorageResource%3CK,+V,+P%3E"
class="anchor">§</a>

### impl\<K, V, P\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.StorageResource.html" class="struct"
title="struct vstd::storage_protocol::StorageResource">StorageResource</a>\<K, V, P\>
...
<div id="impl-Unpin-for-StorageResource%3CK,+V,+P%3E"
class="section impl">

<a href="#impl-Unpin-for-StorageResource%3CK,+V,+P%3E"
class="anchor">§</a>

### impl\<K, V, P\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.StorageResource.html" class="struct"
title="struct vstd::storage_protocol::StorageResource">StorageResource</a>\<K, V, P\>
...
<div id="impl-UnwindSafe-for-StorageResource%3CK,+V,+P%3E"
class="section impl">

<a href="#impl-UnwindSafe-for-StorageResource%3CK,+V,+P%3E"
class="anchor">§</a>

### impl\<K, V, P\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.StorageResource.html" class="struct"
title="struct vstd::storage_protocol::StorageResource">StorageResource</a>\<K, V, P\>
