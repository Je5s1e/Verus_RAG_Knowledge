...
# Struct <span class="struct">ItemTrait</span> Copy item path

<span class="sub-heading"><a href="../src/verus_syn/item.rs.html#271-288" class="src">Source</a>
</span>
...
title="enum verus_syn::Visibility"><code>Visibility</code></a></span><span id="structfield.unsafety"
...
title="struct verus_syn::token::Unsafe"><code>Unsafe</code></a>`>`</span><span id="structfield.auto_token"
class="structfield section-header"><a href="#structfield.auto_token" class="anchor field">§</a>`auto_token: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<`<a href="token/struct.Auto.html" class="struct"
title="struct verus_syn::token::Auto"><code>Auto</code></a>`>`</span><span id="structfield.restriction"
class="structfield section-header"><a href="#structfield.restriction" class="anchor field">§</a>`restriction: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<`<a href="enum.ImplRestriction.html" class="enum"
title="enum verus_syn::ImplRestriction"><code>ImplRestriction</code></a>`>`</span><span id="structfield.trait_token"
class="structfield section-header"><a href="#structfield.trait_token" class="anchor field">§</a>`trait_token: `<a href="token/struct.Trait.html" class="struct"
title="struct verus_syn::token::Trait"><code>Trait</code></a></span><span id="structfield.ident"
...
class="structfield section-header"><a href="#structfield.colon_token" class="anchor field">§</a>`colon_token: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<`<a href="token/struct.Colon.html" class="struct"
title="struct verus_syn::token::Colon"><code>Colon</code></a>`>`</span><span id="structfield.supertraits"
class="structfield section-header"><a href="#structfield.supertraits" class="anchor field">§</a>`supertraits: `<a href="punctuated/struct.Punctuated.html" class="struct"
title="struct verus_syn::punctuated::Punctuated"><code>Punctuated</code></a>`<`<a href="enum.TypeParamBound.html" class="enum"
title="enum verus_syn::TypeParamBound"><code>TypeParamBound</code></a>`, `<a href="token/struct.Plus.html" class="struct"
title="struct verus_syn::token::Plus"><code>Plus</code></a>`>`</span><span id="structfield.brace_token"
class="structfield section-header"><a href="#structfield.brace_token" class="anchor field">§</a>`brace_token: `<a href="token/struct.Brace.html" class="struct"
title="struct verus_syn::token::Brace"><code>Brace</code></a></span><span id="structfield.items"
class="structfield section-header"><a href="#structfield.items" class="anchor field">§</a>`items: `<a href="https://doc.rust-lang.org/1.92.0/alloc/vec/struct.Vec.html"
class="struct" title="struct alloc::vec::Vec"><code>Vec</code></a>`<`<a href="enum.TraitItem.html" class="enum"
title="enum verus_syn::TraitItem"><code>TraitItem</code></a>`>`</span>

## Trait Implementations<a href="#trait-implementations" class="anchor">§</a>

<div id="trait-implementations-list">

<div id="impl-Clone-for-ItemTrait" class="section impl">

<a href="../src/verus_syn/gen/clone.rs.html#1727-1744"
class="src rightside">Source</a><a href="#impl-Clone-for-ItemTrait" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/clone/trait.Clone.html"
class="trait" title="trait core::clone::Clone">Clone</a> for <a href="struct.ItemTrait.html" class="struct"
...
<a href="../src/verus_syn/gen/clone.rs.html#1728-1743"
...
<div id="impl-Debug-for-ItemTrait" class="section impl">

<a href="../src/verus_syn/gen/debug.rs.html#2495-2499"
class="src rightside">Source</a><a href="#impl-Debug-for-ItemTrait" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/fmt/trait.Debug.html"
class="trait" title="trait core::fmt::Debug">Debug</a> for <a href="struct.ItemTrait.html" class="struct"
title="struct verus_syn::ItemTrait">ItemTrait</a>
...
<a href="../src/verus_syn/gen/debug.rs.html#2496-2498"
...
<div id="impl-Hash-for-ItemTrait" class="section impl">

<a href="../src/verus_syn/gen/hash.rs.html#2203-2219"
class="src rightside">Source</a><a href="#impl-Hash-for-ItemTrait" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/hash/trait.Hash.html"
class="trait" title="trait core::hash::Hash">Hash</a> for <a href="struct.ItemTrait.html" class="struct"
title="struct verus_syn::ItemTrait">ItemTrait</a>
...
<a href="../src/verus_syn/gen/hash.rs.html#2204-2218"
...
<a href="../src/verus_syn/item.rs.html#2384-2402"
...
<div id="impl-PartialEq-for-ItemTrait" class="section impl">

<a href="../src/verus_syn/gen/eq.rs.html#1700-1708"
class="src rightside">Source</a><a href="#impl-PartialEq-for-ItemTrait" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.PartialEq.html"
class="trait" title="trait core::cmp::PartialEq">PartialEq</a> for <a href="struct.ItemTrait.html" class="struct"
title="struct verus_syn::ItemTrait">ItemTrait</a>
...
<a href="../src/verus_syn/gen/eq.rs.html#1701-1707"
...
<div id="impl-ToTokens-for-ItemTrait" class="section impl">

<a href="../src/verus_syn/item.rs.html#3378-3397"
class="src rightside">Source</a><a href="#impl-ToTokens-for-ItemTrait" class="anchor">§</a>

### impl <a href="../quote/to_tokens/trait.ToTokens.html" class="trait"
title="trait quote::to_tokens::ToTokens">ToTokens</a> for <a href="struct.ItemTrait.html" class="struct"
title="struct verus_syn::ItemTrait">ItemTrait</a>
...
<a href="../src/verus_syn/item.rs.html#3379-3396"
...
<div id="impl-Eq-for-ItemTrait" class="section impl">

<a href="../src/verus_syn/gen/eq.rs.html#1697"
class="src rightside">Source</a><a href="#impl-Eq-for-ItemTrait" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.Eq.html"
class="trait" title="trait core::cmp::Eq">Eq</a> for <a href="struct.ItemTrait.html" class="struct"
title="struct verus_syn::ItemTrait">ItemTrait</a>
...
<div id="impl-Freeze-for-ItemTrait" class="section impl">

<a href="#impl-Freeze-for-ItemTrait" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.ItemTrait.html" class="struct"
title="struct verus_syn::ItemTrait">ItemTrait</a>

</div>

<div id="impl-RefUnwindSafe-for-ItemTrait" class="section impl">

<a href="#impl-RefUnwindSafe-for-ItemTrait" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.ItemTrait.html" class="struct"
title="struct verus_syn::ItemTrait">ItemTrait</a>

</div>

<div id="impl-Send-for-ItemTrait" class="section impl">

<a href="#impl-Send-for-ItemTrait" class="anchor">§</a>

### impl \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.ItemTrait.html" class="struct"
title="struct verus_syn::ItemTrait">ItemTrait</a>

</div>

<div id="impl-Sync-for-ItemTrait" class="section impl">

<a href="#impl-Sync-for-ItemTrait" class="anchor">§</a>

### impl \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.ItemTrait.html" class="struct"
title="struct verus_syn::ItemTrait">ItemTrait</a>

</div>

<div id="impl-Unpin-for-ItemTrait" class="section impl">

<a href="#impl-Unpin-for-ItemTrait" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.ItemTrait.html" class="struct"
title="struct verus_syn::ItemTrait">ItemTrait</a>

</div>

<div id="impl-UnwindSafe-for-ItemTrait" class="section impl">

<a href="#impl-UnwindSafe-for-ItemTrait" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.ItemTrait.html" class="struct"
title="struct verus_syn::ItemTrait">ItemTrait</a>
