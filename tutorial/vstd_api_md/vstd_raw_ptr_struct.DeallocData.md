...
# Struct <span class="struct">DeallocData</span> Copy item path

<span class="sub-heading"><a href="../../src/vstd/raw_ptr.rs.html#822-829" class="src">Source</a>
</span>

</div>

``` rust
pub struct DeallocData {
    pub addr: usize,
    pub size: nat,
    pub align: nat,
...
<span id="structfield.addr"
class="structfield section-header"><a href="#structfield.addr" class="anchor field">§</a>`addr: `<a href="https://doc.rust-lang.org/1.92.0/std/primitive.usize.html"
class="primitive"><code>usize</code></a></span><span id="structfield.size"
class="structfield section-header"><a href="#structfield.size" class="anchor field">§</a>`size: `<a href="../prelude/struct.nat.html" class="struct"
title="struct vstd::prelude::nat"><code>nat</code></a></span><span id="structfield.align"
class="structfield section-header"><a href="#structfield.align" class="anchor field">§</a>`align: `<a href="../prelude/struct.nat.html" class="struct"
title="struct vstd::prelude::nat"><code>nat</code></a></span><span id="structfield.provenance"
class="structfield section-header"><a href="#structfield.provenance" class="anchor field">§</a>`provenance: `<a href="struct.Provenance.html" class="struct"
title="struct vstd::raw_ptr::Provenance"><code>Provenance</code></a></span>

<div class="docblock">

This should probably be some kind of “allocation ID” (with “allocation
ID” being only one part of a full Provenance definition).
...
<div id="impl-Freeze-for-DeallocData" class="section impl">

<a href="#impl-Freeze-for-DeallocData" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.DeallocData.html" class="struct"
title="struct vstd::raw_ptr::DeallocData">DeallocData</a>

</div>

<div id="impl-RefUnwindSafe-for-DeallocData" class="section impl">

<a href="#impl-RefUnwindSafe-for-DeallocData" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.DeallocData.html" class="struct"
title="struct vstd::raw_ptr::DeallocData">DeallocData</a>

</div>

<div id="impl-Send-for-DeallocData" class="section impl">

<a href="#impl-Send-for-DeallocData" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.DeallocData.html" class="struct"
title="struct vstd::raw_ptr::DeallocData">DeallocData</a>

</div>

<div id="impl-Sync-for-DeallocData" class="section impl">

<a href="#impl-Sync-for-DeallocData" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.DeallocData.html" class="struct"
title="struct vstd::raw_ptr::DeallocData">DeallocData</a>

</div>

<div id="impl-Unpin-for-DeallocData" class="section impl">

<a href="#impl-Unpin-for-DeallocData" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.DeallocData.html" class="struct"
title="struct vstd::raw_ptr::DeallocData">DeallocData</a>

</div>

<div id="impl-UnwindSafe-for-DeallocData" class="section impl">

<a href="#impl-UnwindSafe-for-DeallocData" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.DeallocData.html" class="struct"
title="struct vstd::raw_ptr::DeallocData">DeallocData</a>
