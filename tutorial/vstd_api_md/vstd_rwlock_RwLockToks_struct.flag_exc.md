...
# Struct <span class="struct">flag_exc</span> Copy item path
...
``` rust
pub struct flag_exc<K, V, Pred: InvariantPredicate<K, V>> { /* private fields */ }
```
...
title="trait vstd::rwlock::RwLockPredicate">RwLockPredicate</a>\<V\>\> <a href="../../atomic_ghost/trait.AtomicInvariantPredicate.html"
class="trait"
...
title="struct vstd::prelude::Tracked">Tracked</a>\<<a href="struct.Instance.html" class="struct"
...
class="primitive">bool</a>, <a href="struct.flag_exc.html" class="struct"
title="struct vstd::rwlock::RwLockToks::flag_exc">flag_exc</a>\<(Pred, <a href="../../cell/struct.CellId.html" class="struct"
title="struct vstd::cell::CellId">CellId</a>), <a href="../../cell/struct.PointsTo.html" class="struct"
title="struct vstd::cell::PointsTo">PointsTo</a>\<V\>, InternalPred\<V, Pred\>\>\> for <a href="../struct.InvariantPredicate_auto_RwLock_exc.html"
class="struct"
...
class="primitive">bool</a>\> for <a href="struct.flag_exc.html" class="struct"
...
<div id="impl-Freeze-for-flag_exc%3CK,+V,+Pred%3E" class="section impl">

<a href="#impl-Freeze-for-flag_exc%3CK,+V,+Pred%3E" class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.flag_exc.html" class="struct"
title="struct vstd::rwlock::RwLockToks::flag_exc">flag_exc</a>\<K, V, Pred\>

</div>

<div id="impl-RefUnwindSafe-for-flag_exc%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-flag_exc%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.flag_exc.html" class="struct"
title="struct vstd::rwlock::RwLockToks::flag_exc">flag_exc</a>\<K, V, Pred\>
...
<div id="impl-Send-for-flag_exc%3CK,+V,+Pred%3E" class="section impl">

<a href="#impl-Send-for-flag_exc%3CK,+V,+Pred%3E" class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.flag_exc.html" class="struct"
title="struct vstd::rwlock::RwLockToks::flag_exc">flag_exc</a>\<K, V, Pred\>
...
<div id="impl-Sync-for-flag_exc%3CK,+V,+Pred%3E" class="section impl">

<a href="#impl-Sync-for-flag_exc%3CK,+V,+Pred%3E" class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.flag_exc.html" class="struct"
title="struct vstd::rwlock::RwLockToks::flag_exc">flag_exc</a>\<K, V, Pred\>
...
<div id="impl-Unpin-for-flag_exc%3CK,+V,+Pred%3E" class="section impl">

<a href="#impl-Unpin-for-flag_exc%3CK,+V,+Pred%3E" class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.flag_exc.html" class="struct"
title="struct vstd::rwlock::RwLockToks::flag_exc">flag_exc</a>\<K, V, Pred\>
...
<div id="impl-UnwindSafe-for-flag_exc%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-UnwindSafe-for-flag_exc%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.flag_exc.html" class="struct"
title="struct vstd::rwlock::RwLockToks::flag_exc">flag_exc</a>\<K, V, Pred\>
