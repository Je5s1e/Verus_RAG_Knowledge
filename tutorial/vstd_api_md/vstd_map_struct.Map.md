...
# Struct <span class="struct">Map</span> Copy item path

<span class="sub-heading"><a href="../../src/vstd/map.rs.html#32-34" class="src">Source</a>
</span>
...
`Map<K, V>` is an abstract map type for specifications. To use a “map”
in compiled code, use an `exec` type like HashMap (TODO) that has a
`Map<K, V>` as its specification type.

An object `map: Map<K, V>` has a *domain*, a set of keys given by
[`map.dom()`](Map::dom), and a mapping for keys in the domain to values,
given by [`map[key]`](Map::index). Alternatively, a map can be thought
of as a set of `(K, V)` pairs where each key appears in at most entry.

In general, a map might be infinite. To work specifically with finite
maps, see the [`self.finite()`](Set::finite) predicate.

Maps can be constructed in a few different ways:

- \[`Map::empty()`\] constructs an empty map.
- \[`Map::new`\] and \[`Map::total`\] construct a map given functions
  that specify its domain and the mapping from keys to values (a *map
  comprehension*).
- The [`map!`](../macro.map.html "macro vstd::map") macro, to construct
  small maps of a fixed size.
- By manipulating an existing map with \[`Map::insert`\] or
  \[`Map::remove`\].

To prove that two maps are equal, it is usually easiest to use the
...
<div id="impl-Freeze-for-Map%3CK,+V%3E" class="section impl">

<a href="#impl-Freeze-for-Map%3CK,+V%3E" class="anchor">§</a>

### impl\<K, V\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.Map.html" class="struct"
title="struct vstd::map::Map">Map</a>\<K, V\>

</div>

<div id="impl-RefUnwindSafe-for-Map%3CK,+V%3E" class="section impl">

<a href="#impl-RefUnwindSafe-for-Map%3CK,+V%3E" class="anchor">§</a>

### impl\<K, V\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.Map.html" class="struct"
title="struct vstd::map::Map">Map</a>\<K, V\>
...
<div id="impl-Send-for-Map%3CK,+V%3E" class="section impl">

<a href="#impl-Send-for-Map%3CK,+V%3E" class="anchor">§</a>

### impl\<K, V\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.Map.html" class="struct"
title="struct vstd::map::Map">Map</a>\<K, V\>
...
<div id="impl-Sync-for-Map%3CK,+V%3E" class="section impl">

<a href="#impl-Sync-for-Map%3CK,+V%3E" class="anchor">§</a>

### impl\<K, V\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.Map.html" class="struct"
title="struct vstd::map::Map">Map</a>\<K, V\>
...
<div id="impl-Unpin-for-Map%3CK,+V%3E" class="section impl">

<a href="#impl-Unpin-for-Map%3CK,+V%3E" class="anchor">§</a>

### impl\<K, V\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.Map.html" class="struct"
title="struct vstd::map::Map">Map</a>\<K, V\>
...
<div id="impl-UnwindSafe-for-Map%3CK,+V%3E" class="section impl">

<a href="#impl-UnwindSafe-for-Map%3CK,+V%3E" class="anchor">§</a>

### impl\<K, V\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.Map.html" class="struct"
title="struct vstd::map::Map">Map</a>\<K, V\>
