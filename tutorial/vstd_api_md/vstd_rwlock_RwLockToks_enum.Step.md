...
# Enum <span class="enum">Step</span> Copy item path
...
<div id="variant.acquire_read_start" class="section variant">

<a href="#variant.acquire_read_start" class="anchor">§</a>

### acquire_read_start()

</div>

<div id="variant.acquire_read_end" class="section variant">

<a href="#variant.acquire_read_end" class="anchor">§</a>

### acquire_read_end()

</div>

<div id="variant.acquire_read_abandon" class="section variant">

<a href="#variant.acquire_read_abandon" class="anchor">§</a>

### acquire_read_abandon()

</div>

<div id="variant.acquire_exc_start" class="section variant">

<a href="#variant.acquire_exc_start" class="anchor">§</a>

### acquire_exc_start()

</div>

<div id="variant.acquire_exc_end" class="section variant">

<a href="#variant.acquire_exc_end" class="anchor">§</a>

### acquire_exc_end()

</div>

<div id="variant.release_exc" class="section variant">

<a href="#variant.release_exc" class="anchor">§</a>

### release_exc(V)

</div>

<div id="variant.release_shared" class="section variant">

<a href="#variant.release_shared" class="anchor">§</a>

### release_shared(V)

</div>

<div id="variant.dummy_to_use_type_params" class="section variant">

<a href="#variant.dummy_to_use_type_params" class="anchor">§</a>

### dummy_to_use_type_params(<a href="struct.State.html" class="struct"
...
<div id="impl-Freeze-for-Step%3CK,+V,+Pred%3E" class="section impl">

<a href="#impl-Freeze-for-Step%3CK,+V,+Pred%3E" class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="enum.Step.html" class="enum"
title="enum vstd::rwlock::RwLockToks::Step">Step</a>\<K, V, Pred\>
...
<div id="impl-RefUnwindSafe-for-Step%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-Step%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="enum.Step.html" class="enum"
title="enum vstd::rwlock::RwLockToks::Step">Step</a>\<K, V, Pred\>
...
<div id="impl-Send-for-Step%3CK,+V,+Pred%3E" class="section impl">

<a href="#impl-Send-for-Step%3CK,+V,+Pred%3E" class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="enum.Step.html" class="enum"
title="enum vstd::rwlock::RwLockToks::Step">Step</a>\<K, V, Pred\>
...
<div id="impl-Sync-for-Step%3CK,+V,+Pred%3E" class="section impl">

<a href="#impl-Sync-for-Step%3CK,+V,+Pred%3E" class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="enum.Step.html" class="enum"
title="enum vstd::rwlock::RwLockToks::Step">Step</a>\<K, V, Pred\>
...
<div id="impl-Unpin-for-Step%3CK,+V,+Pred%3E" class="section impl">

<a href="#impl-Unpin-for-Step%3CK,+V,+Pred%3E" class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="enum.Step.html" class="enum"
title="enum vstd::rwlock::RwLockToks::Step">Step</a>\<K, V, Pred\>
...
<div id="impl-UnwindSafe-for-Step%3CK,+V,+Pred%3E" class="section impl">

<a href="#impl-UnwindSafe-for-Step%3CK,+V,+Pred%3E" class="anchor">§</a>

### impl\<K, V, Pred\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="enum.Step.html" class="enum"
title="enum vstd::rwlock::RwLockToks::Step">Step</a>\<K, V, Pred\>
