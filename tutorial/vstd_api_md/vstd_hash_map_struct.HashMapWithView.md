...
# Struct <span class="struct">HashMapWithView</span> Copy item path

<span class="sub-heading"><a href="../../src/vstd/hash_map.rs.html#26-28" class="src">Source</a>
</span>

</div>

``` rust
pub struct HashMapWithView<Key, Value>where
...
`HashMapWithView` is a trusted wrapper around
`std::collections::HashMap` with `View` implemented for the type
`vstd::map::Map<<Key as View>::V, Value>`.
...
<div id="impl-HashMapWithView%3CKey,+Value%3E" class="section impl">

<a href="../../src/vstd/hash_map.rs.html#36-168"
class="src rightside">Source</a><a href="#impl-HashMapWithView%3CKey,+Value%3E" class="anchor">§</a>

### impl\<Key, Value\> <a href="struct.HashMapWithView.html" class="struct"
...
<a href="../../src/vstd/hash_map.rs.html#43-51"
...
<a href="../../src/vstd/hash_map.rs.html#59-67"
class="src rightside">Source</a>
...
Creates an empty `HashMapWithView` with at least capacity for the
...
<a href="../../src/vstd/hash_map.rs.html#73-78"
class="src rightside">Source</a>
...
<a href="../../src/vstd/hash_map.rs.html#82-87"
class="src rightside">Source</a>
...
<a href="../../src/vstd/hash_map.rs.html#95-100"
class="src rightside">Source</a>
...
<a href="../../src/vstd/hash_map.rs.html#106-111"
class="src rightside">Source</a>

#### pub fn <a href="#method.insert" class="fn">insert</a>(&mut self, k: Key, v: Value)
...
<a href="../../src/vstd/hash_map.rs.html#117-122"
class="src rightside">Source</a>
...
<a href="../../src/vstd/hash_map.rs.html#128-133"
class="src rightside">Source</a>

#### pub fn <a href="#method.contains_key" class="fn">contains_key</a>(&self, k: <a href="https://doc.rust-lang.org/1.92.0/std/primitive.reference.html"
...
<a href="../../src/vstd/hash_map.rs.html#139-147"
class="src rightside">Source</a>
...
<a href="../../src/vstd/hash_map.rs.html#153-158"
class="src rightside">Source</a>
...
<a href="../../src/vstd/hash_map.rs.html#162-167"
class="src rightside">Source</a>
...
### impl\<Key, Value\> <a href="../view/trait.View.html" class="trait"
title="trait vstd::view::View">View</a> for <a href="struct.HashMapWithView.html" class="struct"
title="struct vstd::hash_map::HashMapWithView">HashMapWithView</a>\<Key, Value\>
...
title="struct vstd::map::Map">Map</a>\<\<Key as <a href="../view/trait.View.html" class="trait"
title="trait vstd::view::View">View</a>\>::<a href="../view/trait.View.html#associatedtype.V"
class="associatedtype" title="type vstd::view::View::V">V</a>, Value\>
...
<div id="impl-Freeze-for-HashMapWithView%3CKey,+Value%3E"
class="section impl">

<a href="#impl-Freeze-for-HashMapWithView%3CKey,+Value%3E"
class="anchor">§</a>

### impl\<Key, Value\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.HashMapWithView.html" class="struct"
title="struct vstd::hash_map::HashMapWithView">HashMapWithView</a>\<Key, Value\>

</div>

<div id="impl-RefUnwindSafe-for-HashMapWithView%3CKey,+Value%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-HashMapWithView%3CKey,+Value%3E"
class="anchor">§</a>

### impl\<Key, Value\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.HashMapWithView.html" class="struct"
title="struct vstd::hash_map::HashMapWithView">HashMapWithView</a>\<Key, Value\>
...
<div id="impl-Send-for-HashMapWithView%3CKey,+Value%3E"
class="section impl">

<a href="#impl-Send-for-HashMapWithView%3CKey,+Value%3E"
class="anchor">§</a>

### impl\<Key, Value\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.HashMapWithView.html" class="struct"
title="struct vstd::hash_map::HashMapWithView">HashMapWithView</a>\<Key, Value\>
...
class="trait" title="trait core::marker::Send">Send</a>, Value:
<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
...
<div id="impl-Sync-for-HashMapWithView%3CKey,+Value%3E"
class="section impl">

<a href="#impl-Sync-for-HashMapWithView%3CKey,+Value%3E"
class="anchor">§</a>

### impl\<Key, Value\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.HashMapWithView.html" class="struct"
title="struct vstd::hash_map::HashMapWithView">HashMapWithView</a>\<Key, Value\>
...
class="trait" title="trait core::marker::Sync">Sync</a>, Value:
<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
...
<div id="impl-Unpin-for-HashMapWithView%3CKey,+Value%3E"
class="section impl">

<a href="#impl-Unpin-for-HashMapWithView%3CKey,+Value%3E"
class="anchor">§</a>

### impl\<Key, Value\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.HashMapWithView.html" class="struct"
title="struct vstd::hash_map::HashMapWithView">HashMapWithView</a>\<Key, Value\>
...
class="trait" title="trait core::marker::Unpin">Unpin</a>, Value:
<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
...
<div id="impl-UnwindSafe-for-HashMapWithView%3CKey,+Value%3E"
class="section impl">

<a href="#impl-UnwindSafe-for-HashMapWithView%3CKey,+Value%3E"
class="anchor">§</a>

### impl\<Key, Value\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.HashMapWithView.html" class="struct"
title="struct vstd::hash_map::HashMapWithView">HashMapWithView</a>\<Key, Value\>
