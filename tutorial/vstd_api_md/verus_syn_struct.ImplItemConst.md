...
# Struct <span class="struct">ImplItemConst</span> Copy item path

<span class="sub-heading"><a href="../src/verus_syn/item.rs.html#776-796" class="src">Source</a>
</span>

</div>

``` rust
pub struct ImplItemConst {Show 15 fields
...
title="enum verus_syn::Visibility"><code>Visibility</code></a></span><span id="structfield.publish"
...
title="enum verus_syn::Publish"><code>Publish</code></a></span><span id="structfield.mode"
class="structfield section-header"><a href="#structfield.mode" class="anchor field">§</a>`mode: `<a href="enum.FnMode.html" class="enum"
title="enum verus_syn::FnMode"><code>FnMode</code></a></span><span id="structfield.defaultness"
class="structfield section-header"><a href="#structfield.defaultness" class="anchor field">§</a>`defaultness: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<`<a href="token/struct.Default.html" class="struct"
title="struct verus_syn::token::Default"><code>Default</code></a>`>`</span><span id="structfield.const_token"
class="structfield section-header"><a href="#structfield.const_token" class="anchor field">§</a>`const_token: `<a href="token/struct.Const.html" class="struct"
title="struct verus_syn::token::Const"><code>Const</code></a></span><span id="structfield.ident"
...
title="struct verus_syn::Generics"><code>Generics</code></a></span><span id="structfield.colon_token"
class="structfield section-header"><a href="#structfield.colon_token" class="anchor field">§</a>`colon_token: `<a href="token/struct.Colon.html" class="struct"
title="struct verus_syn::token::Colon"><code>Colon</code></a></span><span id="structfield.ty"
class="structfield section-header"><a href="#structfield.ty" class="anchor field">§</a>`ty: `<a href="enum.Type.html" class="enum"
title="enum verus_syn::Type"><code>Type</code></a></span><span id="structfield.ensures"
...
title="struct verus_syn::Ensures"><code>Ensures</code></a>`>`</span><span id="structfield.eq_token"
class="structfield section-header"><a href="#structfield.eq_token" class="anchor field">§</a>`eq_token: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<`<a href="token/struct.Eq.html" class="struct"
title="struct verus_syn::token::Eq"><code>Eq</code></a>`>`</span><span id="structfield.block"
class="structfield section-header"><a href="#structfield.block" class="anchor field">§</a>`block: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<`<a href="https://doc.rust-lang.org/1.92.0/alloc/boxed/struct.Box.html"
class="struct" title="struct alloc::boxed::Box"><code>Box</code></a>`<`<a href="struct.Block.html" class="struct"
title="struct verus_syn::Block"><code>Block</code></a>`>>`</span><span id="structfield.expr"
class="structfield section-header"><a href="#structfield.expr" class="anchor field">§</a>`expr: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<`<a href="https://doc.rust-lang.org/1.92.0/alloc/boxed/struct.Box.html"
class="struct" title="struct alloc::boxed::Box"><code>Box</code></a>`<`<a href="enum.Expr.html" class="enum"
title="enum verus_syn::Expr"><code>Expr</code></a>`>>`</span><span id="structfield.semi_token"
class="structfield section-header"><a href="#structfield.semi_token" class="anchor field">§</a>`semi_token: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<`<a href="token/struct.Semi.html" class="struct"
...
<div id="impl-Clone-for-ImplItemConst" class="section impl">

<a href="../src/verus_syn/gen/clone.rs.html#1366-1386"
class="src rightside">Source</a><a href="#impl-Clone-for-ImplItemConst" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/clone/trait.Clone.html"
class="trait" title="trait core::clone::Clone">Clone</a> for <a href="struct.ImplItemConst.html" class="struct"
...
<a href="../src/verus_syn/gen/clone.rs.html#1367-1385"
...
<div id="impl-Debug-for-ImplItemConst" class="section impl">

<a href="../src/verus_syn/gen/debug.rs.html#2013-2017"
class="src rightside">Source</a><a href="#impl-Debug-for-ImplItemConst" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/fmt/trait.Debug.html"
class="trait" title="trait core::fmt::Debug">Debug</a> for <a href="struct.ImplItemConst.html" class="struct"
title="struct verus_syn::ImplItemConst">ImplItemConst</a>
...
<a href="../src/verus_syn/gen/debug.rs.html#2014-2016"
...
<div id="impl-From%3CImplItemConst%3E-for-ImplItem"
class="section impl">

<a href="../src/verus_syn/item.rs.html#727-774"
class="src rightside">Source</a><a href="#impl-From%3CImplItemConst%3E-for-ImplItem"
class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/convert/trait.From.html"
class="trait" title="trait core::convert::From">From</a>\<<a href="struct.ImplItemConst.html" class="struct"
title="struct verus_syn::ImplItemConst">ImplItemConst</a>\> for <a href="enum.ImplItem.html" class="enum"
...
class="fn">from</a>(e: <a href="struct.ImplItemConst.html" class="struct"
title="struct verus_syn::ImplItemConst">ImplItemConst</a>) -\> <a href="enum.ImplItem.html" class="enum"
title="enum verus_syn::ImplItem">ImplItem</a>
...
<div id="impl-Hash-for-ImplItemConst" class="section impl">

<a href="../src/verus_syn/gen/hash.rs.html#1784-1803"
class="src rightside">Source</a><a href="#impl-Hash-for-ImplItemConst" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/hash/trait.Hash.html"
class="trait" title="trait core::hash::Hash">Hash</a> for <a href="struct.ImplItemConst.html" class="struct"
title="struct verus_syn::ImplItemConst">ImplItemConst</a>
...
<a href="../src/verus_syn/gen/hash.rs.html#1785-1802"
...
<a href="../src/verus_syn/item.rs.html#2978-3024"
...
<div id="impl-PartialEq-for-ImplItemConst" class="section impl">

<a href="../src/verus_syn/gen/eq.rs.html#1378-1388"
class="src rightside">Source</a><a href="#impl-PartialEq-for-ImplItemConst" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.PartialEq.html"
class="trait" title="trait core::cmp::PartialEq">PartialEq</a> for <a href="struct.ImplItemConst.html" class="struct"
title="struct verus_syn::ImplItemConst">ImplItemConst</a>
...
<a href="../src/verus_syn/gen/eq.rs.html#1379-1387"
...
<div id="impl-ToTokens-for-ImplItemConst" class="section impl">

<a href="../src/verus_syn/item.rs.html#3566-3583"
class="src rightside">Source</a><a href="#impl-ToTokens-for-ImplItemConst" class="anchor">§</a>

### impl <a href="../quote/to_tokens/trait.ToTokens.html" class="trait"
title="trait quote::to_tokens::ToTokens">ToTokens</a> for <a href="struct.ImplItemConst.html" class="struct"
title="struct verus_syn::ImplItemConst">ImplItemConst</a>
...
<a href="../src/verus_syn/item.rs.html#3567-3582"
...
<div id="impl-Eq-for-ImplItemConst" class="section impl">

<a href="../src/verus_syn/gen/eq.rs.html#1375"
class="src rightside">Source</a><a href="#impl-Eq-for-ImplItemConst" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.Eq.html"
class="trait" title="trait core::cmp::Eq">Eq</a> for <a href="struct.ImplItemConst.html" class="struct"
title="struct verus_syn::ImplItemConst">ImplItemConst</a>
...
<div id="impl-Freeze-for-ImplItemConst" class="section impl">

<a href="#impl-Freeze-for-ImplItemConst" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.ImplItemConst.html" class="struct"
title="struct verus_syn::ImplItemConst">ImplItemConst</a>

</div>

<div id="impl-RefUnwindSafe-for-ImplItemConst" class="section impl">

<a href="#impl-RefUnwindSafe-for-ImplItemConst" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.ImplItemConst.html" class="struct"
title="struct verus_syn::ImplItemConst">ImplItemConst</a>

</div>

<div id="impl-Send-for-ImplItemConst" class="section impl">

<a href="#impl-Send-for-ImplItemConst" class="anchor">§</a>

### impl \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.ImplItemConst.html" class="struct"
title="struct verus_syn::ImplItemConst">ImplItemConst</a>

</div>

<div id="impl-Sync-for-ImplItemConst" class="section impl">

<a href="#impl-Sync-for-ImplItemConst" class="anchor">§</a>

### impl \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.ImplItemConst.html" class="struct"
title="struct verus_syn::ImplItemConst">ImplItemConst</a>

</div>

<div id="impl-Unpin-for-ImplItemConst" class="section impl">

<a href="#impl-Unpin-for-ImplItemConst" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.ImplItemConst.html" class="struct"
title="struct verus_syn::ImplItemConst">ImplItemConst</a>

</div>

<div id="impl-UnwindSafe-for-ImplItemConst" class="section impl">

<a href="#impl-UnwindSafe-for-ImplItemConst" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.ImplItemConst.html" class="struct"
title="struct verus_syn::ImplItemConst">ImplItemConst</a>
