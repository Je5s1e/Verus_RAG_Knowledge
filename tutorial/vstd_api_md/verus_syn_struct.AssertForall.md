...
# Struct <span class="struct">AssertForall</span> Copy item path

<span class="sub-heading"><a href="../src/verus_syn/verus.rs.html#318-331" class="src">Source</a>
</span>
...
title="struct verus_syn::Attribute"><code>Attribute</code></a>`>`</span><span id="structfield.assert_token"
class="structfield section-header"><a href="#structfield.assert_token" class="anchor field">§</a>`assert_token: `<a href="token/struct.Assert.html" class="struct"
title="struct verus_syn::token::Assert"><code>Assert</code></a></span><span id="structfield.forall_token"
class="structfield section-header"><a href="#structfield.forall_token" class="anchor field">§</a>`forall_token: `<a href="token/struct.Forall.html" class="struct"
title="struct verus_syn::token::Forall"><code>Forall</code></a></span><span id="structfield.or1_token"
...
title="struct verus_syn::punctuated::Punctuated"><code>Punctuated</code></a>`<`<a href="enum.Pat.html" class="enum"
title="enum verus_syn::Pat"><code>Pat</code></a>`, `<a href="token/struct.Comma.html" class="struct"
...
title="struct verus_syn::token::Or"><code>Or</code></a></span><span id="structfield.expr"
class="structfield section-header"><a href="#structfield.expr" class="anchor field">§</a>`expr: `<a href="https://doc.rust-lang.org/1.92.0/alloc/boxed/struct.Box.html"
class="struct" title="struct alloc::boxed::Box"><code>Box</code></a>`<`<a href="enum.Expr.html" class="enum"
title="enum verus_syn::Expr"><code>Expr</code></a>`>`</span><span id="structfield.implies"
class="structfield section-header"><a href="#structfield.implies" class="anchor field">§</a>`implies: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<(`<a href="token/struct.Implies.html" class="struct"
title="struct verus_syn::token::Implies"><code>Implies</code></a>`, `<a href="https://doc.rust-lang.org/1.92.0/alloc/boxed/struct.Box.html"
class="struct" title="struct alloc::boxed::Box"><code>Box</code></a>`<`<a href="enum.Expr.html" class="enum"
title="enum verus_syn::Expr"><code>Expr</code></a>`>)>`</span><span id="structfield.by_token"
class="structfield section-header"><a href="#structfield.by_token" class="anchor field">§</a>`by_token: `<a href="token/struct.By.html" class="struct"
title="struct verus_syn::token::By"><code>By</code></a></span><span id="structfield.body"
...
title="struct verus_syn::Block"><code>Block</code></a>`>`</span>

## Trait Implementations<a href="#trait-implementations" class="anchor">§</a>

<div id="trait-implementations-list">

<div id="impl-Clone-for-AssertForall" class="section impl">

<a href="../src/verus_syn/gen/clone.rs.html#57-72"
class="src rightside">Source</a><a href="#impl-Clone-for-AssertForall" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/clone/trait.Clone.html"
class="trait" title="trait core::clone::Clone">Clone</a> for <a href="struct.AssertForall.html" class="struct"
...
<a href="../src/verus_syn/gen/clone.rs.html#58-71"
...
<div id="impl-Debug-for-AssertForall" class="section impl">

<a href="../src/verus_syn/gen/debug.rs.html#64-79"
class="src rightside">Source</a><a href="#impl-Debug-for-AssertForall" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/fmt/trait.Debug.html"
class="trait" title="trait core::fmt::Debug">Debug</a> for <a href="struct.AssertForall.html" class="struct"
title="struct verus_syn::AssertForall">AssertForall</a>
...
<a href="../src/verus_syn/gen/debug.rs.html#65-78"
...
<div id="impl-Hash-for-AssertForall" class="section impl">

<a href="../src/verus_syn/gen/hash.rs.html#57-68"
class="src rightside">Source</a><a href="#impl-Hash-for-AssertForall" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/hash/trait.Hash.html"
class="trait" title="trait core::hash::Hash">Hash</a> for <a href="struct.AssertForall.html" class="struct"
title="struct verus_syn::AssertForall">AssertForall</a>
...
<a href="../src/verus_syn/gen/hash.rs.html#58-67"
...
<a href="../src/verus_syn/verus.rs.html#1260-1309"
...
<div id="impl-PartialEq-for-AssertForall" class="section impl">

<a href="../src/verus_syn/gen/eq.rs.html#50-56"
class="src rightside">Source</a><a href="#impl-PartialEq-for-AssertForall" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.PartialEq.html"
class="trait" title="trait core::cmp::PartialEq">PartialEq</a> for <a href="struct.AssertForall.html" class="struct"
title="struct verus_syn::AssertForall">AssertForall</a>
...
<a href="../src/verus_syn/gen/eq.rs.html#51-55"
...
<div id="impl-ToTokens-for-AssertForall" class="section impl">

<a href="../src/verus_syn/verus.rs.html#1892-1908"
class="src rightside">Source</a><a href="#impl-ToTokens-for-AssertForall" class="anchor">§</a>

### impl <a href="../quote/to_tokens/trait.ToTokens.html" class="trait"
title="trait quote::to_tokens::ToTokens">ToTokens</a> for <a href="struct.AssertForall.html" class="struct"
title="struct verus_syn::AssertForall">AssertForall</a>
...
<a href="../src/verus_syn/verus.rs.html#1893-1907"
...
<div id="impl-Eq-for-AssertForall" class="section impl">

<a href="../src/verus_syn/gen/eq.rs.html#48"
class="src rightside">Source</a><a href="#impl-Eq-for-AssertForall" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.Eq.html"
class="trait" title="trait core::cmp::Eq">Eq</a> for <a href="struct.AssertForall.html" class="struct"
title="struct verus_syn::AssertForall">AssertForall</a>
...
<div id="impl-Freeze-for-AssertForall" class="section impl">

<a href="#impl-Freeze-for-AssertForall" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.AssertForall.html" class="struct"
title="struct verus_syn::AssertForall">AssertForall</a>

</div>

<div id="impl-RefUnwindSafe-for-AssertForall" class="section impl">

<a href="#impl-RefUnwindSafe-for-AssertForall" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.AssertForall.html" class="struct"
title="struct verus_syn::AssertForall">AssertForall</a>

</div>

<div id="impl-Send-for-AssertForall" class="section impl">

<a href="#impl-Send-for-AssertForall" class="anchor">§</a>

### impl \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.AssertForall.html" class="struct"
title="struct verus_syn::AssertForall">AssertForall</a>

</div>

<div id="impl-Sync-for-AssertForall" class="section impl">

<a href="#impl-Sync-for-AssertForall" class="anchor">§</a>

### impl \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.AssertForall.html" class="struct"
title="struct verus_syn::AssertForall">AssertForall</a>

</div>

<div id="impl-Unpin-for-AssertForall" class="section impl">

<a href="#impl-Unpin-for-AssertForall" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.AssertForall.html" class="struct"
title="struct verus_syn::AssertForall">AssertForall</a>

</div>

<div id="impl-UnwindSafe-for-AssertForall" class="section impl">

<a href="#impl-UnwindSafe-for-AssertForall" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.AssertForall.html" class="struct"
title="struct verus_syn::AssertForall">AssertForall</a>
