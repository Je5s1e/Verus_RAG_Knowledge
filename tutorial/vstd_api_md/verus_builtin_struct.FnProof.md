...
# Struct <span class="struct">FnProof</span> Copy item path

<span class="sub-heading"><a href="../src/verus_builtin/lib.rs.html#1544-1550"
...
<div id="impl-Clone-for-FnProof%3C'a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="section impl">

<a href="../src/verus_builtin/lib.rs.html#1687-1693"
class="src rightside">Source</a><a
href="#impl-Clone-for-FnProof%3C&#39;a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="anchor">§</a>

### impl\<'a, Options: <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Copy.html"
class="trait" title="trait core::marker::Copy">Copy</a>, ArgModes, OutMode, Args, Output\> <a href="https://doc.rust-lang.org/1.92.0/core/clone/trait.Clone.html"
class="trait" title="trait core::clone::Clone">Clone</a> for <a href="struct.FnProof.html" class="struct"
title="struct verus_builtin::FnProof">FnProof</a>\<'a, Options, ArgModes, OutMode, Args, Output\>
...
<a href="../src/verus_builtin/lib.rs.html#1690-1692"
...
<div id="impl-Copy-for-FnProof%3C'a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="section impl">

<a href="../src/verus_builtin/lib.rs.html#1695-1698"
class="src rightside">Source</a><a
href="#impl-Copy-for-FnProof%3C&#39;a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="anchor">§</a>

### impl\<'a, Options: <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Copy.html"
class="trait" title="trait core::marker::Copy">Copy</a>, ArgModes, OutMode, Args, Output\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Copy.html"
class="trait" title="trait core::marker::Copy">Copy</a> for <a href="struct.FnProof.html" class="struct"
title="struct verus_builtin::FnProof">FnProof</a>\<'a, Options, ArgModes, OutMode, Args, Output\>

</div>

<div id="impl-Send-for-FnProof%3C'a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="section impl">

<a href="../src/verus_builtin/lib.rs.html#1700-1703"
class="src rightside">Source</a><a
href="#impl-Send-for-FnProof%3C&#39;a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="anchor">§</a>

### impl\<'a, Options: <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a>, ArgModes, OutMode, Args, Output\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.FnProof.html" class="struct"
title="struct verus_builtin::FnProof">FnProof</a>\<'a, Options, ArgModes, OutMode, Args, Output\>

</div>

<div id="impl-Sync-for-FnProof%3C'a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="section impl">

<a href="../src/verus_builtin/lib.rs.html#1705-1708"
class="src rightside">Source</a><a
href="#impl-Sync-for-FnProof%3C&#39;a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="anchor">§</a>

### impl\<'a, Options: <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a>, ArgModes, OutMode, Args, Output\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.FnProof.html" class="struct"
title="struct verus_builtin::FnProof">FnProof</a>\<'a, Options, ArgModes, OutMode, Args, Output\>
...
<div id="impl-Freeze-for-FnProof%3C'a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="section impl">

<a
href="#impl-Freeze-for-FnProof%3C&#39;a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="anchor">§</a>

### impl\<'a, Options, ArgModes, OutMode, Args, Output\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.FnProof.html" class="struct"
title="struct verus_builtin::FnProof">FnProof</a>\<'a, Options, ArgModes, OutMode, Args, Output\>

</div>

<div id="impl-RefUnwindSafe-for-FnProof%3C'a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="section impl">

<a
href="#impl-RefUnwindSafe-for-FnProof%3C&#39;a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="anchor">§</a>

### impl\<'a, Options, ArgModes, OutMode, Args, Output\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.FnProof.html" class="struct"
title="struct verus_builtin::FnProof">FnProof</a>\<'a, Options, ArgModes, OutMode, Args, Output\>
...
<div id="impl-Unpin-for-FnProof%3C'a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="section impl">

<a
href="#impl-Unpin-for-FnProof%3C&#39;a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="anchor">§</a>

### impl\<'a, Options, ArgModes, OutMode, Args, Output\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.FnProof.html" class="struct"
title="struct verus_builtin::FnProof">FnProof</a>\<'a, Options, ArgModes, OutMode, Args, Output\>
...
class="trait" title="trait core::marker::Unpin">Unpin</a>, ArgModes:
<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a>, OutMode:
<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
...
<div id="impl-UnwindSafe-for-FnProof%3C'a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="section impl">

<a
href="#impl-UnwindSafe-for-FnProof%3C&#39;a,+Options,+ArgModes,+OutMode,+Args,+Output%3E"
class="anchor">§</a>

### impl\<'a, Options, ArgModes, OutMode, Args, Output\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.FnProof.html" class="struct"
title="struct verus_builtin::FnProof">FnProof</a>\<'a, Options, ArgModes, OutMode, Args, Output\>
