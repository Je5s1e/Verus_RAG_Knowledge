...
# Struct <span class="struct">LocalInvariant</span> Copy item path

<span class="sub-heading"><a href="../../src/vstd/invariant.rs.html#163-166"
...
A `LocalInvariant` cannot be shared between threads (that is, it does
not implement [`Sync`](https://doc.rust-lang.org/std/sync/)). However,
this means that a `LocalInvariant` can be opened for an indefinite
length of time, since there is no risk of a race with another thread.
For an invariant object with the opposite properties, see
...
(\[`LocalInvariant::new`\]). These values are fixed for the lifetime of
the `LocalInvariant` object. To open the invariant and access the stored
object `V`, use the macro
[`open_local_invariant!`](../macro.open_local_invariant.html "macro vstd::open_local_invariant").

The `LocalInvariant` API is an instance of the [“invariant” method in
...
<div id="impl-Freeze-for-LocalInvariant%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-Freeze-for-LocalInvariant%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.LocalInvariant.html" class="struct"
title="struct vstd::invariant::LocalInvariant">LocalInvariant</a>\<K, V, Pred\>

</div>

<div id="impl-RefUnwindSafe-for-LocalInvariant%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-LocalInvariant%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.LocalInvariant.html" class="struct"
title="struct vstd::invariant::LocalInvariant">LocalInvariant</a>\<K, V, Pred\>
...
<div id="impl-Send-for-LocalInvariant%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-Send-for-LocalInvariant%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.LocalInvariant.html" class="struct"
title="struct vstd::invariant::LocalInvariant">LocalInvariant</a>\<K, V, Pred\>
...
<div id="impl-Sync-for-LocalInvariant%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-Sync-for-LocalInvariant%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.LocalInvariant.html" class="struct"
title="struct vstd::invariant::LocalInvariant">LocalInvariant</a>\<K, V, Pred\>

</div>

<div id="impl-Unpin-for-LocalInvariant%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-Unpin-for-LocalInvariant%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.LocalInvariant.html" class="struct"
title="struct vstd::invariant::LocalInvariant">LocalInvariant</a>\<K, V, Pred\>
...
<div id="impl-UnwindSafe-for-LocalInvariant%3CK,+V,+Pred%3E"
class="section impl">

<a href="#impl-UnwindSafe-for-LocalInvariant%3CK,+V,+Pred%3E"
class="anchor">§</a>

### impl\<K, V, Pred\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.LocalInvariant.html" class="struct"
title="struct vstd::invariant::LocalInvariant">LocalInvariant</a>\<K, V, Pred\>
