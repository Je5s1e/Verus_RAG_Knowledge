...
# Struct <span class="struct">WriteHandle</span> Copy item path

<span class="sub-heading"><a href="../../src/vstd/rwlock.rs.html#373-377" class="src">Source</a>
</span>

</div>

``` rust
pub struct WriteHandle<'a, V, Pred: RwLockPredicate<V>> { /* private fields */ }
```
...
[`RwLock`](struct.RwLock.html "struct vstd::rwlock::RwLock").

Note that this handle does not contain a reference to the lock-protected
object; ownership of the object is obtained separately from
[`RwLock::acquire_write`](struct.RwLock.html#method.acquire_write "method vstd::rwlock::RwLock::acquire_write").
This may be changed in the future.

**Warning:** The lock is *NOT* released automatically when the handle is
dropped. You must call
[`release_write`](struct.WriteHandle.html#method.release_write "method vstd::rwlock::WriteHandle::release_write").
...
<div id="impl-WriteHandle%3C'a,+V,+Pred%3E" class="section impl">

<a href="../../src/vstd/rwlock.rs.html#389-419"
class="src rightside">Source</a><a href="#impl-WriteHandle%3C&#39;a,+V,+Pred%3E" class="anchor">§</a>

### impl\<'a, V, Pred: <a href="trait.RwLockPredicate.html" class="trait"
title="trait vstd::rwlock::RwLockPredicate">RwLockPredicate</a>\<V\>\> <a href="struct.WriteHandle.html" class="struct"
title="struct vstd::rwlock::WriteHandle">WriteHandle</a>\<'a, V, Pred\>

</div>

<div class="impl-items">

<div id="method.release_write" class="section method">

<a href="../../src/vstd/rwlock.rs.html#402-418"
class="src rightside">Source</a>

#### pub fn <a href="#method.release_write" class="fn">release_write</a>(self, new_val: V)
...
<div id="impl-Freeze-for-WriteHandle%3C'a,+V,+Pred%3E"
class="section impl">

<a href="#impl-Freeze-for-WriteHandle%3C&#39;a,+V,+Pred%3E"
class="anchor">§</a>

### impl\<'a, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.WriteHandle.html" class="struct"
title="struct vstd::rwlock::WriteHandle">WriteHandle</a>\<'a, V, Pred\>

</div>

<div id="impl-RefUnwindSafe-for-WriteHandle%3C'a,+V,+Pred%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-WriteHandle%3C&#39;a,+V,+Pred%3E"
class="anchor">§</a>

### impl\<'a, V, Pred\> \!<a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.WriteHandle.html" class="struct"
title="struct vstd::rwlock::WriteHandle">WriteHandle</a>\<'a, V, Pred\>

</div>

<div id="impl-Send-for-WriteHandle%3C'a,+V,+Pred%3E"
class="section impl">

<a href="#impl-Send-for-WriteHandle%3C&#39;a,+V,+Pred%3E"
class="anchor">§</a>

### impl\<'a, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.WriteHandle.html" class="struct"
title="struct vstd::rwlock::WriteHandle">WriteHandle</a>\<'a, V, Pred\>
...
<div id="impl-Sync-for-WriteHandle%3C'a,+V,+Pred%3E"
class="section impl">

<a href="#impl-Sync-for-WriteHandle%3C&#39;a,+V,+Pred%3E"
class="anchor">§</a>

### impl\<'a, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.WriteHandle.html" class="struct"
title="struct vstd::rwlock::WriteHandle">WriteHandle</a>\<'a, V, Pred\>
...
<div id="impl-Unpin-for-WriteHandle%3C'a,+V,+Pred%3E"
class="section impl">

<a href="#impl-Unpin-for-WriteHandle%3C&#39;a,+V,+Pred%3E"
class="anchor">§</a>

### impl\<'a, V, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.WriteHandle.html" class="struct"
title="struct vstd::rwlock::WriteHandle">WriteHandle</a>\<'a, V, Pred\>
...
<div id="impl-UnwindSafe-for-WriteHandle%3C'a,+V,+Pred%3E"
class="section impl">

<a href="#impl-UnwindSafe-for-WriteHandle%3C&#39;a,+V,+Pred%3E"
class="anchor">§</a>

### impl\<'a, V, Pred\> \!<a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.WriteHandle.html" class="struct"
title="struct vstd::rwlock::WriteHandle">WriteHandle</a>\<'a, V, Pred\>
