...
# Struct <span class="struct">GhostSubset</span> Copy item path

<span class="sub-heading"><a href="../../../src/vstd/tokens/set.rs.html#99-101"
...
The existence of a
[`GhostSubset`](struct.GhostSubset.html "struct vstd::tokens::set::GhostSubset")
implies that:

- Those values will remain in the set unless ;
- Those values will remain in the set (unless the onwer of the
  [`GhostSubset`](struct.GhostSubset.html "struct vstd::tokens::set::GhostSubset")
  deletes it using \[`GhostSetAuth::delete`\]);
- All other
...
<div id="impl-Freeze-for-GhostSubset%3CT%3E" class="section impl">

<a href="#impl-Freeze-for-GhostSubset%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.GhostSubset.html" class="struct"
title="struct vstd::tokens::set::GhostSubset">GhostSubset</a>\<T\>

</div>

<div id="impl-RefUnwindSafe-for-GhostSubset%3CT%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-GhostSubset%3CT%3E"
class="anchor">§</a>

### impl\<T\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.GhostSubset.html" class="struct"
title="struct vstd::tokens::set::GhostSubset">GhostSubset</a>\<T\>
...
<div id="impl-Send-for-GhostSubset%3CT%3E" class="section impl">

<a href="#impl-Send-for-GhostSubset%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.GhostSubset.html" class="struct"
title="struct vstd::tokens::set::GhostSubset">GhostSubset</a>\<T\>
...
<div id="impl-Sync-for-GhostSubset%3CT%3E" class="section impl">

<a href="#impl-Sync-for-GhostSubset%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.GhostSubset.html" class="struct"
title="struct vstd::tokens::set::GhostSubset">GhostSubset</a>\<T\>
...
<div id="impl-Unpin-for-GhostSubset%3CT%3E" class="section impl">

<a href="#impl-Unpin-for-GhostSubset%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.GhostSubset.html" class="struct"
title="struct vstd::tokens::set::GhostSubset">GhostSubset</a>\<T\>
...
<div id="impl-UnwindSafe-for-GhostSubset%3CT%3E" class="section impl">

<a href="#impl-UnwindSafe-for-GhostSubset%3CT%3E" class="anchor">§</a>

### impl\<T\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.GhostSubset.html" class="struct"
title="struct vstd::tokens::set::GhostSubset">GhostSubset</a>\<T\>
