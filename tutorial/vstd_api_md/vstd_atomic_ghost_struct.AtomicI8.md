...
# Struct <span class="struct">AtomicI8</span> Copy item path

<span class="sub-heading"><a href="../../src/vstd/atomic_ghost.rs.html#207" class="src">Source</a>
</span>

</div>

``` rust
pub struct AtomicI8<K, G, Pred> { /* private fields */ }
```
...
Sequentially-consistent atomic memory location storing a `i8` and
...
<div id="impl-AtomicI8%3CK,+G,+Pred%3E" class="section impl">

<a href="../../src/vstd/atomic_ghost.rs.html#207"
class="src rightside">Source</a><a href="#impl-AtomicI8%3CK,+G,+Pred%3E" class="anchor">§</a>

### impl\<K, G, Pred\> <a href="struct.AtomicI8.html" class="struct"
title="struct vstd::atomic_ghost::AtomicI8">AtomicI8</a>\<K, G, Pred\>
...
title="struct vstd::prelude::Ghost">Ghost</a>\<K\>, u: <a href="https://doc.rust-lang.org/1.92.0/std/primitive.i8.html"
class="primitive">i8</a>, verus_tmp_g: <a href="../prelude/struct.Tracked.html" class="struct"
...
#### pub fn <a href="#method.load" class="fn">load</a>(&self) -\> <a href="https://doc.rust-lang.org/1.92.0/std/primitive.i8.html"
...
#### pub fn <a href="#method.into_inner" class="fn">into_inner</a>(self) -\> (<a href="https://doc.rust-lang.org/1.92.0/std/primitive.i8.html"
class="primitive">i8</a>, <a href="../prelude/struct.Tracked.html" class="struct"
...
<div id="impl-Freeze-for-AtomicI8%3CK,+G,+Pred%3E" class="section impl">

<a href="#impl-Freeze-for-AtomicI8%3CK,+G,+Pred%3E" class="anchor">§</a>

### impl\<K, G, Pred\> \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.AtomicI8.html" class="struct"
title="struct vstd::atomic_ghost::AtomicI8">AtomicI8</a>\<K, G, Pred\>

</div>

<div id="impl-RefUnwindSafe-for-AtomicI8%3CK,+G,+Pred%3E"
class="section impl">

<a href="#impl-RefUnwindSafe-for-AtomicI8%3CK,+G,+Pred%3E"
class="anchor">§</a>

### impl\<K, G, Pred\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.AtomicI8.html" class="struct"
title="struct vstd::atomic_ghost::AtomicI8">AtomicI8</a>\<K, G, Pred\>
...
<div id="impl-Send-for-AtomicI8%3CK,+G,+Pred%3E" class="section impl">

<a href="#impl-Send-for-AtomicI8%3CK,+G,+Pred%3E" class="anchor">§</a>

### impl\<K, G, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.AtomicI8.html" class="struct"
title="struct vstd::atomic_ghost::AtomicI8">AtomicI8</a>\<K, G, Pred\>
...
<div id="impl-Sync-for-AtomicI8%3CK,+G,+Pred%3E" class="section impl">

<a href="#impl-Sync-for-AtomicI8%3CK,+G,+Pred%3E" class="anchor">§</a>

### impl\<K, G, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.AtomicI8.html" class="struct"
title="struct vstd::atomic_ghost::AtomicI8">AtomicI8</a>\<K, G, Pred\>
...
<div id="impl-Unpin-for-AtomicI8%3CK,+G,+Pred%3E" class="section impl">

<a href="#impl-Unpin-for-AtomicI8%3CK,+G,+Pred%3E" class="anchor">§</a>

### impl\<K, G, Pred\> <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.AtomicI8.html" class="struct"
title="struct vstd::atomic_ghost::AtomicI8">AtomicI8</a>\<K, G, Pred\>
...
<div id="impl-UnwindSafe-for-AtomicI8%3CK,+G,+Pred%3E"
class="section impl">

<a href="#impl-UnwindSafe-for-AtomicI8%3CK,+G,+Pred%3E"
class="anchor">§</a>

### impl\<K, G, Pred\> <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.AtomicI8.html" class="struct"
title="struct vstd::atomic_ghost::AtomicI8">AtomicI8</a>\<K, G, Pred\>
