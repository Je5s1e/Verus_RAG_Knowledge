...
<span class="sub-heading"><a href="../src/vstd/invariant.rs.html#398-406" class="src">Source</a>
</span>
...
[`PAtomic`](atomic/index.html "mod vstd::atomic") library. The user can
also mark their own functions as “atomic operations” using
...
[`PAtomic`](atomic/index.html "mod vstd::atomic"). Note that reading and
writing through a
