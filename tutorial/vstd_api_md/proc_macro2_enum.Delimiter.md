...
# Enum <span class="enum">Delimiter</span> Copy item path

<span class="sub-heading"><a href="../src/proc_macro2/lib.rs.html#685-712" class="src">Source</a>
</span>
...
<div id="variant.Parenthesis" class="section variant">

<a href="#variant.Parenthesis" class="anchor">§</a>
...
created by a macro_rules macro in the input of a proc_macro macro are
preserved, and only in very specific circumstances. Any `None`-delimited
groups (re)created by a proc_macro will therefore not preserve operator
priorities as indicated above. The other `Delimiter` variants should be
used instead in this context. This is a rustc bug. For details, see
...
<div id="impl-Clone-for-Delimiter" class="section impl">

<a href="../src/proc_macro2/lib.rs.html#684"
class="src rightside">Source</a><a href="#impl-Clone-for-Delimiter" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/clone/trait.Clone.html"
class="trait" title="trait core::clone::Clone">Clone</a> for <a href="enum.Delimiter.html" class="enum"
...
class="fn">clone</a>(&self) -\> <a href="enum.Delimiter.html" class="enum"
title="enum proc_macro2::Delimiter">Delimiter</a>
...
<div id="impl-Debug-for-Delimiter" class="section impl">

<a href="../src/proc_macro2/lib.rs.html#684"
class="src rightside">Source</a><a href="#impl-Debug-for-Delimiter" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/fmt/trait.Debug.html"
class="trait" title="trait core::fmt::Debug">Debug</a> for <a href="enum.Delimiter.html" class="enum"
title="enum proc_macro2::Delimiter">Delimiter</a>
...
<div id="impl-PartialEq-for-Delimiter" class="section impl">

<a href="../src/proc_macro2/lib.rs.html#684"
class="src rightside">Source</a><a href="#impl-PartialEq-for-Delimiter" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.PartialEq.html"
class="trait" title="trait core::cmp::PartialEq">PartialEq</a> for <a href="enum.Delimiter.html" class="enum"
title="enum proc_macro2::Delimiter">Delimiter</a>
...
class="fn">eq</a>(&self, other: &<a href="enum.Delimiter.html" class="enum"
title="enum proc_macro2::Delimiter">Delimiter</a>) -\> <a href="https://doc.rust-lang.org/1.92.0/std/primitive.bool.html"
...
<div id="impl-Copy-for-Delimiter" class="section impl">

<a href="../src/proc_macro2/lib.rs.html#684"
class="src rightside">Source</a><a href="#impl-Copy-for-Delimiter" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Copy.html"
class="trait" title="trait core::marker::Copy">Copy</a> for <a href="enum.Delimiter.html" class="enum"
title="enum proc_macro2::Delimiter">Delimiter</a>

</div>

<div id="impl-Eq-for-Delimiter" class="section impl">

<a href="../src/proc_macro2/lib.rs.html#684"
class="src rightside">Source</a><a href="#impl-Eq-for-Delimiter" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.Eq.html"
class="trait" title="trait core::cmp::Eq">Eq</a> for <a href="enum.Delimiter.html" class="enum"
title="enum proc_macro2::Delimiter">Delimiter</a>

</div>

<div id="impl-StructuralPartialEq-for-Delimiter" class="section impl">

<a href="../src/proc_macro2/lib.rs.html#684"
class="src rightside">Source</a><a href="#impl-StructuralPartialEq-for-Delimiter" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/marker/trait.StructuralPartialEq.html"
class="trait"
title="trait core::marker::StructuralPartialEq">StructuralPartialEq</a> for <a href="enum.Delimiter.html" class="enum"
title="enum proc_macro2::Delimiter">Delimiter</a>
...
<div id="impl-Freeze-for-Delimiter" class="section impl">

<a href="#impl-Freeze-for-Delimiter" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="enum.Delimiter.html" class="enum"
title="enum proc_macro2::Delimiter">Delimiter</a>

</div>

<div id="impl-RefUnwindSafe-for-Delimiter" class="section impl">

<a href="#impl-RefUnwindSafe-for-Delimiter" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="enum.Delimiter.html" class="enum"
title="enum proc_macro2::Delimiter">Delimiter</a>

</div>

<div id="impl-Send-for-Delimiter" class="section impl">

<a href="#impl-Send-for-Delimiter" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="enum.Delimiter.html" class="enum"
title="enum proc_macro2::Delimiter">Delimiter</a>

</div>

<div id="impl-Sync-for-Delimiter" class="section impl">

<a href="#impl-Sync-for-Delimiter" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="enum.Delimiter.html" class="enum"
title="enum proc_macro2::Delimiter">Delimiter</a>

</div>

<div id="impl-Unpin-for-Delimiter" class="section impl">

<a href="#impl-Unpin-for-Delimiter" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="enum.Delimiter.html" class="enum"
title="enum proc_macro2::Delimiter">Delimiter</a>

</div>

<div id="impl-UnwindSafe-for-Delimiter" class="section impl">

<a href="#impl-UnwindSafe-for-Delimiter" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="enum.Delimiter.html" class="enum"
title="enum proc_macro2::Delimiter">Delimiter</a>
