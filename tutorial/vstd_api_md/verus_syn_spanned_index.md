...
<span class="sub-heading"><a href="../../src/verus_syn/spanned.rs.html#1-118"
...
[`Type`](../enum.Type.html "enum verus_syn::Type") that we want to
assert implements the
...
[`syn::Error::new_spanned`](../struct.Error.html#method.new_spanned "associated function verus_syn::Error::new_spanned")
...
title="trait verus_syn::spanned::Spanned">Spanned</a>  
A trait that can provide the `Span` of the complete contents of a syntax
tree node.
