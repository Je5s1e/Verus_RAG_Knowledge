...
# Struct <span class="struct">WithSpecOnExpr</span> Copy item path

<span class="sub-heading"><a href="../src/verus_syn/verus.rs.html#250-257" class="src">Source</a>
</span>
...
pub struct WithSpecOnExpr {
    pub with: With,
    pub inputs: Punctuated<Expr, Comma>,
    pub outputs: Option<(FatArrow, Pat)>,
    pub follows: Option<(OrEq, Pat)>,
}
```

## Fields<a href="#fields" class="anchor">§</a>

<span id="structfield.with"
class="structfield section-header"><a href="#structfield.with" class="anchor field">§</a>`with: `<a href="token/struct.With.html" class="struct"
title="struct verus_syn::token::With"><code>With</code></a></span><span id="structfield.inputs"
...
title="struct verus_syn::token::Comma"><code>Comma</code></a>`>`</span><span id="structfield.outputs"
class="structfield section-header"><a href="#structfield.outputs" class="anchor field">§</a>`outputs: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<(`<a href="token/struct.FatArrow.html" class="struct"
title="struct verus_syn::token::FatArrow"><code>FatArrow</code></a>`, `<a href="enum.Pat.html" class="enum"
title="enum verus_syn::Pat"><code>Pat</code></a>`)>`</span><span id="structfield.follows"
class="structfield section-header"><a href="#structfield.follows" class="anchor field">§</a>`follows: `<a href="https://doc.rust-lang.org/1.92.0/core/option/enum.Option.html"
class="enum" title="enum core::option::Option"><code>Option</code></a>`<(`<a href="token/struct.OrEq.html" class="struct"
title="struct verus_syn::token::OrEq"><code>OrEq</code></a>`, `<a href="enum.Pat.html" class="enum"
...
<div id="impl-Clone-for-WithSpecOnExpr" class="section impl">

<a href="../src/verus_syn/gen/clone.rs.html#3039-3048"
class="src rightside">Source</a><a href="#impl-Clone-for-WithSpecOnExpr" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/clone/trait.Clone.html"
class="trait" title="trait core::clone::Clone">Clone</a> for <a href="struct.WithSpecOnExpr.html" class="struct"
...
<a href="../src/verus_syn/gen/clone.rs.html#3040-3047"
...
<div id="impl-Debug-for-WithSpecOnExpr" class="section impl">

<a href="../src/verus_syn/gen/debug.rs.html#4258-4267"
class="src rightside">Source</a><a href="#impl-Debug-for-WithSpecOnExpr" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/fmt/trait.Debug.html"
class="trait" title="trait core::fmt::Debug">Debug</a> for <a href="struct.WithSpecOnExpr.html" class="struct"
title="struct verus_syn::WithSpecOnExpr">WithSpecOnExpr</a>
...
<a href="../src/verus_syn/gen/debug.rs.html#4259-4266"
...
<div id="impl-Hash-for-WithSpecOnExpr" class="section impl">

<a href="../src/verus_syn/gen/hash.rs.html#3823-3832"
class="src rightside">Source</a><a href="#impl-Hash-for-WithSpecOnExpr" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/hash/trait.Hash.html"
class="trait" title="trait core::hash::Hash">Hash</a> for <a href="struct.WithSpecOnExpr.html" class="struct"
title="struct verus_syn::WithSpecOnExpr">WithSpecOnExpr</a>
...
<a href="../src/verus_syn/gen/hash.rs.html#3824-3831"
...
<a href="../src/verus_syn/verus.rs.html#2503-2540"
...
<div id="impl-PartialEq-for-WithSpecOnExpr" class="section impl">

<a href="../src/verus_syn/gen/eq.rs.html#3045-3050"
class="src rightside">Source</a><a href="#impl-PartialEq-for-WithSpecOnExpr" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.PartialEq.html"
class="trait" title="trait core::cmp::PartialEq">PartialEq</a> for <a href="struct.WithSpecOnExpr.html" class="struct"
title="struct verus_syn::WithSpecOnExpr">WithSpecOnExpr</a>
...
<a href="../src/verus_syn/gen/eq.rs.html#3046-3049"
...
<div id="impl-Eq-for-WithSpecOnExpr" class="section impl">

<a href="../src/verus_syn/gen/eq.rs.html#3043"
class="src rightside">Source</a><a href="#impl-Eq-for-WithSpecOnExpr" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/cmp/trait.Eq.html"
class="trait" title="trait core::cmp::Eq">Eq</a> for <a href="struct.WithSpecOnExpr.html" class="struct"
title="struct verus_syn::WithSpecOnExpr">WithSpecOnExpr</a>
...
<div id="impl-Freeze-for-WithSpecOnExpr" class="section impl">

<a href="#impl-Freeze-for-WithSpecOnExpr" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Freeze.html"
class="trait" title="trait core::marker::Freeze">Freeze</a> for <a href="struct.WithSpecOnExpr.html" class="struct"
title="struct verus_syn::WithSpecOnExpr">WithSpecOnExpr</a>

</div>

<div id="impl-RefUnwindSafe-for-WithSpecOnExpr" class="section impl">

<a href="#impl-RefUnwindSafe-for-WithSpecOnExpr" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.RefUnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::RefUnwindSafe">RefUnwindSafe</a> for <a href="struct.WithSpecOnExpr.html" class="struct"
title="struct verus_syn::WithSpecOnExpr">WithSpecOnExpr</a>

</div>

<div id="impl-Send-for-WithSpecOnExpr" class="section impl">

<a href="#impl-Send-for-WithSpecOnExpr" class="anchor">§</a>

### impl \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Send.html"
class="trait" title="trait core::marker::Send">Send</a> for <a href="struct.WithSpecOnExpr.html" class="struct"
title="struct verus_syn::WithSpecOnExpr">WithSpecOnExpr</a>

</div>

<div id="impl-Sync-for-WithSpecOnExpr" class="section impl">

<a href="#impl-Sync-for-WithSpecOnExpr" class="anchor">§</a>

### impl \!<a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Sync.html"
class="trait" title="trait core::marker::Sync">Sync</a> for <a href="struct.WithSpecOnExpr.html" class="struct"
title="struct verus_syn::WithSpecOnExpr">WithSpecOnExpr</a>

</div>

<div id="impl-Unpin-for-WithSpecOnExpr" class="section impl">

<a href="#impl-Unpin-for-WithSpecOnExpr" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/1.92.0/core/marker/trait.Unpin.html"
class="trait" title="trait core::marker::Unpin">Unpin</a> for <a href="struct.WithSpecOnExpr.html" class="struct"
title="struct verus_syn::WithSpecOnExpr">WithSpecOnExpr</a>

</div>

<div id="impl-UnwindSafe-for-WithSpecOnExpr" class="section impl">

<a href="#impl-UnwindSafe-for-WithSpecOnExpr" class="anchor">§</a>

### impl <a
href="https://doc.rust-lang.org/1.92.0/core/panic/unwind_safe/trait.UnwindSafe.html"
class="trait"
title="trait core::panic::unwind_safe::UnwindSafe">UnwindSafe</a> for <a href="struct.WithSpecOnExpr.html" class="struct"
title="struct verus_syn::WithSpecOnExpr">WithSpecOnExpr</a>
